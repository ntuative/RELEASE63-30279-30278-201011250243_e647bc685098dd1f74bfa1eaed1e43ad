package com.sulake.habbo.catalog.recycler
{
   ...
   public class RecyclerLogic implements IRecycler
   {
      ...
      public static const const_175:int = 5;
      
      private static const const_840:int = 0;
      
      private static const const_387:int = 1;
      
      private static const const_839:int = 2;
      ...
      {
         return this.var_566 != const_840;
      }
      
      private function get systemActive() : Boolean
      {
         return this.var_1647 != RecyclerStatusMessageEvent.const_978;
      }
      
      private function get ready() : Boolean
      {
         return this.active && this.var_566 == const_387;
      }
      ...
      {
         this.var_566 = const_839;
         this.var_104 = new Array(const_175);
         if(param1 == null)
         {
            return;
         }
      ...
      public function cancel() : void
      {
         ...
         var _loc1_:int = 0;
         while(_loc1_ < const_175)
         {
            this.releaseSlot(_loc1_);
            _loc1_++;
         }
         this.var_566 = const_840;
      }
      ...
      public function setSystemStatus(param1:int, param2:int) : void
      {
         ...
         {
            case RecyclerStatusMessageEvent.const_1486:
               this.var_566 = const_387;
               if(this._view == null)
               {
                  return;
               ...
               this.updateRecyclerButton();
               break;
            case RecyclerStatusMessageEvent.const_978:
               if(this._view == null)
               {
                  return;
               }
               ...
               this._catalog.setupInventoryForRecycler(false);
               break;
            case RecyclerStatusMessageEvent.const_1294:
               if(this._view == null)
               {
                  return;
               }
      ...
      public function setFinished(param1:int, param2:int) : void
      {
         ...
         switch(status)
         {
            case RecyclerFinishedMessageEvent.const_989:
               if(this._view != null)
               {
      ...
      public function placeObjectAtSlot(param1:int, param2:int, param3:int, param4:int, param5:String) : void
      {
         ...
         if(this.var_104.length > 0)
         {
            ...
            newSlotId = 0;
            while(oldObjectData != null && newSlotId < const_175)
            {
      ...
      private function isPoolFull() : Boolean
      {
         ...
         if(this.var_104.length < const_175)
         {
            return false;
         }
         var _loc1_:int = 0;
