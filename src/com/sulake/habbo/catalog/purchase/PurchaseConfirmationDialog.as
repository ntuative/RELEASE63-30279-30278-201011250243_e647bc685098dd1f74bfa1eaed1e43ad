package com.sulake.habbo.catalog.purchase
{
   ...
   public class PurchaseConfirmationDialog implements IGetImageListener
   {
      ...
      private const const_1536:uint = 4.293848814E9;
      
      private const const_1537:uint = 4.294967295E9;
      
      private const const_1782:uint = 4.291613146E9;
      ...
      private function updateLocalizations() : void
      {
         ...
         var _loc8_:String = this.var_79.activityPointType == Purse.const_406 ? "pixels" : "activitypoints";
      ...
      private function showGiftDialog() : void
      {
         ...
         if(_loc1_.isEnabled)
         {
            ...
            this.var_1484 = _loc1_.stuffTypes;
            this.var_633 = _loc1_.boxTypes;
            this.var_634 = _loc1_.ribbonTypes;
            this.var_963 = this.var_1484[0];
            this.var_299 = this.var_633[0];
            this.var_298 = this.var_634[0];
            this.initColorGrid();
      ...
      private function updatePreview() : void
      {
         ...
         if(this.var_298 < 0)
         {
            this.var_298 = this.var_634.length - 1;
         }
         if(this.var_298 > this.var_634.length - 1)
         {
            this.var_298 = 0;
         }
         if(this.var_299 < 0)
         {
            this.var_299 = this.var_633.length - 1;
         }
         if(this.var_299 > this.var_633.length - 1)
         {
            this.var_299 = 0;
         }
         var _loc1_:int = this.var_633[this.var_299] * 1000 + this.var_634[this.var_298];
         if(this._window == null)
         {
            return;
         }
      ...
      private function initColorGrid() : void
      {
         ...
         var _loc3_:Array = this.var_1484;
      ...
      private function giveGift() : void
      {
         ...
         var _loc8_:int = !!_loc6_ ? 0 : int(this.var_633[this.var_299]);
         var _loc9_:int = !!_loc6_ ? 0 : int(this.var_634[this.var_298]);
         this._catalog.purchaseProductAsGift(this._pageId,this.var_79,this.var_1206,_loc2_,_loc4_,_loc7_,_loc8_,_loc9_);
      }
      ...
      private function confirmationHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param2.name)
         {
            case "gift_button":
               ...
               break;
            case "buy_button":
               this._catalog.purchaseProduct(this._pageId,this.var_79.offerId,this.var_1206);
               this.dispose();
               break;
            case "cancel_button":
      ...
      private function nameInputHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param1.type)
         {
            case WindowEvent.const_115:
               ...
               if(this.var_1988 == _loc3_.text)
               {
                  return;
               }
               _loc4_ = _loc3_.text.toLowerCase();
               _loc5_ = [];
               for each(_loc7_ in this.var_190)
               {
                  if(_loc7_.toLowerCase().search(_loc4_) != -1)
                  {
                     _loc5_.push(_loc7_);
                  }
                  if(_loc5_.length >= this.const_1783)
                  {
                     break;
                  }
               }
               this.updateSuggestions(_loc5_);
               this.var_1988 = _loc3_.text;
               break;
            case WindowMouseEvent.const_39:
               ...
               break;
            case WindowKeyboardEvent.const_717:
               _loc6_ = param1 as WindowKeyboardEvent;
               switch(_loc6_.keyCode)
               {
                  case Keyboard.UP:
                     this.highlightSuggestion(this.var_297 - 1);
                     break;
                  case Keyboard.DOWN:
                     this.highlightSuggestion(this.var_297 + 1);
                     break;
      ...
      {
         if(this.var_219 == null || !this.var_219.visible)
         {
            return;
         }
         var _loc1_:IItemListWindow = this.var_219.findChildByName("suggestion_list") as IItemListWindow;
         if(_loc1_ == null)
         {
            return;
         }
         var _loc2_:IWindowContainer = _loc1_.getListItemAt(this.var_297) as IWindowContainer;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      private function updateSuggestions(param1:Array) : void
      {
         ...
         if(this.var_219 == null)
         {
            this.var_219 = this._window.findChildByName("suggestion_container") as IWindowContainer;
         }
         if(this.var_529 == null)
         {
            this.var_529 = this.createWindow("suggestion_list_item") as IWindowContainer;
            this.var_529.procedure = this.suggestionsEventHandler;
         }
         if(this.var_219 == null || this.var_529 == null)
         {
            return;
         }
         var _loc2_:IItemListWindow = this.var_219.findChildByName("suggestion_list") as IItemListWindow;
         if(_loc2_ == null)
         {
            return;
         }
         ...
         {
            _loc5_ = this.var_529.clone() as IWindowContainer;
            if(_loc5_ != null)
            {
      ...
      private function highlightSuggestion(param1:int) : void
      {
         ...
         _loc3_ = _loc2_.getListItemAt(this.var_297) as IWindowContainer;
         if(_loc3_ != null)
         {
            _loc3_.color = this.getColor(this.var_297);
         }
         this.var_297 = param1;
         if(this.var_297 < 0)
         {
            this.var_297 = _loc2_.numListItems - 1;
         }
         if(this.var_297 >= _loc2_.numListItems)
         {
            this.var_297 = 0;
         }
         _loc3_ = _loc2_.getListItemAt(this.var_297) as IWindowContainer;
         if(_loc3_ != null)
         {
            _loc3_.color = this.const_1782;
         }
      }
      
      private function getColor(param1:int) : uint
      {
         return param1 % 2 == 0 ? uint(this.const_1536) : uint(this.const_1537);
      }
      ...
      private function suggestionsEventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER:
               _loc5_ = this.var_219.findChildByName("suggestion_list") as IItemListWindow;
               if(_loc5_ == null)
               {
                  return;
               }
