package com.sulake.habbo.catalog.marketplace
{
   ...
   public class MarketPlaceLogic implements IMarketPlace
   {
      ...
      public const const_1557:int = 1;
      
      public const const_1607:int = 2;
      
      public const const_1816:int = 3;
      ...
      private var var_197:MarketplaceConfirmationDialog;
      ...
      private var var_2558:MarketplaceItemStats;
      ...
      private function showConfirmation(param1:int, param2:MarketPlaceOfferData) : void
      {
         if(!this.var_197)
         {
            this.var_197 = new MarketplaceConfirmationDialog(this,this._catalog,this._roomEngine);
         }
         this.var_197.showConfirmation(param1,param2);
      }
      ...
      {
         this.requestOffers(this.var_2556,this.var_2557,this.var_2509,this.var_2555);
      }
      ...
      public function buyOffer(param1:int) : void
      {
         ...
         this.showConfirmation(this.const_1557,_loc2_);
      }
      ...
      public function onOwnOffers(param1:IMessageEvent) : void
      {
         ...
         this.var_2374 = _loc3_.creditsWaiting;
      ...
      public function onBuyResult(param1:IMessageEvent) : void
      {
         ...
         else if(parser.result == 3)
         {
            ...
            this.showConfirmation(this.const_1607,updateItem);
            this._visualization.listUpdatedNotify();
         }
      ...
      {
         if(param1.furniCategoryId != this.var_2311 || param1.furniTypeId != this.var_2312)
         {
            return;
         }
      ...
      private function isPosterItem(param1:MarketPlaceOfferData) : Boolean
      {
         ...
         if(param1.furniType == 2 && param1.stuffData != null)
         {
            ...
            {
               _loc4_ = _loc3_.name;
               if(_loc4_ != null && _loc4_ == const_1211)
               {
                  _loc2_ = true;
               }
            }
