package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ColourGridCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      override public function init() : void
      {
         ...
         this.var_1729 = _loc1_.content as XML;
      ...
      private function populateColourGrid() : void
      {
         ...
         var _loc13_:* = null;
         var _loc14_:* = 0;
         Logger.log("[ColourGridCatalogWidget] Display colors: " + [this.var_1351.length,this._colourGrid.numGridItems]);
         this._colourGrid.destroyGridItems();
         this.var_327 = null;
         for each(_loc1_ in this.var_1351)
         {
            _loc2_ = page.viewer.catalog.windowManager.buildFromXML(this.var_1729) as IWindowContainer;
            ...
            if(_loc4_ != null)
            {
               _loc4_.bitmap = new BitmapData(this.var_952.width,this.var_952.height,true,0);
               _loc6_ = 255;
               _loc7_ = 255;
               _loc8_ = 255;
               if(_loc1_ > 0)
            ...
            if(_loc5_ != null)
            {
               _loc5_.bitmap = new BitmapData(this.var_781.width,this.var_781.height,true,16777215);
               _loc5_.bitmap.copyPixels(this.var_781,this.var_781.rect,new Point(0,0),null,null,true);
