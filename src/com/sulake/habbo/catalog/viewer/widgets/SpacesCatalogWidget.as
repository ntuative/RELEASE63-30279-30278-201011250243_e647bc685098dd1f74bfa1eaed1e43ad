package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class SpacesCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      private var var_1641:String = "default";
      ...
      private var var_1643:String = "1.1";
      ...
      private function onClick(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc2_.name)
         {
            ...
            case "ctlg_wall_color_next":
               ...
               break;
            case "ctlg_buy_wall":
               _loc3_ = this.var_1295[this.var_380];
               if(_loc3_ != null)
               {
            ...
            case "ctlg_floor_color_next":
               ...
               break;
            case "ctlg_buy_floor":
               _loc3_ = this.var_1296[this.var_383];
               if(_loc3_ != null)
               {
            ...
            case "ctlg_buy_landscape":
               _loc3_ = this.var_1297[this.var_382];
               if(_loc3_ != null)
               {
                  (page.viewer.catalog as HabboCatalog).showPurchaseConfirmation(_loc3_,page.pageId,this.var_1643);
               }
               break;
            default:
      ...
      private function updateConfiguration() : void
      {
         ...
         var _loc13_:* = null;
         var _loc14_:* = null;
         var _loc2_:String = this.var_849[this.var_380];
         ...
         _loc6_ = this.var_1296[this.var_383];
         if(_loc6_ != null)
         {
         ...
         var _loc7_:String = this.var_845[this.var_382];
         for each(_loc1_ in this.var_164.landscapes.pattern)
         {
            if(_loc1_.@id == _loc7_)
            {
               _loc13_ = _loc1_.children()[this.var_455];
               if(_loc13_ != null)
               {
                  this.var_1643 = _loc13_.@id;
               }
            }
         }
         _loc8_ = this.var_1297[this.var_382];
         if(_loc8_ != null)
         {
      ...
      private function changePattern(param1:String, param2:int) : void
      {
         ...
         switch(param1)
         {
            case const_191:
               ...
               if(this.var_380 < 0)
               {
                  this.var_380 = this.var_849.length - 1;
               }
               if(this.var_380 == this.var_849.length)
               {
                  this.var_380 = 0;
               }
               this.var_381 = 0;
               this.var_847 = 0;
               _loc5_ = this.var_849[this.var_380];
               for each(_loc8_ in this.var_164.walls.pattern)
               {
                  if(_loc8_.@id == _loc5_)
                  {
                     this.var_847 = _loc8_.children().length();
                  }
               }
            ...
            case const_190:
               ...
               for each(_loc9_ in this.var_164.floors.pattern)
               {
                  if(_loc9_.@id == _loc6_)
                  {
                     this.var_848 = _loc9_.children().length();
                  }
               }
            ...
            case const_94:
               ...
               if(this.var_382 < 0)
               {
                  this.var_382 = this.var_845.length - 1;
               }
               if(this.var_382 >= this.var_845.length)
               {
                  this.var_382 = 0;
               }
               this.var_455 = 0;
               this.var_846 = 0;
               _loc7_ = this.var_845[this.var_382];
               for each(_loc10_ in this.var_164.landscapes.pattern)
               {
                  if(_loc10_.@id == _loc7_)
                  {
                     this.var_846 = _loc10_.children().length();
                  }
               }
      ...
      private function retrieveSpacesPreview() : void
      {
         var _loc4_:* = null;
         var _loc5_:* = null;
         var _loc2_:ImageResult = page.viewer.roomEngine.getRoomImage(this._floorType,this.var_1641,this.var_1643,64,this,"window_romantic_wide");
         ...
         {
            this.var_1640 = _loc2_.id;
            this.var_1642 = _loc3_.id;
      ...
      public function imageReady(param1:int, param2:BitmapData) : void
      {
         ...
         if(this.var_318 != null && this.var_319 != null)
         {
            this.setRoomImage(this.var_318,this.var_319);
         }
      }
   }
}
