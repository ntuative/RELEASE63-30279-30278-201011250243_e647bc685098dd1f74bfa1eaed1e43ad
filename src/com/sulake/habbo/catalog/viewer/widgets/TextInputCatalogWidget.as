package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class TextInputCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      {
         super.init();
         this.var_1051 = _window.findChildByName("input_text") as ITextFieldWindow;
         if(this.var_1051 != null)
         {
            this.var_1051.addEventListener(WindowKeyboardEvent.const_717,this.onKey);
         }
      }
      ...
      private function onKey(param1:WindowKeyboardEvent) : void
      {
         ...
         events.dispatchEvent(new TextInputEvent(this.var_1051.text));
      }
   }
}
