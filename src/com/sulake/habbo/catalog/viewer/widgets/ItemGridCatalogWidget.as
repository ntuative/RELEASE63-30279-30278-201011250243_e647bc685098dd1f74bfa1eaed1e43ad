   ...
   public class ItemGridCatalogWidget extends CatalogWidget implements ICatalogWidget, IItemGrid
   {
      ...
      public function ItemGridCatalogWidget(param1:IWindowContainer)
      {
         ...
         if(this._scrollBar != null)
         {
            ...
            this._scrollBar.addEventListener(WindowEvent.const_784,this.activateScrollbar);
            this._scrollBar.addEventListener(WindowEvent.const_272,this.activateScrollbar);
            this._scrollBar.addEventListener(WindowEvent.const_592,this.deActivateScrollbar);
      ...
      override public function dispose() : void
      {
         ...
         this.var_1146.destroyGridItems();
         this.var_1146 = null;
         this.var_1727 = null;
         this.var_327 = null;
         super.dispose();
      ...
      {
         this.var_1146 = _window.findChildByName("itemGrid") as IItemGridWindow;
      ...
      protected function loadItemGridGraphics(param1:TimerEvent = null) : void
      {
         ...
         if(param1 != null)
         {
            ...
            if(this.var_780 == page.offers.length)
            {
         ...
         while(_loc3_ < 3)
         {
            if(this.var_780 >= 0 && this.var_780 < page.offers.length)
            {
               _loc4_ = page.offers[this.var_780];
      ...
      protected function createGridItem(param1:Offer) : void
      {
         ...
         {
            ++this.var_1467;
            (param1.productContainer as BundleProductContainer).setBundleCounter(this.var_1467);
         }
      }
