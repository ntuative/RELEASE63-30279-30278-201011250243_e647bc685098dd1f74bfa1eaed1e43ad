package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ItemGroupCatalogWidget extends ItemGridCatalogWidget implements ICatalogWidget, IItemGrid
   {
      ...
      {
         var _loc2_:Offer = this.var_523[this.var_951][this.var_1466];
      ...
      override public function select(param1:IGridItem) : void
      {
         ...
         super.select(param1);
         this.var_951 = var_1146.getGridItemIndex(param1.view);
         var _loc2_:String = this._groupNames[this.var_951];
         var _loc3_:Array = this.var_523[this.var_951] as Array;
      ...
      override protected function populateItemGrid() : void
      {
         ...
         {
            if(this.var_1466 < _loc1_.length)
            {
               _loc2_ = _loc1_[this.var_1466] as Offer;
      ...
      private function createOfferGroups() : void
      {
         ...
         {
            if(_loc1_.pricingModel == Offer.const_511 || _loc1_.pricingModel == Offer.const_492)
            {
               _loc3_ = _loc1_.productContainer.firstProduct;
               if(_loc3_ != null)
               {
                  _loc4_ = _loc3_.productClassId;
                  if(_loc3_.productType == ProductTypeEnum.const_80 || _loc3_.productType == ProductTypeEnum.const_87)
                  {
                     if(_loc3_.furnitureData != null)
                     {
                        ...
                        if(this._groupNames.indexOf(_loc5_) == -1)
                        {
                           ...
                           this.var_523.push(new Array());
                        }
                        _loc6_ = this._groupNames.indexOf(_loc5_);
                        (this.var_523[_loc6_] as Array).push(_loc1_);
                     }
                  }
               }
            }
         }
         for each(_loc2_ in this.var_523)
         {
