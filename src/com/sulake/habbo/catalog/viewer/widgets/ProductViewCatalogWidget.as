package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ProductViewCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      private var var_1248:IScrollbarWindow;
      ...
      {
         this.var_817 = _window.findChildByName("ctlg_product_name") as ITextWindow;
         this.var_1000 = _window.findChildByName("ctlg_description") as ITextWindow;
         this.var_80 = _window.findChildByName("ctlg_teaserimg_1") as IBitmapWrapperWindow;
         this.var_1553 = new Point(this.var_80.x,this.var_80.y);
         this.var_440 = _window.findChildByName("bundleGrid") as IItemGridWindow;
         this.var_1248 = _window.findChildByName("bundleGridScrollbar") as IScrollbarWindow;
         ...
         this.var_1554 = _loc2_.content as BitmapData;
      ...
      private function onPreviewProduct(param1:SelectProductEvent) : void
      {
         ...
         this.var_817.text = _loc4_;
         this.var_1000.text = _loc5_;
         this.var_817.height = this.var_817.textHeight + 5;
         this.var_1000.y = this.var_817.y + this.var_817.height;
         this.var_1000.height = Math.max(130,this.var_1000.textHeight + 5);
         ...
         else
         {
            ...
            switch(_loc2_.pricingModel)
            {
               case Offer.const_495:
                  _loc6_ = this.var_1554.clone();
                  if(this.var_440 != null)
                  {
                     this.var_440.visible = true;
                     _loc10_ = _loc2_.productContainer as BundleProductContainer;
                     _loc10_.populateItemGrid(this.var_440,this.var_1248,this.var_1727);
                     this.var_440.scrollV = 0;
                  }
                  break;
                     ...
                     case ProductTypeEnum.const_237:
                        ...
                        if(_loc15_.avatarRenderManager != null)
                        {
                           ...
                           if(_loc16_ != null)
                           {
                              ...
                              _loc16_.appendAction(AvatarAction.const_286,AvatarAction.const_525);
                              _loc16_.appendAction(AvatarAction.const_261,_loc8_.productClassId);
      ...
      {
         var _loc1_:* = null;
         for each(_loc1_ in this.var_2088)
         {
      ...
      private function setPreviewImage(param1:BitmapData, param2:Boolean, param3:Point = null) : void
      {
         ...
         if(this.var_80 != null && true)
         {
            ...
            this.var_80.x = this.var_1553.x;
            this.var_80.y = this.var_1553.y;
            if(param3 != null)
            {
