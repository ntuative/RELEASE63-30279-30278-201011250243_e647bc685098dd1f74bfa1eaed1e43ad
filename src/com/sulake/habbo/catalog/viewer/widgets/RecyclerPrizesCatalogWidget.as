package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class RecyclerPrizesCatalogWidget extends CatalogWidget implements ICatalogWidget, IItemGrid
   {
      ...
      private var var_1099:PrizeViewer;
      
      private var _itemList:IItemListWindow;
      
      private var var_1727:XML;
      
      private var var_1728:XML;
      ...
      override public function init() : void
      {
         var _loc1_:* = null;
         super.init();
         this.var_1099 = new PrizeViewer();
         this.var_710 = this.recycler.getPrizeTable();
         ...
         this.var_1728 = _loc1_.content as XML;
         this.populateItemGrid();
         if(this.var_710.length > 0 && this.var_710[0].prizes.length > 0)
         {
            this.select(this.var_710[0].prizes[0] as IGridItem);
         }
      }
      ...
      {
         var _loc2_:int = 0;
         while(_loc2_ < this.var_710.length)
         {
            this.createLevelItem(this.var_710[_loc2_]);
            _loc2_++;
         }
      }
      ...
      {
         var _loc6_:* = null;
         var _loc2_:IWindowContainer = page.viewer.catalog.windowManager.buildFromXML(this.var_1728) as IWindowContainer;
      ...
      {
         var _loc3_:IWindowContainer = page.viewer.catalog.windowManager.buildFromXML(this.var_1727) as IWindowContainer;
      ...
      public function select(param1:IGridItem) : void
      {
         ...
         this.var_1099.viewProduct(page.viewer.roomEngine,_loc3_,_loc2_.productItemType,_loc2_.productItemTypeId,_loc2_.title,_loc4_);
      }
