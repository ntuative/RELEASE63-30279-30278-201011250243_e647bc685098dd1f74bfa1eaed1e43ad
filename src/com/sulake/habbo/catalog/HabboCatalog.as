package com.sulake.habbo.catalog
{
   ...
   public class HabboCatalog extends Component implements IHabboCatalog, IProductDataListener
   {
      ...
      private var var_197:PurchaseConfirmationDialog;
      ...
      private var var_2233:GiftWrappingConfiguration;
      
      private var var_1039:ClubGiftController;
      ...
      public function showPurchaseConfirmation(param1:IPurchasableOffer, param2:int, param3:String = "") : void
      {
         ...
         if(param1 is Offer)
         {
            if(this.var_197 == null)
            {
               this.var_197 = new PurchaseConfirmationDialog(this._localization);
            }
            _loc4_ = [];
            ...
            this.var_197.showOffer(this,param1,param2,param3,_loc4_);
         ...
         {
            this.var_454.showConfirmation(param1 as ClubBuyOfferData,param2);
         }
      }
      ...
      public function openCatalogPageById(param1:int, param2:int) : void
      {
         ...
         {
            this.toggleCatalog(true);
            this.var_317.method_10(param1,param2);
         }
         else
         {
            this.toggleCatalog();
      ...
      {
         return this.var_398.getProductData(param1);
      }
      ...
      public function getFurnitureData(param1:int, param2:String) : IFurnitureData
      {
         ...
         {
            _loc3_ = this.var_398.getFloorItemData(param1);
         }
         if(param2 == ProductTypeEnum.const_80)
         {
            _loc3_ = this.var_398.getWallItemData(param1);
         }
         return _loc3_;
      }
      ...
      private function updatePurse() : void
      {
         ...
         this._localization.registerParameter("catalog.purse.pixelbalance","balance",String(this.var_103.getActivityPointsForType(Purse.const_406)));
         var _loc1_:int = 0;
      ...
      private function toggleCatalog(param1:Boolean = false) : void
      {
         ...
         if(!this.var_723)
         {
            if(!this.var_398.loadProductData(this))
            {
               return;
            }
            this.init();
         ...
         {
            this._toolbar.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_51,HabboToolbarIconEnum.CATALOGUE,this._mainContainer));
         }
         if(this._mainContainer.visible)
         {
      ...
      private function onRoomSessionEvent(param1:RoomSessionEvent) : void
      {
         switch(param1.type)
         {
            case RoomSessionEvent.const_88:
               this.var_1639 = param1.session.isPrivateRoom;
               if(this.var_85 != null)
               {
      ...
      private function createClubGiftController() : void
      {
         ...
         {
            this.var_1039 = new ClubGiftController(this);
         }
      }
      ...
      private function createClubBuyController() : void
      {
         if(this.var_454 == null)
         {
            this.var_454 = new ClubBuyController(this);
         }
      }
      ...
      private function onCatalogIndex(param1:IMessageEvent) : void
      {
         ...
         {
            this.var_317.openPage(this.var_670);
            this.var_670 = "";
            this.var_844 = -1;
         }
         else if(this.var_844 > -1)
         {
            this.var_317.method_10(this.var_844,this.var_1638);
            this.var_844 = -1;
            this.var_1638 = -1;
            this.var_670 = "";
         }
      ...
      private function onCatalogPage(param1:IMessageEvent) : void
      {
         ...
         var _loc6_:Array = _loc3_.localization.method_21.concat();
      ...
      private function onCreditBalance(param1:IMessageEvent) : void
      {
         ...
         this.updatePurse();
         if(!this.var_2234 && this.var_564 != null)
         {
            this.var_564.playSound(HabboSoundTypesEnum.const_907);
         }
         this.var_2234 = false;
      }
      ...
      private function onActivityPointNotification(param1:IMessageEvent) : void
      {
         ...
         this.updatePurse();
         if(!this.var_2235 && this.var_564 != null)
         {
            this.var_564.playSound(HabboSoundTypesEnum.const_908);
         }
         this.var_2235 = false;
      }
      ...
      private function onClubGiftInfo(param1:ClubGiftInfoEvent) : void
      {
         ...
         this.var_1039.setInfo(_loc2_.daysUntilNextGift,_loc2_.giftsAvailable,_loc2_.offers,_loc2_.giftData);
      }
      ...
      private function onGiftWrappingConfiguration(param1:GiftWrappingConfigurationEvent) : void
      {
         ...
         this.var_2233 = new GiftWrappingConfiguration(param1);
      }
      ...
      private function onIsOfferGiftable(param1:IsOfferGiftableMessageEvent) : void
      {
         ...
         if(this.var_197 != null)
         {
            this.var_197.onIsOfferGiftable(param1.getParser());
         }
      }
