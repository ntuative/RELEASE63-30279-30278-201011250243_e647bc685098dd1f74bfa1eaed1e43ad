package com.sulake.habbo.inventory.badges
{
   ...
   public class BadgesModel implements IInventoryModel
   {
      ...
      private const const_1791:int = 5;
      ...
      public function BadgesModel(param1:HabboInventory, param2:IHabboWindowManager, param3:IHabboCommunicationManager, param4:IAssetLibrary, param5:ISessionDataManager)
      {
         ...
         this.var_398 = param5;
         this.var_398.events.addEventListener(BadgeImageReadyEvent.const_137,this.onBadgeImageReady);
      ...
      {
         var _loc2_:int = 0;
         while(_loc2_ < this.var_872.length)
         {
            if(this.var_872[_loc2_] == param1)
            {
      ...
      public function updateBadge(param1:String, param2:Boolean) : void
      {
         ...
         else
         {
            ...
            _loc8_.iconImage = this.var_398.getBadgeImage(param1);
      ...
      public function setBadgeSelected(param1:String) : void
      {
         ...
         {
            _loc2_ = this.var_234[_loc3_] as Badge;
            if(_loc2_ != null)
            {
      ...
      public function getBadges(param1:int = -1) : Array
      {
         ...
         switch(param1)
         {
            ...
            case 0:
               ...
               while(_loc3_ < this.var_234.length)
               {
                  if((this.var_234[_loc3_] as Badge).isInUse == false)
                  {
                     _loc2_.push(this.var_234[_loc3_]);
                  }
                  _loc3_++;
               }
               return _loc2_;
      ...
      {
         if(param1 == InventoryCategory.const_264 && this._controller.isVisible)
         {
