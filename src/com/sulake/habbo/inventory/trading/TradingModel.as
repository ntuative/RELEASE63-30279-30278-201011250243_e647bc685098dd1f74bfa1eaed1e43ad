package com.sulake.habbo.inventory.trading
{
   ...
   public class TradingModel implements IInventoryModel, IGetImageListener
   {
      ...
      public static const const_1309:uint = 9;
      ...
      public static const const_273:uint = 3;
      
      public static const const_467:uint = 4;
      
      public static const const_253:uint = 5;
      ...
      public function startTrading(param1:int, param2:String, param3:Boolean, param4:int, param5:String, param6:Boolean) : void
      {
         ...
         this.var_47.updateItemList(this.var_657);
         this.var_47.updateItemList(this.var_1273);
      ...
      public function close() : void
      {
         if(this.var_702)
         {
            if(this._state != const_183 && this._state != const_253)
            {
               this.requestCancelTrading();
               this.state = TradingModel.TRADING_STATE_CANCELLED;
            }
            this.state = const_183;
            this._inventory.toggleInventorySubPage(InventorySubCategory.const_1046);
            this.var_702 = false;
         }
      ...
      {
         Logger.log("OLD STATE: " + this._state + " NEW STATE: " + param1 + " OWN: " + this.var_658 + " OTHER: " + this.var_1020);
         ...
         {
            case const_183:
               if(param1 == const_172 || param1 == const_253)
               {
                  this._state = param1;
                  _loc2_ = true;
               }
      ...
      public function handleMessageEvent(param1:IMessageEvent) : void
      {
         ...
         if(param1 is TradingAlreadyOpenEvent)
         {
            ...
            this.var_47.alertPopup(TradingView.const_1008);
         }
         else if(param1 is TradingAcceptEvent)
         {
            Logger.log("TRADING::TradingAcceptEvent");
            if(TradingAcceptEvent(param1).userID == this.var_657)
            {
               this.var_658 = TradingAcceptEvent(param1).userAccepts != 0;
            }
            else
            {
               this.var_1020 = TradingAcceptEvent(param1).userAccepts != 0;
            }
            this.var_47.updateUserInterface();
         }
         ...
         else if(param1 is TradingCloseEvent)
         {
            ...
            if(_loc2_.userID != this.var_657)
            {
               this.var_47.alertPopup(TradingView.const_1029);
            }
            this.close();
         }
      ...
      public function requestAddItemToTrading(param1:int, param2:int, param3:int, param4:Boolean, param5:String = "") : Boolean
      {
         ...
         if(this.var_266.length < const_1309)
         {
