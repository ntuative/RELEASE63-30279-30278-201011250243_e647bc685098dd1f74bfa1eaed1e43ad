package com.sulake.habbo.inventory
{
   ...
   public class InventoryMainView
   {
      ...
      private var var_2608:IWindowContainer;
      
      private var _controller:HabboInventory;
      
      private var _toolbar:IHabboToolbar;
      
      private var var_967:Boolean = true;
      ...
      public function showInventory() : void
      {
         ...
         _loc1_.visible = true;
         if(this._toolbar != null && this.var_967)
         {
            this._toolbar.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_51,HabboToolbarIconEnum.INVENTORY,_loc1_ as IWindowContainer));
            this.var_967 = false;
         }
         this._controller.method_8(this.var_636);
      }
      ...
      public function toggleCategoryView(param1:String, param2:Boolean = true) : void
      {
         ...
         else
         {
            _loc3_.visible = true;
            _loc3_.activate();
            if(param1 != this.var_637 || !this._controller.isInventoryCategoryInit(param1))
            {
               this.setViewToCategory(param1);
            }
            if(this._toolbar != null && this.var_967)
            {
               this._toolbar.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_51,HabboToolbarIconEnum.INVENTORY,_loc3_ as IWindowContainer));
               this.var_967 = false;
            }
            this._controller.method_8(param1);
         }
      }
      ...
      public function updateSubCategoryView() : void
      {
         ...
         this.setSubViewToCategory(this.var_636);
      }
      ...
      private function setViewToCategory(param1:String) : void
      {
         ...
         _loc2_.container.removeChild(this.var_1491);
         _loc2_.invalidate();
      ...
      private function onHabboToolbarEvent(param1:HabboToolbarEvent) : void
      {
         ...
         {
            if(this.var_637 == InventoryCategory.const_142)
            {
               this.toggleCategoryView(InventoryCategory.const_142);
            }
            else if(this.var_637 == InventoryCategory.const_78)
            {
