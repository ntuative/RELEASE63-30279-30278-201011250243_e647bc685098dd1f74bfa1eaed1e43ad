package com.sulake.habbo.inventory
{
   ...
   public class HabboInventory extends Component implements IHabboInventory
   {
      ...
      private var var_1111:IRoomSession;
      ...
      private const const_1798:int = 500;
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_19 != null)
         {
            this.var_19.events.removeEventListener(RoomSessionEvent.const_88,this.roomSessionEventHandler);
            this.var_19.events.removeEventListener(RoomSessionEvent.const_90,this.roomSessionEventHandler);
            this.var_19.events.removeEventListener(RoomSessionPropertyUpdateEvent.const_490,this.roomSessionEventHandler);
      ...
      {
         return TradingModel(this.var_46.getValue(InventorySubCategory.const_281));
      }
      
      public function get effectsModel() : EffectsModel
      {
         return EffectsModel(this.var_46.getValue(InventoryCategory.const_779));
      }
      
      public function get badgesModel() : BadgesModel
      {
         return BadgesModel(this.var_46.getValue(InventoryCategory.const_264));
      }
      
      public function get achievementsModel() : AchievementsModel
      {
         return AchievementsModel(this.var_46.getValue(InventoryCategory.const_321));
      }
      ...
      {
         return PetsModel(this.var_46.getValue(InventoryCategory.const_142));
      }
      
      public function get marketplaceModel() : MarketplaceModel
      {
         return this.var_46.getValue(InventoryCategory.const_358) as MarketplaceModel;
      }
      ...
      {
         this.var_398 = ISessionDataManager(param2);
         this.initInventory();
      }
      ...
      private function onRoomSessionManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_19.events.addEventListener(RoomSessionEvent.const_88,this.roomSessionEventHandler);
         this.var_19.events.addEventListener(RoomSessionEvent.const_90,this.roomSessionEventHandler);
         this.var_19.events.addEventListener(RoomSessionPropertyUpdateEvent.const_490,this.roomSessionEventHandler);
         this.initInventory();
      }
      ...
      private function roomSessionEventHandler(param1:RoomSessionEvent) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case RoomSessionEvent.const_90:
               this.var_1111 = null;
               break;
            case RoomSessionPropertyUpdateEvent.const_490:
               this.petsModel.updatePetsAllowed();
         }
      }
      ...
      {
         if(!this._communication || !this._windowManager || !this._localization || !this._roomEngine || !this.var_398 || !this._config || !this._catalog || !this._avatarRenderer || !this.var_19 || !this._toolbar)
         {
            return;
         }
         ...
         this.var_46.add(InventoryCategory.const_358,_loc1_);
         ...
         var _loc3_:BadgesModel = new BadgesModel(this,this._windowManager,this._communication,this._assetLibrary,this.var_398);
         this.var_46.add(InventoryCategory.const_264,_loc3_);
         ...
         this.var_46.add(InventoryCategory.const_779,_loc4_);
         var _loc5_:AchievementsModel = new AchievementsModel(this,this._windowManager,this._communication,this._assetLibrary,this._localization,this.var_398);
         this.var_46.add(InventoryCategory.const_321,_loc5_);
         ...
         this.var_46.add(InventorySubCategory.const_281,_loc6_);
         ...
         this.var_46.add(InventoryCategory.const_142,_loc8_);
         this.var_173 = true;
         if(this.var_2458)
         {
            this.requestData();
      ...
      public function toggleInventorySubPage(param1:String) : void
      {
         ...
         switch(param1)
         {
            case InventorySubCategory.const_281:
      ...
      public function requestInventoryCategoryInit(param1:String) : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc2_.requestInitialization(this.const_1798);
         }
      }
      
      public function notifyChangedEffects() : void
      {
         events.dispatchEvent(new HabboInventoryEffectsEvent(HabboInventoryEffectsEvent.const_1094));
      }
