package com.sulake.habbo.inventory.furni
{
   ...
   public class FurniModel implements IInventoryModel
   {
      ...
      public static const const_350:String = "pets";
      
      private static const const_1197:int = 100;
      ...
      public function FurniModel(param1:HabboInventory, param2:MarketplaceModel, param3:IHabboWindowManager, param4:IHabboCommunicationManager, param5:IAssetLibrary, param6:IRoomEngine, param7:IHabboCatalog)
      {
         ...
         this._roomEngine.events.addEventListener(RoomEngineObjectEvent.const_225,this.onObjectPlaced);
         this._catalog = param7;
         this.var_575 = new Timer(const_1197,1);
         this.var_575.addEventListener(TimerEvent.TIMER_COMPLETE,this.onImageUpdateTimerEvent);
         var _loc8_:IAsset = this._assets.getAssetByName("inventory_thumb_xml");
         var _loc9_:XmlAsset = XmlAsset(_loc8_);
         this.var_2331 = XML(_loc9_.content);
         this.clearFurniList();
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            ...
            if(this._roomEngine != null)
            {
               ...
               {
                  this._roomEngine.events.removeEventListener(RoomEngineObjectEvent.const_225,this.onObjectPlaced);
               }
            ...
            {
               this.var_575.removeEventListener(TimerEvent.TIMER_COMPLETE,this.onImageUpdateTimerEvent);
               this.var_575.stop();
               this.var_575 = null;
            }
      ...
      public function createNewGroupItemTemplate(param1:int, param2:String, param3:int, param4:String = null, param5:Number = NaN, param6:Boolean = false) : GroupItem
      {
         ...
         var _loc8_:* = null;
         var _loc9_:* = null;
         if(param3 == FurniCategory.const_364)
         {
         ...
         if(this.var_876 == null)
         {
            this.var_876 = this._windowManager.buildFromXML(this.var_2331) as IWindowContainer;
         }
         var _loc11_:IWindowContainer = this.var_876.clone() as IWindowContainer;
         ...
         if(param1 == InventoryCategory.const_78 && this._controller.isVisible)
         {
            switch(this._view.visibleCategoryId)
            {
               ...
               case const_47:
                  ...
                  break;
               case const_350:
                  this._controller.toggleInventoryPage(InventoryCategory.const_142);
            }
         }
      }
      ...
      public function clearFurniList() : void
      {
         ...
         this.var_471.add(const_41,new Array());
         this.var_471.add(const_47,new Array());
         if(this._view != null)
         {
      ...
      {
         return this._controller.getSubCategoryViewId() == InventorySubCategory.const_281;
      }
      ...
      public function requestSelectedFurniPlacement(param1:Boolean = false) : Boolean
      {
         ...
         if(_loc3_.category == FurniCategory.const_320 || _loc3_.category == FurniCategory.const_364 || _loc3_.category == FurniCategory.const_357)
         {
            if(param1)
            {
               return false;
      ...
      public function requestSelectedFurniToRecycler() : IItem
      {
         ...
         var _loc2_:IItem = _loc1_.method_20();
         if(_loc2_ == null)
         {
            return null;
         }
      ...
      {
         if(this.var_1328 && param1.type == RoomEngineObjectEvent.const_225)
         {
            this.var_1328 = false;
         }
      }
      ...
      {
         return this.var_471.getValue(param1);
      }
      ...
      public function method_3(param1:String) : void
      {
         switch(param1)
         {
            case InventorySubCategory.const_281:
               ...
               break;
            case InventorySubCategory.const_1046:
               this.removeAllLocks();
               if(this._view != null)
               {
                  this._view.updateActionView();
      ...
      public function getAllStripIds(param1:Array) : void
      {
         ...
         var _loc7_:int = 0;
         var _loc8_:int = 0;
         var _loc2_:Array = this.var_471.getKeys();
         var _loc3_:int = 0;
         while(_loc3_ < _loc2_.length)
         {
            _loc4_ = this.var_471.getValue(_loc2_[_loc3_]) as Array;
            if(_loc4_ != null)
            {
               _loc5_ = 0;
               while(_loc5_ < _loc4_.length)
