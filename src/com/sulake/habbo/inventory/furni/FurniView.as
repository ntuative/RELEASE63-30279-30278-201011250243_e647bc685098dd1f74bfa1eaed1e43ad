package com.sulake.habbo.inventory.furni
{
   ...
   public class FurniView implements IInventoryView, IGetImageListener
   {
      ...
      private const const_1813:int = 0;
      
      private const const_827:int = 1;
      
      private const const_1513:int = 2;
      
      private const const_1515:int = 3;
      
      private const const_1514:int = 42;
      
      private const const_1512:int = 120;
      ...
      public function FurniView(param1:FurniModel, param2:MarketplaceModel, param3:IHabboWindowManager, param4:IAssetLibrary, param5:IRoomEngine)
      {
         ...
         this.var_425.add(FurniModel.const_41,new FurniGridView(this.var_62,FurniModel.const_41,this._windowManager,this._assetLibrary,this._roomEngine));
         this.var_425.add(FurniModel.const_47,new FurniGridView(this.var_62,FurniModel.const_47,this._windowManager,this._assetLibrary,this._roomEngine));
      ...
      private function showCategoryGrid(param1:String = null) : void
      {
         ...
         var _loc3_:FurniGridView = this.var_425.getValue(this.var_353);
         if(_loc3_)
         {
      ...
      {
         var _loc2_:int = 0;
         var _loc1_:Array = this.var_62.getCategoryContent(this.var_353);
         if(!this.var_62.isListInited())
         {
            _loc2_ = this.const_827;
         }
         else if(!_loc1_ || _loc1_.length == 0)
         {
            _loc2_ = this.const_1513;
         }
         else
         {
            _loc2_ = this.const_1515;
         }
         if(this.var_1985 == _loc2_)
         {
            return;
         }
         ...
         switch(_loc2_)
         {
            case this.const_827:
               ...
               break;
            case this.const_1513:
               _loc3_.visible = false;
               _loc4_.visible = true;
               _loc5_.visible = false;
               break;
            case this.const_1515:
               _loc3_.visible = false;
               _loc4_.visible = false;
               _loc5_.visible = true;
      ...
      public function updateActionView() : void
      {
         ...
         _loc4_ = this.var_62.getGroupItemInIndex(_loc3_,this.var_353);
         if(_loc3_ > -1 && _loc4_ != null && _loc4_.peek() != null)
         {
            _loc5_ = _loc4_.peek();
            _loc1_ = true;
            if(_loc5_.category == FurniCategory.const_364)
            {
         ...
         if(_loc11_)
         {
            if(_loc1_ && this.var_690 && this.var_690.isEnabled && _loc5_.sellable)
            {
               _loc11_.enable();
            }
            else
      ...
      private function setPreviewImage(param1:BitmapData) : void
      {
         ...
         if(_loc3_ > this.const_1512)
         {
            _loc3_ = this.const_1512;
         }
         else if(_loc3_ < this.const_1514)
         {
            _loc3_ = this.const_1514;
         }
         else
         {
         ...
         else if(param1.type == WindowEvent.const_60)
         {
            switch(param2.name)
            {
               ...
               case "tab_wall":
                  ...
                  break;
               case "tab_pets":
                  this.switchCategory(FurniModel.const_350);
            }
         }
      }
   }
