package com.sulake.habbo.inventory.pets
{
   ...
   public class PetsView implements IInventoryView, IPetImageListener
   {
      ...
      public function PetsView(param1:PetsModel, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IHabboLocalizationManager, param5:IAvatarRenderManager)
      {
         ...
         this.var_435 = this._view.findChildByName("grid") as IItemGridWindow;
      ...
      {
         var _loc2_:PetsGridItem = this.var_577.remove(param1) as PetsGridItem;
         if(_loc2_ == null)
         {
            return;
         }
         this.var_435.removeGridItem(_loc2_.window);
      ...
      {
         if(this.var_577 == null || this.var_577.length == 0)
         {
            this.updatePreview();
            return;
         }
         this.setSelectedGridItem(this.var_577.getWithIndex(0));
      }
      ...
      public function addPet(param1:PetData) : void
      {
         ...
         if(this.var_577.getValue(param1.id) != null)
         {
            return;
         }
         ...
         if(_loc2_ != null)
         {
            this.var_435.addGridItem(_loc2_.window);
            this.var_577.add(param1.id,_loc2_);
