package com.sulake.habbo.avatar
{
   ...
   public class AvatarImage implements IAvatarImage, IDisposable
   {
      ...
      private static const const_1156:String = "Default";
      
      private static const const_1155:int = 2;
      
      private static const const_1154:String = AvatarSetType.const_32;
      ...
      protected var var_722:Boolean;
      
      protected var var_667:Array;
      
      protected var _assets:AssetAliasCollection;
      
      protected var var_213:AvatarImageCache;
      
      protected var var_553:AvatarFigureContainer;
      
      protected var var_497:IAvatarDataContainer;
      
      protected var var_284:Array;
      
      protected var var_37:BitmapData;
      
      private var var_904:IActiveActionData;
      ...
      public function AvatarImage(param1:AvatarStructure, param2:AssetAliasCollection, param3:AvatarFigureContainer, param4:String)
      {
         ...
         this.var_553 = param3;
         this.var_213 = new AvatarImageCache(this._structure,this,this._assets,this._scale);
         this.setDirection(const_1154,const_1155);
         this.var_284 = new Array();
         this.var_904 = new ActiveActionData(AvatarAction.const_365);
         this.var_904.definition = this._structure.getActionDefinition(const_1156);
         this.resetActions();
      ...
      public function dispose() : void
      {
         ...
         if(!this.var_722)
         {
            ...
            if(this.var_638)
            {
               for each(_loc2_ in this.var_638)
               {
                  _loc2_.dispose();
               }
      ...
      {
         return this._structure.getPartColor(this.var_553,param1);
      }
      
      public function setDirection(param1:String, param2:int) : void
      {
         param2 += this.var_1497;
      ...
      {
         return this._structure.getBodyPartData(param1.animation.id,this.var_635,param1.id);
      }
      ...
      private function getFullImageCacheKey() : String
      {
         ...
         if(this.var_258.length == 1 && this.var_83 == this.var_2579)
         {
            return this.var_83 + this.var_532 + this.var_635 % 4;
         }
         if(this.var_258.length == 2)
         {
            for each(_loc1_ in this.var_258)
            {
               ...
               {
                  return this.var_83 + this.var_532 + 0;
               }
            }
         }
         return null;
      ...
      {
         if(param3 != this.var_2005 || param2 != this.var_2004 || param1 != this.var_2006)
         {
            this.var_2005 = param3;
            this.var_2004 = param2;
            this.var_2006 = param1;
            this.var_1496 = this._structure.getBodyParts(param1,param2,param3);
         }
      ...
      public function getImage(param1:String, param2:Boolean) : BitmapData
      {
         ...
         if(this.var_1148 || this.var_37 == null || (this.var_37.width != _loc5_.width || this.var_37.height != _loc5_.height))
         {
            if(this.var_37 != null && !this.var_1148)
            {
               this.var_37.dispose();
            }
         ...
         while(_loc12_ >= 0)
         {
            ...
            _loc9_ = _loc4_.getImageContainer(_loc8_,this.var_635);
         ...
         {
            if(this.var_497.paletteIsGrayscale)
            {
               ...
               this.var_37 = _loc13_;
               this.var_37.paletteMap(this.var_37,this.var_37.rect,new Point(0,0),this.var_497.reds,[],[]);
            }
            else
            {
      ...
      public function getCroppedImage(param1:String) : BitmapData
      {
         ...
         while(_loc12_ >= 0)
         {
            ...
            _loc8_ = _loc2_.getImageContainer(_loc7_,this.var_635);
            if(_loc8_ != null)
            {
               _loc9_ = _loc8_.image;
               if(_loc9_ == null)
      ...
      protected function addActionData(param1:String, param2:String = "") : void
      {
         ...
         this.var_284.push(new ActiveActionData(param1,param2,this.var_635));
      }
      ...
      private function resetActions() : Boolean
      {
         ...
         this.var_248 = this.var_904;
         this.var_248.definition = this.var_904.definition;
         this.resetBodyPartCache(this.var_904);
         return true;
      }
      ...
      private function sortActions() : Boolean
      {
         ...
         var _loc1_:Boolean = false;
         this.var_532 = "";
         this.var_258 = this._structure.sortActions(this.var_284);
         if(this.var_258 == null)
         {
            this.var_667 = new Array(0,0,0);
            if(this.var_1211 != "")
            {
               _loc1_ = true;
               this.var_1211 = "";
         ...
         {
            this.var_667 = this._structure.getCanvasOffsets(this.var_258,this._scale,this.var_83);
            for each(_loc4_ in this.var_258)
            {
               this.var_532 += _loc4_.actionType + _loc4_.actionParameter;
               if(_loc4_.actionType == AvatarAction.const_261)
               {
                  _loc5_ = parseInt(_loc4_.actionParameter);
                  if(this.var_1210 != _loc5_)
                  {
                     _loc2_ = true;
                  }
                  this.var_1210 = _loc5_;
                  _loc3_ = true;
               }
            }
            if(!_loc3_)
            ...
            if(this.var_1211 != this.var_532)
            {
               _loc1_ = true;
               this.var_1211 = this.var_532;
            }
         }
         this.var_1212 = true;
         return _loc1_;
            ...
            if(!(!_loc1_ || !_loc1_.definition))
            {
               ...
               if(_loc1_.definition.isAnimation)
               {
                  ...
                  if(_loc2_ != null)
                  {
                     ...
                     {
                        this.var_1497 = _loc2_.directionData.offset;
                     }
                     if(_loc2_.hasAvatarData())
                     {
                        this.var_497 = _loc2_.avatarData;
                     }
                  }
               }
               if(_loc1_.actionType == AvatarAction.const_307 || _loc1_.actionType == AvatarAction.const_206 || _loc1_.actionType == AvatarAction.const_344)
               {
                  this.var_866 = true;
               }
            }
