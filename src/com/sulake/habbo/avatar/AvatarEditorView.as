package com.sulake.habbo.avatar
{
   ...
   public class AvatarEditorView
   {
      ...
      public static var var_1144:IWindowContainer;
      
      public static var var_1394:IWindowContainer;
      
      public static var var_1840:int = 6710886;
      ...
      private var var_451:ITabSelectorWindow;
      ...
      public function AvatarEditorView(param1:HabboAvatarEditor, param2:IHabboWindowManager, param3:IHabboCatalog, param4:Array, param5:Boolean)
      {
         ...
         var _loc8_:* = null;
         this.var_1024 = [];
         this.var_1214 = [AvatarEditorFigureCategory.const_596,AvatarEditorFigureCategory.const_44,AvatarEditorFigureCategory.const_202,AvatarEditorFigureCategory.const_721,AvatarEditorFigureCategory.const_973,AvatarEditorFigureCategory.const_99];
         super();
         ...
         if(var_1144 == null)
         {
            ...
            var_1144 = this._controller.windowManager.buildFromXML(_loc7_.content as XML) as IWindowContainer;
         }
         if(var_1394 == null)
         {
            _loc8_ = this._controller.assets.getAssetByName("color_chooser_cell") as XmlAsset;
            var_1394 = this._controller.windowManager.buildFromXML(_loc8_.content as XML) as IWindowContainer;
         }
         this.var_377 = new Timer(1000);
         this.var_377.addEventListener(TimerEvent.TIMER,this.onUpdate);
         if(param4 == null)
         {
            param4 = this.var_1214;
         }
      ...
      public function dispose() : void
      {
         ...
         {
            this.var_377.stop();
            this.var_377.removeEventListener(TimerEvent.TIMER,this.onUpdate);
            this.var_377 = null;
         }
      ...
      public function validateAvailableCategories(param1:Array) : Boolean
      {
         ...
         if(param1 == null)
         {
            return this.validateAvailableCategories(this.var_1214);
         }
      ...
      private function onUpdate(param1:Event = null) : void
      {
         ...
         {
            this.var_2180 = this.canChangeOutfit();
            this.var_377.stop();
            if(this._window)
            {
      ...
      private function createWindow(param1:Boolean) : void
      {
         ...
         this.var_451 = this._window.findChildByName("mainTabs") as ITabSelectorWindow;
         var _loc2_:int = this.var_451.numSelectables - 1;
         while(_loc2_ >= 0)
         {
            _loc4_ = this.var_451.getSelectableAt(_loc2_);
            if(_loc4_ != null && this.var_1024.indexOf(_loc4_.name) < 0)
            {
               _loc5_ = this.var_451.removeSelectable(_loc4_);
               _loc6_ = _loc2_ + 1;
               while(_loc6_ < this.var_451.numSelectables)
               {
                  this.var_451.getSelectableAt(_loc6_).x = this.var_451.getSelectableAt(_loc6_).x - _loc5_.width;
                  _loc6_++;
               }
            }
            _loc2_--;
      ...
      private function attachImages() : void
      {
         ...
         var _loc1_:Array = this.var_1214;
      ...
      public function update() : void
      {
         ...
         if(this._controller.sessionData && this._controller.sessionData.hasUserRight("fuse_use_wardrobe") && (this.var_1620 == AvatarEditorSideCategory.const_99 || this.var_2181))
         {
         ...
         this.setViewToCategory(this.var_332);
      }
      ...
      {
         if(this.var_1620 == AvatarEditorSideCategory.const_99)
         {
            this.var_2181 = false;
            this.setSideContent(AvatarEditorSideCategory.const_613);
         }
         else
         {
      ...
      private function setSideContent(param1:String) : void
      {
         ...
         switch(param1)
         {
            case AvatarEditorSideCategory.const_613:
               break;
      ...
      private function setViewToCategory(param1:String) : void
      {
         ...
         this.var_332 = param1;
         this.var_451.setSelected(this.var_451.getSelectableByName(param1));
      ...
      private function displayStripClubDialog() : void
      {
         ...
         if(!this.var_450)
         {
            ...
            this.var_450 = this._windowManager.buildFromXML(_loc2_,2) as IFrameWindow;
            this.var_450.procedure = this.stripClubDialogEventProc;
            this.var_450.center();
         }
         else
         {
