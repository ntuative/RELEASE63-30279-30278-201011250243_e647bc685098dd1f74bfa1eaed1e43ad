package com.sulake.habbo.avatar.animation
{
   ...
   public class AvatarDataContainer implements IAvatarDataContainer
   {
      ...
      {
         super();
         this.var_1798 = parseInt(param1.@ink);
         var _loc2_:String = String(param1.@foreground);
         _loc2_ = _loc2_.replace("#","");
         var _loc3_:String = String(param1.@background);
         _loc3_ = _loc3_.replace("#","");
         this.var_2528 = parseInt(_loc2_,16);
         this.var_2527 = parseInt(_loc3_,16);
         this._rgb = parseInt(_loc2_,16);
         this.var_1526 = this._rgb >> 16 & 255;
         this.var_1525 = this._rgb >> 8 & 255;
         this._b = this._rgb >> 0 & 255;
         this.var_1527 = this.var_1526 / 255 * 1;
         this.var_1524 = this.var_1525 / 255 * 1;
         this.var_1528 = this._b / 255 * 1;
         if(this.var_1798 == 37)
         {
            this._alphaMultiplier = 0.5;
            this.var_2526 = false;
         }
         this.var_1619 = new ColorTransform(this.var_1527,this.var_1524,this.var_1528,this._alphaMultiplier);
         this.var_1128 = this.generatePaletteMapForGrayscale(this.var_2527,this.var_2528);
      }
      ...
      {
         return this.var_1128.getValue("reds") as Array;
      }
      
      public function get greens() : Array
      {
         return this.var_1128.getValue("greens") as Array;
      }
      
      public function get blues() : Array
      {
         return this.var_1128.getValue("blues") as Array;
      }
      
      public function get alphas() : Array
      {
         return this.var_1128.getValue("alphas") as Array;
      }
