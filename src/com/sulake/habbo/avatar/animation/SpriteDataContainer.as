package com.sulake.habbo.avatar.animation
{
   public class SpriteDataContainer implements ISpriteDataContainer
   {
      ...
      private var var_2542:IAnimation;
      ...
      public function SpriteDataContainer(param1:IAnimation, param2:XML)
      {
         ...
         this.var_1798 = parseInt(param2.@ink);
         this.var_2540 = String(param2.@member);
         this.var_2541 = Boolean(parseInt(param2.@directions));
         this._dx = [];
         this.var_1385 = [];
         this.var_1384 = [];
         for each(_loc3_ in param2.direction)
         {
            ...
            this.var_1384[_loc4_] = parseInt(_loc3_.@dz);
         }
      }
      ...
      {
         if(param1 < this.var_1384.length)
         {
