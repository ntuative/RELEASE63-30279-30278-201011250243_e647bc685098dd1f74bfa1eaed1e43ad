package com.sulake.habbo.avatar
{
   ...
   public class PetImage implements IAvatarImage, IDisposable
   {
      ...
      private var var_213:AvatarImageCache;
      ...
      private var var_497:IAvatarDataContainer;
      ...
      public function PetImage(param1:AvatarStructure, param2:AssetAliasCollection, param3:String, param4:String)
      {
         ...
         this.var_553 = new AvatarFigureContainer(param3);
         var _loc5_:int = this.var_553.getPartSetId("pbd");
         this.solvePetAvatarTypeAndBreed(_loc5_);
         this.var_1374 = this.var_1376;
      ...
      public function getImage(param1:String, param2:Boolean) : BitmapData
      {
         ...
         while(_loc7_ >= 0)
         {
            ...
            _loc9_ = _loc3_.getImageContainer(_loc8_,this.var_635);
            if(_loc9_ && _loc9_.image && _loc9_.regPoint)
            {
               ...
               _loc15_ = this._structure.getParts(_loc8_,this.var_553,_loc13_,"pet",_loc12_.getDirection(),[]);
               ...
               {
                  _loc18_ = _loc15_[0];
                  _loc19_ = _loc18_.getFrameIndex(this.var_635);
                  _loc20_ = this.var_83;
                  _loc21_ = 1;
                  switch(this.var_83)
                  {
      ...
      public function getCroppedImage(param1:String) : BitmapData
      {
         ...
         while(_loc7_ >= 0)
         {
            ...
            _loc10_ = _loc2_.getImageContainer(_loc9_,this.var_635);
            if(_loc10_ != null)
            {
               ...
               _loc16_ = this._structure.getParts(_loc9_,this.var_553,_loc14_,"pet",_loc13_.getDirection(),[]);
               _loc17_ = 32;
               if(this._scale == AvatarScaleType.const_83)
               {
                  _loc17_ = 6;
               ...
               {
                  _loc19_ = _loc16_[0];
                  _loc20_ = _loc19_.getFrameIndex(this.var_635);
                  _loc21_ = this.var_83;
                  _loc22_ = 1;
                  switch(this.var_83)
                  {
      ...
      public function appendAction(param1:String, ... rest) : Boolean
      {
         ...
         this.var_532 = this.var_532 + param1 + _loc3_;
         switch(param1)
         {
      ...
      private function addActionData(param1:String, param2:String = "") : void
      {
         ...
         this.var_284.push(new ActiveActionData(param1,param2));
      }
      ...
      private function resetActions() : Boolean
      {
         ...
         this.setActionToParts(this.var_904);
         this.getCache().resetBodyPartCache(this.var_904);
         return true;
      }
      ...
      private function sortActions() : void
      {
         ...
         this.var_1375 = this._structure.sortActions(this.var_284);
         ...
         {
            this.var_667 = this._structure.getCanvasOffsets(this.var_1375,this._scale,this.var_83);
         }
      }
      ...
      private function setActionsToParts() : void
      {
         ...
         for each(_loc1_ in this.var_1375)
         {
            if(!(!_loc1_ || !_loc1_.definition))
            {
               ...
               if(_loc1_.actionType == AvatarAction.const_307)
               {
                  this.var_866 = true;
               }
            }
         ...
         if(_loc2_ != null)
         {
            ...
            if(_loc3_ != null)
            {
               for each(_loc4_ in _loc3_.parts)
               {
                  if(_loc4_.type == "pbd")
                  {
                     this.var_1376 = _loc4_.id;
                     this.var_1795 = _loc4_.breed;
                     break;
                  }
               }
            }
