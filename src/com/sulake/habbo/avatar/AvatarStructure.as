package com.sulake.habbo.avatar
{
   ...
   public class AvatarStructure extends EventDispatcher
   {
      ...
      private var var_384:FigureData;
      ...
      private var var_904:ActionDefinition;
      
      private var var_458:String;
      
      private var var_1645:PartOffsetData;
      ...
      {
         this.var_1645.loadOffsets(param1);
      }
      ...
      public function initActions(param1:IAssetLibrary, param2:XML) : void
      {
         ...
         this.var_851 = new AvatarActionManager(param1,this.var_458,param2);
         this.var_904 = this.var_851.getDefaultAction();
      }
      ...
      public function initPartSets(param1:XML) : Boolean
      {
         ...
         {
            if(this.var_458 == AvatarType.const_104)
            {
      ...
      public function initFigureData(param1:XML) : Boolean
      {
         ...
         return this.var_384.parse(param1);
      }
      
      public function injectFigureData(param1:XML) : void
      {
         this.var_384.injectXML(param1);
      }
      ...
      public function getPartColor(param1:AvatarFigureContainer, param2:String, param3:int = 0) : IPartColor
      {
         ...
         var _loc5_:ISetType = this.var_384.getSetType(param2);
         if(_loc5_ == null)
         {
            return null;
         }
         var _loc6_:IPalette = this.var_384.getPalette(_loc5_.paletteID);
         if(!_loc6_)
         {
            return null;
         }
      ...
      {
         return this.var_851.getActionDefinition(param1);
      }
      
      public function getActionDefinitionWithState(param1:String) : ActionDefinition
      {
         return this.var_851.getActionDefinitionWithState(param1);
      }
      ...
      {
         return this.var_851.sortActions(param1);
      }
      ...
      public function getMandatorySetTypeIds(param1:String, param2:int) : Array
      {
         ...
         {
            this.var_671[param1] = new Dictionary();
         }
         if(this.var_671[param1][param2])
         {
            return this.var_671[param1][param2];
         }
         this.var_671[param1][param2] = this.var_384.getMandatorySetTypeIds(param1,param2);
         return this.var_671[param1][param2];
      }
      
      public function getDefaultPartSet(param1:String, param2:String) : IFigurePartSet
      {
         return this.var_384.getDefaultPartSet(param1,param2);
      }
      
      public function getCanvasOffsets(param1:Array, param2:String, param3:int) : Array
      {
         return this.var_851.getCanvasOffsets(param1,param2,param3);
      }
      ...
      {
         var _loc4_:Number = AvatarDirectionAngle.const_1475[param3];
      ...
      public function getParts(param1:String, param2:AvatarFigureContainer, param3:IActiveActionData, param4:String, param5:int, param6:Array, param7:Dictionary = null) : Array
      {
         ...
         for each(_loc16_ in _loc20_)
         {
            ...
            _loc29_ = this.var_384.getSetType(_loc16_);
            if(_loc29_)
            {
               _loc30_ = this.var_384.getPalette(_loc29_.paletteID);
               if(_loc30_)
               {
      ...
      {
         return this.var_1645.getOffset(param1,param2,param3,param4,param5,param6);
      }
