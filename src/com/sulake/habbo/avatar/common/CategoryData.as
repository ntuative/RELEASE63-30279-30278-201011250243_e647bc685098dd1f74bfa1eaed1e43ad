package com.sulake.habbo.avatar.common
{
   ...
   public class CategoryData
   {
      ...
      public function dispose() : void
      {
         ...
         if(this.var_215)
         {
            for each(_loc2_ in this.var_215 as Array)
            {
               if(_loc2_)
               {
      ...
      public function selectPartIndex(param1:int) : AvatarEditorGridPartItem
      {
         ...
         if(this.var_778 >= 0 && this._parts.length > this.var_778)
         {
            _loc2_ = this._parts[this.var_778];
            if(_loc2_)
            {
               _loc2_.isSelected = false;
            }
      ...
      public function getSelectedColorIds() : Array
      {
         ...
         var _loc1_:Array = this.var_215[0] as Array;
      ...
      public function getPalette(param1:int) : Array
      {
         ...
         if(this.var_215.length <= param1)
         {
            return null;
         }
         return this.var_215[param1] as Array;
      }
      
      public function getCurrentPart() : AvatarEditorGridPartItem
      {
         return this._parts[this.var_778] as AvatarEditorGridPartItem;
      }
