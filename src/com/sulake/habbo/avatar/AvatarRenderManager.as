package com.sulake.habbo.avatar
{
   ...
   public class AvatarRenderManager extends Component implements IAvatarRenderManager
   {
      ...
      private var var_313:PetDataManager;
      
      private var var_664:PaletteManager;
      ...
      private var var_1631:AvatarFigureContainer;
      ...
      public function AvatarRenderManager(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_606 = RenderMode.const_1360;
         ...
         this.var_94.add(AvatarType.const_104,_loc4_);
         ...
         this.var_94.add(AvatarType.const_68,_loc4_);
         this._aliasCollection = new AssetAliasCollection(this,param1.assets as AssetLibraryCollection);
         this.var_313 = new PetDataManager(this,param1.assets as AssetLibraryCollection);
         this.var_664 = new PaletteManager(param1.assets as AssetLibraryCollection);
         var _loc5_:XML = param3.getAssetByName("HabboAvatarPetFigure").content as XML;
         this.var_313.populateFigureData(_loc5_);
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_94 != null)
         {
            for each(_loc1_ in this.var_94.getValues())
            {
               _loc1_.dispose();
            }
            this.var_94.dispose();
      ...
      private function onAllModulesReadyAndRunning(param1:Event) : void
      {
         ...
         this.var_313.init();
         this.var_664.init();
         _loc2_ = this.var_94.getValue(AvatarType.const_104) as AvatarStructure;
         if(_loc2_)
         {
         ...
         _loc2_ = this.var_94.getValue(AvatarType.const_68) as AvatarStructure;
         if(_loc2_)
         {
            _loc2_.resetPartOffsets(context.assets);
         }
      ...
      private function onHabboConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(param2 != null)
         {
            ...
            _loc3_ = this.var_94.getValue(AvatarType.const_104) as AvatarStructure;
            if(_loc3_ != null)
            {
      ...
      private function checkIfReady() : void
      {
         if(!this.var_811)
         {
            if(this.var_2202 && this.var_2204 && this.var_2203)
            {
      ...
      {
         var _loc5_:AvatarStructure = this.var_94.getValue(AvatarType.const_104) as AvatarStructure;
         if(_loc5_ == null)
         {
            return null;
         }
         ...
         if(!this.var_1631)
         {
            this.var_1631 = new AvatarFigureContainer(this.const_1789);
         }
         this.var_196.loadFigureSetData(_loc6_,param4);
         return new PlaceholderAvatarImage(_loc5_,this._aliasCollection,this.var_1631,param2);
      }
      ...
      public function removePetImageListener(param1:IPetImageListener) : void
      {
         ...
         var _loc4_:* = null;
         var _loc5_:int = 0;
         if(param1 == null || this.var_268 == null)
         {
            return;
         }
         var _loc2_:Array = new Array();
         for each(_loc3_ in this.var_268.getKeys())
         {
            _loc4_ = this.var_268.getValue(_loc3_);
            if(_loc4_ != null)
            {
      ...
      public function createPetImage(param1:int, param2:int, param3:uint, param4:String, param5:IPetImageListener = null) : IAvatarImage
      {
         var _loc9_:* = null;
         var _loc6_:* = false;
         if(this.mode != RenderMode.const_1312)
         {
            _loc6_ = !this.var_313.assetsReady(param1,param4);
         }
         var _loc7_:String = this.var_313.createPetFigureString(param1,param2,param3);
         var _loc8_:AvatarStructure = this.var_94.getValue(AvatarType.const_68) as AvatarStructure;
         if(_loc8_ == null)
         {
            return null;
         }
         ...
         if(param5 != null)
         {
            ...
            this.var_268.add(_loc7_,_loc9_);
         }
      ...
      public function resetPetData() : void
      {
         ...
         this.var_313.populateFigureData(_loc1_);
         var _loc2_:AvatarStructure = this.var_94.getValue(AvatarType.const_68);
         _loc2_.initFigureData(_loc1_);
         _loc2_.resetPartOffsets(context.assets);
         var _loc5_:Array = this.var_268.getKeys();
         for each(_loc6_ in _loc5_)
         {
            _loc4_ = this.var_268.getValue(_loc6_);
            if(_loc4_)
            {
      ...
      {
         var _loc2_:AvatarStructure = this.var_94.getValue(param1) as AvatarStructure;
         if(_loc2_ != null)
         {
      ...
      {
         var _loc3_:AvatarStructure = this.var_94.getValue(AvatarType.const_104) as AvatarStructure;
      ...
      {
         return this.var_313 as IPetDataManager;
      }
      ...
      public function injectFigureData(param1:String, param2:XML) : void
      {
         ...
         switch(param1)
         {
            ...
            case AvatarType.const_68:
               _loc3_ = this.var_94.getValue(AvatarType.const_68) as AvatarStructure;
               break;
            default:
