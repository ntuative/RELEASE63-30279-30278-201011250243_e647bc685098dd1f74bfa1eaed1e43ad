package com.sulake.habbo.avatar
{
   ...
   public class HabboAvatarEditor extends Component implements IHabboAvatarEditor
   {
      ...
      private static const const_1135:String = "hr-100.hd-180-7.ch-215-66.lg-270-79.sh-305-62.ha-1002-70.wa-2007";
      
      private static const const_1137:String = "hr-515-33.hd-600-1.ch-635-70.lg-716-66-62.sh-735-68";
      ...
      private var var_629:ISessionDataManager;
      
      private var _view:AvatarEditorView;
      
      private var var_950:AvatarEditorHandler;
      ...
      private function init() : void
      {
         ...
         if(!this.var_173)
         {
            ...
            _loc1_.loadAvatarData(const_1135,FigureData.const_73);
            _loc2_.loadAvatarData(const_1137,FigureData.FEMALE);
            this.var_90 = new Map();
            this.var_419 = new Map();
            this.var_90.add(AvatarEditorFigureCategory.const_596,new BodyModel(this));
            this.var_90.add(AvatarEditorFigureCategory.const_44,new HeadModel(this));
            this.var_90.add(AvatarEditorFigureCategory.const_202,new TorsoModel(this));
            this.var_90.add(AvatarEditorFigureCategory.const_721,new LegsModel(this));
            this.var_90.add(AvatarEditorFigureCategory.const_973,new HotLooksModel(this));
            this.var_419.add(AvatarEditorSideCategory.const_99,new WardrobeModel(this));
            this.var_419.add(AvatarEditorSideCategory.const_397,new ClubPromoModel(this));
            this.var_173 = true;
         }
      }
      ...
      public function openEditor(param1:IWindowContainer = null, param2:IHabboAvatarEditorDataSaver = null, param3:Array = null, param4:Boolean = false, param5:Boolean = true) : Boolean
      {
         ...
         else
         {
            if(this.var_216 == null)
            {
               this.var_216 = this._windowManager.createWindow("avatarEditorContainer","",HabboWindowType.const_58,HabboWindowStyle.const_35,0 | 0,new Rectangle(0,0,2,2),null,0) as IWindowContainer;
               this.var_216.addChild(this._view.window);
               if(param5)
               {
                  this.var_216.center();
               }
            ...
            this.var_216.visible = !this.var_216.visible;
         }
         this._view.show();
         ...
         {
            this.toggleAvatarEditorPage(AvatarEditorFigureCategory.const_596);
         }
      ...
      {
         var _loc2_:ISideContentModel = this.var_419.getValue(param1) as ISideContentModel;
         if(_loc2_ != null)
         {
            return _loc2_.getWindowContainer();
         }
      ...
      private function onSessionDataManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_629 = param2 as ISessionDataManager;
      }
      ...
      private function onAvatarRenderManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         (this.var_418 as Component).events.addEventListener(AvatarRenderEvent.AVATAR_RENDER_READY,this.onAvatarRendererReady);
      }
      
      private function onAvatarRendererReady(param1:Event = null) : void
      {
         this.var_779 = this.var_418.getFigureData(AvatarType.const_104);
      ...
      private function onCommunicationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_950 = new AvatarEditorHandler(this,this._communication);
      }
      ...
      {
         return this.var_522[this.var_819];
      }
      ...
      public function saveCurrentSelection() : void
      {
         ...
         if(this.var_1197 != null)
         {
            ...
            this.var_1197.saveFigure(_loc1_,_loc2_);
         }
      }
      ...
      public function generateDataContent(param1:IAvatarEditorCategoryModel, param2:String) : CategoryData
      {
         ...
         if(_loc8_ != null)
         {
            ...
            _loc12_ = this.isClubTryoutAllowed() && this.var_1462;
            for each(_loc13_ in _loc9_.colors)
            {
               if(_loc13_.isSelectable && (_loc12_ || this.var_949 >= _loc13_.clubLevel))
               {
                  _loc17_ = 0;
                  while(_loc17_ < this.const_1136)
                  {
                     _loc18_ = new AvatarEditorGridColorItem(AvatarEditorView.var_1394.clone() as IWindowContainer,param1,_loc13_);
            ...
            {
               _loc20_ = 2;
               _loc14_ = this.var_418.getMandatoryAvatarPartSetIds(this.gender,_loc20_);
            }
            else
            {
               _loc14_ = this.var_418.getMandatoryAvatarPartSetIds(this.gender,this.clubMemberLevel);
            }
            ...
            if(_loc15_)
            {
               ...
               if(_loc21_)
               {
                  ...
                  _loc7_ = new AvatarEditorGridPartItem(AvatarEditorView.var_1144.clone() as IWindowContainer,param1,null,null,false);
            ...
            {
               _loc23_ = false;
               if(_loc6_.gender == FigureData.const_1285)
               {
                  _loc23_ = true;
               }
               ...
               if(_loc6_.isSelectable && _loc23_ && (_loc12_ || this.var_949 >= _loc6_.clubLevel))
               {
                  _loc7_ = new AvatarEditorGridPartItem(AvatarEditorView.var_1144.clone() as IWindowContainer,param1,_loc6_,_loc11_,_loc16_);
                  _loc3_.push(_loc7_);
               }
            }
         }
      ...
      public function getDefaultColour(param1:String) : int
      {
         ...
         if(_loc2_ != null)
         {
            ...
            {
               if(_loc4_.isSelectable && this.var_949 >= _loc4_.clubLevel)
               {
                  return _loc4_.id;
               }
            }
      ...
      public function get wardrobe() : WardrobeModel
      {
         ...
         return this.var_419.getValue(AvatarEditorSideCategory.const_99);
      }
