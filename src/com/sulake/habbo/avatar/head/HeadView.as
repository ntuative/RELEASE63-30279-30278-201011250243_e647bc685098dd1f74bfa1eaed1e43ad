   ...
   public class HeadView extends CategoryBaseView implements IAvatarEditorCategoryView
   {
      ...
      override public function init() : void
      {
         ...
         if(!var_33)
         {
            ...
            var_33["null"] = new AvatarEditorGridView(var_62,FigureData.const_164,_windowManager,_assetLibrary);
            var_33["null"] = new AvatarEditorGridView(var_62,FigureData.const_217,_windowManager,_assetLibrary);
            var_33["null"] = new AvatarEditorGridView(var_62,FigureData.const_234,_windowManager,_assetLibrary);
            var_33["null"] = new AvatarEditorGridView(var_62,FigureData.const_200,_windowManager,_assetLibrary);
         ...
         if(var_62 && var_130 == "")
         {
            var_62.switchCategory(FigureData.const_164);
         }
      }
      ...
      private function windowEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            ...
            {
               case "tab_hair":
                  this.switchCategory(FigureData.const_164);
                  break;
               case "tab_hat":
               ...
               case "tab_accessories":
                  ...
                  break;
               case "tab_eyewear":
                  this.switchCategory(FigureData.const_200);
                  break;
               case "tab_masks":
