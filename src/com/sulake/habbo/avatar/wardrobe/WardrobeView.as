package com.sulake.habbo.avatar.wardrobe
{
   ...
   public class WardrobeView implements ISideContentView
   {
      ...
      public function WardrobeView(param1:WardrobeModel)
      {
         ...
         this.var_830 = this._window.findChildByName("hc_slots") as IItemListWindow;
         this.var_1017 = this._window.findChildByName("vip_slots") as IItemListWindow;
      ...
      public function update() : void
      {
         ...
         while(_loc3_ < _loc1_.length)
         {
            ...
            if(_loc3_ < 5)
            {
               if(this.var_830)
               {
                  this.var_830.addListItem(_loc2_.view);
                  _loc2_.view.visible = true;
               }
            }
            else if(this.var_1017)
            {
