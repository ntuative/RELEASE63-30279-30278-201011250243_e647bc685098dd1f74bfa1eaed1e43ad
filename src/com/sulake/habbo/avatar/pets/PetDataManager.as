package com.sulake.habbo.avatar.pets
{
   ...
   public class PetDataManager implements IPetDataManager
   {
      ...
      public function removeListener(param1:IPetDataListener = null) : void
      {
         ...
         var _loc2_:int = this.var_444.indexOf(param1);
         if(_loc2_ != -1)
         {
            this.var_444.splice(_loc2_,1);
         }
      }
      ...
      {
         var _loc1_:* = null;
         while(this.var_444.length > 0)
         {
            _loc1_ = this.var_444.pop() as IPetDataListener;
      ...
      public function assetsReady(param1:int, param2:String, param3:IPetDataListener = null) : Boolean
      {
         ...
         {
            if(this.var_1253.indexOf(_loc6_) == -1)
            {
               _loc7_ = false;
               if(this.var_551.getValue(_loc6_) == null)
               {
                  ...
                  this.var_551.add(_loc6_,_loc8_);
                  if(param3 != null && this.var_444.indexOf(param3) == -1)
                  {
                     this.var_444.push(param3);
                  }
               }
            }
         }
      ...
      private function unregisterLoadingAssets(param1:LibraryLoader) : void
      {
         ...
         for each(_loc3_ in this.var_551.getKeys())
         {
            _loc5_ = this.var_551.getValue(_loc3_);
            if(param1 == _loc5_)
            {
               _loc2_.push(_loc3_);
            }
