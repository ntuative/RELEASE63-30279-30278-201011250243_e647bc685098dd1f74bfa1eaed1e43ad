package com.sulake.habbo.communication
{
   ...
   public class HabboCommunicationManager extends Component implements IHabboCommunicationManager, IConnectionStateListener
   {
      ...
      {
         if(this.var_247.length == 0 || this.var_397 < 0 || this.var_397 >= this.var_247.length)
         {
            return 0;
         }
         return this.var_247[this.var_397];
      }
      ...
      private function onCoreCommunicationManagerInit(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(param2 != null)
         {
            ...
            this.var_283.registerProtocolType(HabboProtocolType.const_1085,WedgieProtocol);
            this._connection = this.var_283.createConnection(HabboConnectionType.const_214,ConnectionType.const_894);
            _loc3_ = this.var_283.getProtocolInstanceOfType(HabboProtocolType.const_1085);
      ...
      private function onHabboConfigurationInit(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(param2 != null)
         {
            ...
            this.var_247 = [];
            this.var_32 = this.var_117.getKey("connection.info.host",null);
            if(this.var_32 == null)
            {
            ...
            {
               this.var_32 = this.var_117.getKey("connection.info.host.local");
               _loc3_ = this.var_117.getKey("connection.info.port.local");
            }
            _loc4_ = this.validateHost();
            if(!_loc4_)
            {
               Core.crash("Tried to connect to an invalid host: " + this.var_32,Core.const_276);
               return;
            }
            _loc5_ = _loc3_.split(",");
      ...
      private function nextPort() : void
      {
         ...
         if(this.var_397 >= this.var_247.length)
         {
            ...
            if(this.var_910 > _loc1_)
            {
               ...
               this.var_2535 = true;
               Core.error("Connection failed to host " + this.var_32 + " ports " + this.var_247,true,Core.const_276);
               return;
            }
            this.var_397 = 0;
         }
         this._connection.timeout = this.var_910 * 10000;
         this._connection.init(this.var_32,this.var_247[this.var_397]);
      }
      ...
      private function onIOError(param1:IOErrorEvent) : void
      {
         ...
         ErrorReportStorage.addDebugData("Communication IO Error","IOError " + param1.type + " on connect: " + param1.text + ". Port was " + this.var_247[this.var_397]);
         this.tryNextPort();
      }
      ...
      {
         this.var_1383.addEventListener(TimerEvent.TIMER,this.onTryNextPort);
         this.var_1383.start();
      }
      ...
      private function onSecurityError(param1:SecurityErrorEvent) : void
      {
         ...
         ErrorReportStorage.addDebugData("Communication Security Error","SecurityError on connect: " + param1.text + ". Port was " + this.var_247[this.var_397]);
         this.tryNextPort();
      }
      
      public function getHabboMainConnection(param1:Function) : IConnection
      {
         return !!this.var_283 ? this.var_283.queueConnection(HabboConnectionType.const_214,param1) : null;
      }
      ...
      public function addHabboConnectionMessageEvent(param1:IMessageEvent) : void
      {
         if(this.var_283)
         {
            this.var_283.addConnectionMessageEvent(HabboConnectionType.const_214,param1);
         }
      }
      ...
      {
         ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1434,param1);
         ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1480,String(param2));
      }
      
      public function messageReceived(param1:String, param2:String) : void
      {
         ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1301,String(new Date().getTime()));
         ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1371,param1 + " " + param2);
      ...
      {
         ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1472,String(new Date().getTime()));
         ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1364,param1 + " " + param2);
         if(this.var_125.length > 0)
         {
