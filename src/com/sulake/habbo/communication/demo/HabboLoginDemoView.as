package com.sulake.habbo.communication.demo
{
   ...
   public class HabboLoginDemoView extends EventDispatcher
   {
      ...
      public static const const_484:String = "InitConnection";
      ...
      private function createWindow() : void
      {
         ...
         this._window = this.var_159.windowManager.createWindow("habbo_login_window","Login",HabboWindowType.const_139,HabboWindowStyle.const_38,0 | 0,new Rectangle(10,10,320,240),null) as IFrameWindow;
      ...
      private function windowEventProcessor(param1:WindowEvent = null, param2:IWindow = null) : void
      {
         ...
         {
            dispatchEvent(new Event(const_484));
         }
      }
      ...
      private function initSSOTicket() : void
      {
         ...
         {
            this.var_160.removeEventListener(SSOTicket.const_379,this.onParsedTicketSuccess);
            this.var_160.removeEventListener(SSOTicket.const_282,this.onParsedTicketFailure);
            this.var_160 = null;
         }
         var _loc1_:String = "";
         if(this.var_159.habboConfiguration != null)
         {
            _loc1_ = this.var_159.habboConfiguration.getKey("url.prefix",_loc1_);
            _loc1_ = _loc1_.replace("http://","");
            _loc1_ = _loc1_.replace("https://","");
         }
         var _loc2_:IHabboWebLogin = this.var_159.habboCommunication.habboWebLogin(this.name,this.password);
         this.var_160 = new SSOTicket(this.var_159.assets,_loc2_,_loc1_);
         this.var_160.addEventListener(SSOTicket.const_379,this.onParsedTicketSuccess);
         this.var_160.addEventListener(SSOTicket.const_282,this.onParsedTicketFailure);
      }
      
      private function onParsedTicketSuccess(param1:Event) : void
      {
         Logger.log("Got ticket: " + this.var_160.ticket);
         this.var_159.shockwaveClientUrl = this.var_160.shockwaveClientUrl;
         this.var_159.ssoTicket = this.var_160.ticket;
         this.var_160.removeEventListener(SSOTicket.const_379,this.onParsedTicketSuccess);
         this.var_160.removeEventListener(SSOTicket.const_282,this.onParsedTicketFailure);
         this.var_160 = null;
         dispatchEvent(new Event(const_484));
