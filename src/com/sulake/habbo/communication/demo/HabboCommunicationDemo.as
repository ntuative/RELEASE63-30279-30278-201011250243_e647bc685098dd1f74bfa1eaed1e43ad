package com.sulake.habbo.communication.demo
{
   ...
   public class HabboCommunicationDemo extends Component
   {
      ...
      private var var_2106:PseudoRandom;
      ...
      public function setSSOTicket(param1:String) : void
      {
         ...
         {
            this.var_552 = param1;
            this.var_43.initConnection(HabboConnectionType.const_214);
         }
      }
      ...
      {
         if(this.var_43 && this.var_117 && this.var_19 && this._windowManager)
         {
      ...
      private function componentsAreRunning() : void
      {
         ...
         this.var_552 = this.var_117.getKey("sso.ticket",null);
         this.var_1559 = this.var_117.getKey("flash.client.url","");
         this.var_2107 = this.var_117.getKey("external.variables.txt","");
         if(this.var_193 == null)
         {
            this.var_193 = new HabboHotelView(this._windowManager,assets,Component(context).events);
         }
         if(_loc3_)
         {
            this.var_43.mode = HabboConnectionType.const_107;
            if(this.var_552)
            {
               this.var_43.initConnection(HabboConnectionType.const_214);
            }
         ...
         else if(this._windowManager != null)
         {
            ...
            if(_loc4_)
            {
               ...
               this._view.addEventListener(HabboLoginDemoView.const_484,this.onInitConnection);
            }
         }
      }
      ...
      private function onInitConnection(param1:Event = null) : void
      {
         ...
         else
         {
            ...
            {
               this.var_43.mode = HabboConnectionType.const_1030;
            }
         }
         this.var_43.initConnection(HabboConnectionType.const_214);
      }
      ...
      private function onConnectionEstablished(param1:Event = null) : void
      {
         ...
         if(_loc2_ != null)
         {
            this.dispatchLoginStepEvent(HabboCommunicationEvent.const_607);
      ...
      private function onInitCrypto(param1:IMessageEvent) : void
      {
         ...
         this.var_2106 = new PseudoRandom(parseInt(_loc4_.substring(_loc4_.length - 4),16),65536);
         switch(this.var_43.mode)
         {
            case HabboConnectionType.const_107:
               _loc6_ = "";
               ...
               this.var_193.loadBannerImage(_loc7_ + "?token=" + this.var_1254,this.onHotelViewBannerLoaded);
               break;
            case HabboConnectionType.const_1030:
               this.sendConnectionParameters(_loc2_);
               break;
            case HabboConnectionType.const_1416:
               this.var_818 = this.generateRandomHexString(30);
               ...
               this.var_445.init(this.var_818);
      ...
      private function onSecretKeyEvent(param1:IMessageEvent) : void
      {
         ...
         var _loc7_:IEncryption = new RC4_R27(_loc6_,this.var_2106);
      ...
      private function sendConnectionParameters(param1:IConnection) : void
      {
         ...
         connection.send(new VersionCheckMessageComposer(401,this.var_1559,this.var_2107));
      ...
      private function onSessionParamsEvent(param1:IMessageEvent) : void
      {
         ...
         if(this.var_552 != null)
         {
            _loc4_ = new SSOTicketMessageComposer(this.var_552);
            _loc2_.send(_loc4_);
      ...
      private function onConnectionDisconnected(param1:Event) : void
      {
         ...
         if(param1.type == Event.CLOSE && !this.var_2108)
         {
      ...
      private function onHotelViewBannerLoaded(param1:BitmapData) : void
      {
         ...
         var _loc4_:String = xor(_loc3_,this.var_1254);
