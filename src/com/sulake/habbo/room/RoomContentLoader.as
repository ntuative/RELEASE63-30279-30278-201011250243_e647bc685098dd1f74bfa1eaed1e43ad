package com.sulake.habbo.room
{
   ...
   public class RoomContentLoader implements IRoomContentLoader, IFurniDataListener, IDisposable
   {
      ...
      public static const const_792:String = "RCL_LOADER_READY";
      
      private static const const_308:String = "RCL_PUBLICROOM_";
      
      private static const const_1521:int = 0;
      
      private static const const_827:int = 1;
      
      private static const name_2:int = 2;
      
      private static const const_382:String = "place_holder";
      
      private static const const_541:String = "wall_place_holder";
      
      private static const const_1171:String = const_382;
      
      private static const ROOM_CONTENT:String = "room";
      
      private static const const_828:String = "tile_cursor";
      ...
      private var var_1252:IEventDispatcher = null;
      ...
      public function RoomContentLoader()
      {
         this.var_549 = [];
         this._wallItems = [];
         this.var_2091 = ["hh_people_pool","hh_people_pool_calippo","hh_paalu","hh_people_paalu"];
         this.var_2092 = ["room_public","room_public_park","room_public_pool"];
         super();
      ...
      {
         if(this._state >= const_827)
         {
            return;
         }
         this.var_1252 = param1;
         this.var_2095 = param2.getKey("flash.dynamic.download.url","furniture/");
         this.var_2093 = param2.getKey("flash.dynamic.download.name.template","%typeid%.swf");
         this.var_2089 = param2.getKey("public.room.dynamic.download.url","");
         this.var_2090 = param2.getKey("public.room.dynamic.download.name.template","%typeid%.swf");
      ...
      private function initFurniData() : void
      {
         ...
         var _loc1_:Array = this.var_398.getFurniData(this);
         if(_loc1_ == null)
         {
            return;
         }
      ...
      public function dispose() : void
      {
         ...
         {
            _loc1_ = this.var_441.length;
            _loc2_ = 0;
            while(_loc2_ < _loc1_)
            {
               _loc3_ = this.var_441.getWithIndex(_loc2_) as AssetLibrary;
               if(_loc3_ != null)
               {
                  _loc3_.dispose();
               }
         ...
         {
            _loc1_ = this.var_373.length;
            _loc2_ = 0;
            while(_loc2_ < _loc1_)
            {
               _loc4_ = this.var_373.getWithIndex(_loc2_) as IGraphicAssetCollection;
               if(_loc4_ != null)
               {
                  _loc4_.dispose();
               }
      ...
      private function populateFurniData(param1:Array) : void
      {
         ...
         for each(_loc2_ in param1)
         {
            ...
            if(_loc6_.length > 0)
            {
               this.var_648.add(_loc4_,_loc6_);
            }
            _loc7_ = _loc2_.name;
            if(_loc2_.type == "s")
            {
               this.var_548.add(_loc3_,_loc4_);
               if(this.var_549.indexOf(_loc7_) < 0)
               {
                  this.var_549.push(_loc7_);
               }
            }
            ...
            _loc8_ = this.var_547.getValue(_loc7_);
            if(_loc5_ > _loc8_)
            {
               this.var_547.remove(_loc7_);
               this.var_547.add(_loc7_,_loc5_);
            }
         }
      }
      ...
      private function continueInitilization() : void
      {
         if(this.var_2094)
         {
            ...
            {
               this.var_1252.dispatchEvent(new Event(const_792));
            }
         }
      }
      ...
      public function setRoomObjectAlias(param1:String, param2:String) : void
      {
         if(this.var_442 != null)
         {
            ...
            this.var_442.add(param1,param2);
         }
         if(this.var_443 != null)
         {
      ...
      private function getRoomObjectAlias(param1:String) : String
      {
         ...
         if(this.var_442 != null)
         {
            _loc2_ = this.var_442.getValue(param1) as String;
         }
         if(_loc2_ == null)
         {
            _loc2_ = param1;
      ...
      public function getObjectCategory(param1:String) : int
      {
         ...
         if(this.var_549.indexOf(param1) >= 0)
         {
      ...
      {
         return [const_382,const_541,ROOM_CONTENT,const_828,const_829];
      }
      ...
      {
         var _loc3_:String = this.var_550.getValue(param1) as String;
      ...
      {
         if(param1 == RoomObjectVisualizationEnum.const_166 || param1 == RoomObjectVisualizationEnum.const_68 || param1 == RoomObjectVisualizationEnum.BOT)
         {
            return true;
         }
         return false;
      ...
      private function getObjectRevision(param1:String) : int
      {
         ...
         if(_loc2_ == RoomObjectCategoryEnum.const_28 || _loc2_ == RoomObjectCategoryEnum.const_27)
         {
            ...
            return int(this.var_547.getValue(param1));
         }
         return 0;
      }
      ...
      private function getObjectContentURLs(param1:String) : Array
      {
         ...
         switch(_loc2_)
         {
            ...
            default:
               ...
               {
                  _loc10_ = this.var_2090;
                  _loc10_ = _loc10_.replace(/%typeid%/,_loc7_[_loc9_]);
                  _loc8_.push(this.var_2089 + _loc10_);
                  _loc9_++;
               }
               return _loc8_;
         }
      ...
      public function insertObjectContent(param1:int, param2:int, param3:IAssetLibrary) : Boolean
      {
         ...
         if(_loc5_)
         {
            ...
            if(this.initializeGraphicAssetCollection(_loc4_,param3))
            {
               ...
               {
                  case RoomObjectCategoryEnum.const_28:
                     if(this.var_549.indexOf(_loc4_) == -1)
                     {
                        this.var_549.push(_loc4_);
                     }
                     break;
                  case RoomObjectCategoryEnum.const_27:
               ...
               _loc6_ = new RoomContentLoadedEvent(RoomContentLoadedEvent.const_333,_loc4_);
      ...
      public function loadObjectContent(param1:String, param2:IEventDispatcher) : Boolean
      {
         ...
         {
            this.var_176 = this.var_1251.getValue(param1) as PublicRoomData;
         }
      ...
      public function loadLegacyContent(param1:String, param2:IEventDispatcher) : Array
      {
         ...
         {
            if(_loc3_[_loc5_].toString().length > 0 && this.var_2091.indexOf(_loc3_[_loc5_]) == -1)
            {
      ...
      private function onContentLoadError(param1:Event) : void
      {
         ...
         for each(_loc4_ in _loc3_)
         {
            ...
            {
               Core.crash("Failed to load asset: " + _loc2_.url,Core.const_1289);
               return;
            }
         }
      }
      ...
      private function onContentLoaded(param1:Event) : void
      {
         ...
         if(_loc4_)
         {
            if(this.var_2092.indexOf(this.getVisualizationType(_loc5_)) >= 0)
            {
               _loc7_ = this.getVisualizationXML(_loc5_);
               _loc8_ = this.extractPublicRoomFromXML(_loc5_,_loc7_);
               this.var_1251.add(_loc5_,_loc8_);
               this.var_176 = _loc8_;
               this.extractPublicRoomFurnitures(_loc5_,_loc2_);
            }
            _loc3_ = new RoomContentLoadedEvent(RoomContentLoadedEvent.const_333,_loc5_);
         }
         else
         {
      ...
      public function extractObjectContent(param1:String, param2:String) : Boolean
      {
         ...
         this.var_649.add(param2,param1);
         if(this.initializeGraphicAssetCollection(param2,_loc3_))
         {
            return true;
         }
         this.var_649.remove(param2);
         return false;
      }
      ...
      private function getAssetLibrary(param1:String) : IAssetLibrary
      {
         ...
         var _loc3_:IAssetLibrary = this.var_441.getValue(this.getAssetLibraryName(_loc2_)) as IAssetLibrary;
         if(_loc3_ == null)
         {
            _loc4_ = this.var_649.getValue(_loc2_);
            if(_loc4_ != null)
            {
               _loc2_ = this.getContentType(_loc4_);
               _loc3_ = this.var_441.getValue(this.getAssetLibraryName(_loc2_)) as IAssetLibrary;
            }
         }
         return _loc3_;
      }
      ...
      private function addAssetLibraryCollection(param1:String, param2:IEventDispatcher) : IAssetLibrary
      {
         ...
         this.var_441.add(_loc5_,_loc4_);
      ...
      public function getLogicType(param1:String) : String
      {
         ...
         if(_loc5_ != RoomObjectLogicEnum.const_219 && _loc5_ != RoomObjectLogicEnum.const_166)
         {
            _loc6_ = "@shadow";
      ...
      private function createGraphicAssetCollection(param1:String, param2:IAssetLibrary) : IGraphicAssetCollection
      {
         ...
         _loc3_ = this.var_479.createGraphicAssetCollection();
         if(_loc3_ != null)
         {
            _loc3_.assetLibrary = param2;
            this.var_373.add(param1,_loc3_);
         }
         return _loc3_;
      }
      ...
      {
         var _loc2_:String = this.getContentType(param1);
         return this.var_373.getValue(_loc2_) as IGraphicAssetCollection;
      }
      ...
      private function disposeGraphicAssetCollection(param1:String) : Boolean
      {
         var _loc3_:* = null;
         var _loc2_:String = this.getContentType(param1);
         if(this.var_373[_loc2_] != null)
         {
            _loc3_ = this.var_373.remove(_loc2_);
            if(_loc3_ != null)
            {
               _loc3_.dispose();
            }
