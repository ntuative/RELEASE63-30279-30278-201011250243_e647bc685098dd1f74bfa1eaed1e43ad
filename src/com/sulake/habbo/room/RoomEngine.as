package com.sulake.habbo.room
{
   ...
   public class RoomEngine extends Component implements IRoomEngine, IRoomManagerListener, IRoomCreator, IRoomEngineServices, IUpdateReceiver
   {
      ...
      private static const const_544:String = "temporary_room";
      
      private static const const_310:int = -1;
      
      private static const const_543:String = "room";
      
      private static const const_833:int = -2;
      
      private static const const_1178:String = "tile_cursor";
      
      private static const const_835:int = -3;
      
      private static const const_1177:String = "selection_arrow";
      
      private static const const_834:String = "overlay";
      
      private static const const_309:String = "object_icon_sprite";
      
      private static const const_384:int = 15;
      ...
      private var var_839:IRoomRendererFactory = null;
      
      private var var_25:IRoomObjectFactory = null;
      
      private var var_479:IRoomObjectVisualizationFactory = null;
      
      private var var_263:IAdManager = null;
      
      private var var_398:ISessionDataManager = null;
      ...
      private var var_663:NumberBank;
      ...
      public function RoomEngine(param1:IContext, param2:uint = 0)
      {
         ...
         this.var_663 = new NumberBank(1000);
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_479.release(new IIDRoomObjectVisualizationFactory());
            this.var_479 = null;
         }
         if(this.var_41 != null)
         {
         ...
         {
            this.var_839.release(new IIDRoomRendererFactory());
            this.var_839 = null;
         }
         ...
         if(this.var_263)
         {
            this.var_263.release(new IIDHabboAdManager());
            this.var_263 = null;
         }
      ...
      public function update(param1:uint) : void
      {
         ...
         var _loc2_:IRoomInstance = this.var_41.getRoom(this.getRoomIdentifier(this.var_92,this.var_93));
         ...
         while(_loc2_ < this.var_311.length)
         {
            ...
            if(_loc4_ != null)
            {
               ...
               if(_loc10_ != null)
               {
                  ...
                  if(_loc5_ != this.var_92 || _loc6_ != this.var_93 || !this.var_1029)
                  {
      ...
      private function updateRoomCamera(param1:int, param2:int, param3:int, param4:Vector3d, param5:uint) : void
      {
         ...
         if(_loc8_ != null && _loc9_ != null && _loc10_ != null)
         {
            ...
            if(_loc13_ != null)
            {
               _loc14_ = _loc10_.getNumber(RoomVariableEnum.const_681) - 0.5;
               _loc15_ = _loc10_.getNumber(RoomVariableEnum.const_631) - 0.5;
               _loc16_ = _loc10_.getNumber(RoomVariableEnum.const_642) + 0.5;
               _loc17_ = _loc10_.getNumber(RoomVariableEnum.const_636) + 0.5;
      ...
      private function onVisualizationFactoryReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_479 = param2 as IRoomObjectVisualizationFactory;
         if(this.var_15 != null)
         {
            this.var_15.visualizationFactory = this.var_479;
         }
         this.initializeRoomManager();
      }
      ...
      private function onRoomManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(this.var_41 != null)
         {
            ...
            this.var_41.addObjectUpdateCategory(RoomObjectCategoryEnum.const_305);
            this.var_41.addObjectUpdateCategory(RoomObjectCategoryEnum.const_75);
      ...
      private function onRendererFactoryReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_839 = param2 as IRoomRendererFactory;
         this.initializeRoomManager();
      }
      ...
      private function onHabboConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(this.var_15 != null)
         {
            events.addEventListener(RoomContentLoader.const_792,this.onContentLoaderReady);
      ...
      {
         if(param1 != null && param1.type == RoomContentLoader.const_792)
         {
            this.var_2201 = true;
            this.initializeRoomManager();
         }
      ...
      private function onAdManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_263 = param2 as IAdManager;
         this.var_263.events.addEventListener(AdEvent.const_523,this.showRoomAd);
      }
      ...
      private function onSessionDataManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_398 = param2 as ISessionDataManager;
         this.var_15.sessionDataManager = this.var_398;
      }
      ...
      private function initializeObjectEvents() : void
      {
         if(this.var_25 != null)
         {
            ...
            {
               this.var_25.events.addEventListener(RoomObjectMouseEvent.const_247,this.roomObjectEventHandler);
               this.var_25.events.addEventListener(RoomObjectMouseEvent.const_479,this.roomObjectEventHandler);
               this.var_25.events.addEventListener(RoomObjectMouseEvent.ROOM_OBJECT_MOUSE_DOWN,this.roomObjectEventHandler);
               this.var_25.events.addEventListener(RoomObjectStateChangeEvent.const_184,this.roomObjectEventHandler);
               this.var_25.events.addEventListener(RoomObjectStateChangeEvent.const_625,this.roomObjectEventHandler);
               ...
               this.var_25.events.addEventListener(RoomObjectWidgetRequestEvent.const_97,this.roomObjectEventHandler);
               ...
               this.var_25.events.addEventListener(RoomObjectFurnitureActionEvent.const_498,this.roomObjectEventHandler);
               this.var_25.events.addEventListener(RoomObjectFurnitureActionEvent.const_527,this.roomObjectEventHandler);
               this.var_25.events.addEventListener(RoomObjectFurnitureActionEvent.const_392,this.roomObjectEventHandler);
               this.var_25.events.addEventListener(RoomObjectFurnitureActionEvent.const_417,this.roomObjectEventHandler);
               this.var_25.events.addEventListener(RoomObjectFurnitureActionEvent.const_532,this.roomObjectEventHandler);
               ...
               this.var_25.events.addEventListener(RoomObjectFurnitureActionEvent.const_489,this.roomObjectEventHandler);
               this.var_25.events.addEventListener(RoomObjectFurnitureActionEvent.const_475,this.roomObjectEventHandler);
               this.var_25.events.addEventListener(RoomObjectFurnitureActionEvent.const_394,this.roomObjectEventHandler);
               ...
               this.var_25.events.addEventListener(RoomObjectMoveEvent.const_497,this.roomObjectEventHandler);
               this.var_25.events.addEventListener(RoomObjectRoomAdEvent.const_274,this.roomObjectEventHandler);
               this.var_25.events.addEventListener(RoomObjectRoomAdEvent.const_481,this.roomObjectEventHandler);
               this.var_25.events.addEventListener(RoomObjectRoomAdEvent.const_349,this.roomObjectEventHandler);
               this.var_25.events.addEventListener(RoomObjectRoomAdEvent.const_376,this.roomObjectEventHandler);
               this.var_25.events.addEventListener(RoomObjectRoomActionEvent.const_499,this.roomObjectEventHandler);
               this.var_25.events.addEventListener(RoomObjectRoomActionEvent.const_1036,this.roomObjectEventHandler);
               this.var_25.events.addEventListener(RoomObjectRoomActionEvent.const_526,this.roomObjectEventHandler);
            }
         }
      }
      ...
      {
         if(this.var_25 == null || this.var_479 == null || this.var_41 == null || this.var_839 == null || this._communication == null || this.var_117 == null || !this.var_2201)
         {
            return;
         }
      ...
      public function roomManagerInitialized(param1:Boolean = true) : void
      {
         ...
         {
            this.var_453 = true;
            events.dispatchEvent(new RoomEngineEvent(RoomEngineEvent.const_692,0,0));
            _loc2_ = 0;
            while(_loc2_ < this.var_312.length)
            {
               _loc3_ = this.var_312.getWithIndex(_loc2_) as RoomData;
               if(_loc3_ != null)
               {
      ...
      public function setIsPlayingGame(param1:int, param2:int, param3:Boolean) : void
      {
         ...
         {
            _loc5_ = !!param3 ? 1 : 0;
            _loc4_.setNumber(RoomVariableEnum.const_1012,_loc5_);
            if(_loc5_ == 0)
            {
               events.dispatchEvent(new RoomEngineEvent(RoomEngineEvent.const_410,param1,param2));
            }
            else
            {
               events.dispatchEvent(new RoomEngineEvent(RoomEngineEvent.const_434,param1,param2));
            }
         }
      }
      ...
      public function getIsPlayingGame(param1:int, param2:int) : Boolean
      {
         ...
         if(_loc3_ != null)
         {
            _loc4_ = _loc3_.getNumber(RoomVariableEnum.const_1012);
            if(_loc4_ > 0)
            {
               return true;
            }
      ...
      public function initializeRoom(param1:int, param2:int, param3:XML) : void
      {
         ...
         if(!this.var_453)
         {
            _loc5_ = this.var_312.remove(_loc4_);
            if(_loc5_ != null)
            {
            ...
            this.var_312.add(_loc4_,_loc5_);
      ...
      private function createRoom(param1:String, param2:XML, param3:String, param4:String, param5:String, param6:String) : IRoomInstance
      {
         ...
         if(this.isPublicRoomWorldType(param6))
         {
            ...
            _loc9_.getModelController().setString(RoomObjectVariableEnum.const_887,param6,true);
         ...
         {
            _loc9_ = _loc7_.createRoomObject(const_310,const_543,_loc8_) as IRoomObjectController;
         ...
         if(param2 != null)
         {
            ...
            if(param2.dimensions.length() == 1)
            {
               ...
               _loc7_.setNumber(RoomVariableEnum.const_681,_loc16_);
               _loc7_.setNumber(RoomVariableEnum.const_642,_loc17_);
               _loc7_.setNumber(RoomVariableEnum.const_631,_loc18_);
               _loc7_.setNumber(RoomVariableEnum.const_636,_loc19_);
         ...
         if(param3 != null)
         {
            _loc11_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_564,param3);
            _loc9_.getEventHandler().processUpdateMessage(_loc11_);
         }
         if(param4 != null)
         {
            _loc11_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_798,param4);
            _loc9_.getEventHandler().processUpdateMessage(_loc11_);
         }
         if(param5 != null)
         {
            ...
            if(param2.doors.door.length() > 0)
            {
               ...
               while(_loc23_ < _loc20_.length())
               {
                  ...
                  if(XMLValidator.checkRequiredAttributes(_loc24_,_loc21_))
                  {
                     ...
                     _loc22_ = new RoomObjectRoomMaskUpdateMessage(RoomObjectRoomMaskUpdateMessage.const_513,_loc30_,_loc29_,_loc31_,RoomObjectRoomMaskUpdateMessage.const_242);
                     _loc9_.getEventHandler().processUpdateMessage(_loc22_);
                     if(_loc28_ == 90 || _loc28_ == 180)
                     {
                        if(_loc28_ == 90)
                        {
                           _loc7_.setNumber(RoomObjectVariableEnum.const_766,_loc25_ - 0.5,true);
                           _loc7_.setNumber(RoomObjectVariableEnum.const_555,_loc26_,true);
                        }
                        if(_loc28_ == 180)
                        {
                           _loc7_.setNumber(RoomObjectVariableEnum.const_766,_loc25_,true);
                           _loc7_.setNumber(RoomObjectVariableEnum.const_555,_loc26_ - 0.5,true);
                        }
                        _loc7_.setNumber(RoomObjectVariableEnum.const_1043,_loc27_,true);
                        _loc7_.setNumber(RoomObjectVariableEnum.const_895,_loc28_,true);
                     }
                  }
                  _loc23_++;
               }
         ...
         _loc7_.createRoomObject(const_833,const_1178,RoomObjectCategoryEnum.const_305);
         _loc7_.createRoomObject(const_835,const_1177,RoomObjectCategoryEnum.const_305);
         return _loc7_;
      }
      
      public function method_5(param1:int, param2:int) : IRoomObjectController
      {
      ...
      public function updateObjectRoom(param1:int, param2:int, param3:String = null, param4:String = null, param5:String = null) : Boolean
      {
         var _loc8_:* = null;
         var _loc9_:* = null;
         var _loc6_:IRoomObjectController = this.method_5(param1,param2);
         if(_loc6_ == null)
         {
            _loc8_ = this.getRoomIdentifier(param1,param2);
            _loc9_ = this.var_312.getValue(_loc8_);
            if(_loc9_ == null)
            {
               _loc9_ = new RoomData(param1,param2,null);
               this.var_312.add(_loc8_,_loc9_);
            }
            if(param3 != null)
            {
         ...
         if(param3 != null)
         {
            _loc7_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_564,param3);
            _loc6_.getEventHandler().processUpdateMessage(_loc7_);
         }
         if(param4 != null)
         {
            _loc7_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_798,param4);
            _loc6_.getEventHandler().processUpdateMessage(_loc7_);
         }
         if(param5 != null)
         {
      ...
      {
         var _loc5_:IRoomObjectController = this.method_5(param1,param2);
         if(_loc5_ == null || _loc5_.getEventHandler() == null)
         {
            return false;
         }
         var _loc6_:* = null;
         _loc6_ = new RoomObjectRoomPlaneVisibilityUpdateMessage(RoomObjectRoomPlaneVisibilityUpdateMessage.const_971,param3);
         _loc5_.getEventHandler().processUpdateMessage(_loc6_);
         _loc6_ = new RoomObjectRoomPlaneVisibilityUpdateMessage(RoomObjectRoomPlaneVisibilityUpdateMessage.const_1090,param4);
         _loc5_.getEventHandler().processUpdateMessage(_loc6_);
         return true;
      }
      ...
      public function createRoomCanvas(param1:int, param2:int, param3:int, param4:int, param5:int, param6:int) : DisplayObject
      {
         ...
         if(_loc9_ == null)
         {
            _loc9_ = this.var_839.createRenderer();
         }
         if(_loc9_ == null)
         {
            return null;
         }
         _loc9_.roomObjectVariableAccurateZ = RoomObjectVariableEnum.const_987;
         ...
         if(_loc10_.geometry != null)
         {
            _loc13_ = _loc8_.getNumber(RoomObjectVariableEnum.const_766);
            _loc14_ = _loc8_.getNumber(RoomObjectVariableEnum.const_555);
            _loc15_ = _loc8_.getNumber(RoomObjectVariableEnum.const_1043);
            _loc16_ = _loc8_.getNumber(RoomObjectVariableEnum.const_895);
      ...
      {
         var _loc8_:int = param2 - this.var_1290;
         var _loc9_:int = param3 - this.var_1288;
         if(param4 == MouseEvent.MOUSE_DOWN)
         {
            if(!param5 && !param6 && !param7)
            {
               this.var_1029 = true;
               this.var_838 = false;
               this.var_2199 = this.var_1290;
               this.var_2200 = this.var_1288;
            }
         }
         ...
         else if(param4 == MouseEvent.MOUSE_MOVE)
         {
            if(this.var_1029)
            {
               if(!this.var_838)
               {
                  _loc8_ = param2 - this.var_2199;
                  _loc9_ = param3 - this.var_2200;
                  if(_loc8_ <= -const_384 || _loc8_ >= const_384 || _loc9_ <= -const_384 || _loc9_ >= const_384)
                  {
                     this.var_838 = true;
                  }
                  _loc8_ = 0;
            ...
            if(!this.handleRoomDragging(_loc9_,param2,param3,param4,param5,param6,param7))
            {
               if(!_loc9_.handleMouseEvent(param2,param3,param4,param5,param6,param7,param8))
               {
                  ...
                  if(param4 == MouseEvent.CLICK)
                  {
                     if(events != null)
                     {
                        events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_487,this.var_92,this.var_93,-1,RoomObjectCategoryEnum.const_147));
                     }
                     _loc13_ = "null";
                  }
                  else if(param4 == MouseEvent.MOUSE_MOVE)
                  ...
                  if(this.var_66 != null)
                  {
                     _loc14_ = new RoomObjectMouseEvent(_loc13_,null,const_310,const_543);
                     this.var_66.handleRoomObjectEvent(_loc14_,this.var_92,this.var_93);
                  }
               }
            }
      ...
      private function getOverlaySprite(param1:IRoomRenderingCanvas) : Sprite
      {
         ...
         return _loc2_.getChildByName(const_834) as Sprite;
      }
      ...
      public function setObjectMoverIconSprite(param1:int, param2:int, param3:Boolean, param4:String = null) : void
      {
         ...
         if(param3)
         {
            _loc6_ = this.getRoomObjectImage(this.var_92,this.var_93,param1,param2,new Vector3d(),1,null);
         }
         ...
         var _loc7_:IRoomRenderingCanvas = this.getRoomCanvas(this.var_92,this.var_93,this.var_1289);
         if(_loc7_ != null)
         {
            ...
            if(_loc11_ != null)
            {
               _loc11_.x = this.var_1290 - _loc6_.data.width / 2;
               _loc11_.y = this.var_1288 - _loc6_.data.height / 2;
            }
         }
      }
      ...
      public function setObjectMoverIconSpriteVisible(param1:Boolean) : void
      {
         var _loc3_:* = null;
         var _loc4_:* = null;
         var _loc2_:IRoomRenderingCanvas = this.getRoomCanvas(this.var_92,this.var_93,this.var_1289);
         if(_loc2_ != null)
         {
      ...
      {
         var _loc2_:* = null;
         var _loc1_:IRoomRenderingCanvas = this.getRoomCanvas(this.var_92,this.var_93,this.var_1289);
         if(_loc1_ != null)
         {
      ...
      public function modifyRoomObject(param1:int, param2:int, param3:String) : Boolean
      {
         if(this.var_66 != null)
         {
            return this.var_66.modifyRoomObject(this.var_92,this.var_93,param1,param2,param3);
         }
         return false;
      }
      ...
      public function modifyRoomObjectData(param1:int, param2:int, param3:String) : Boolean
      {
         if(this.var_66 != null)
         {
            ...
            {
               return this.var_66.modifyWallItemData(this.var_92,this.var_93,param1,param3);
            }
         }
         return false;
      }
      ...
      public function deleteRoomObject(param1:int, param2:int) : Boolean
      {
         if(this.var_66 != null)
         {
            if(param2 == RoomObjectCategoryEnum.const_27)
            {
               return this.var_66.deleteWallItem(this.var_92,this.var_93,param1);
            }
         }
         return false;
      }
      ...
      public function initializeRoomObjectInsert(param1:int, param2:int, param3:int, param4:String = null) : Boolean
      {
         ...
         if(this.var_66 != null)
         {
            return this.var_66.initializeRoomObjectInsert(this.var_92,this.var_93,param1,param2,param3,param4);
         }
         return false;
      }
      ...
      public function cancelRoomObjectInsert() : void
      {
         if(this.var_66 != null)
         {
            this.var_66.cancelRoomObjectInsert(this.var_92,this.var_93);
         }
      }
      ...
      public function getRoomObjectCategory(param1:String) : int
      {
         ...
         return RoomObjectCategoryEnum.const_147;
      }
      ...
      {
         return this.getObject(this.getRoomIdentifier(param1,param2),const_835,RoomObjectCategoryEnum.const_305);
      }
      
      public function getTileCursor(param1:int, param2:int) : IRoomObjectController
      {
         return this.getObject(this.getRoomIdentifier(param1,param2),const_833,RoomObjectCategoryEnum.const_305);
      }
      ...
      public function addObjectFurniture(param1:int, param2:int, param3:int, param4:int, param5:IVector3d, param6:IVector3d, param7:int, param8:String, param9:Number = NaN, param10:int = -1) : Boolean
      {
         ...
         if(_loc14_ != null && _loc14_.getModelController() != null)
         {
            ...
            _loc14_.getModelController().setNumber(RoomObjectVariableEnum.const_368,param4,true);
            ...
            _loc14_.getModelController().setNumber(RoomObjectVariableEnum.const_1093,param10);
         ...
         if(events != null)
         {
            events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_290,param1,param2,param3,RoomObjectCategoryEnum.const_28));
         }
      ...
      public function addObjectWallItem(param1:int, param2:int, param3:int, param4:int, param5:IVector3d, param6:IVector3d, param7:int, param8:String) : Boolean
      {
         ...
         if(_loc12_ != null && _loc12_.getModelController() != null)
         {
            ...
            _loc12_.getModelController().setNumber(RoomObjectVariableEnum.const_368,param4,true);
            _loc12_.getModelController().setString(RoomObjectVariableEnum.const_319,_loc11_,true);
            _loc12_.getModelController().setNumber(RoomObjectVariableEnum.const_987,1,true);
         }
         ...
         if(events != null)
         {
            events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_290,param1,param2,param3,RoomObjectCategoryEnum.const_27));
         }
      ...
      public function updateObjectRoomWindow(param1:int, param2:int, param3:int, param4:Boolean = true) : void
      {
         ...
         if(_loc7_ != null)
         {
            ...
            {
               if(_loc7_.getModel().getNumber(RoomObjectVariableEnum.const_932) > 0)
               {
                  _loc9_ = _loc7_.getModel().getString(RoomObjectVariableEnum.const_941);
                  ...
                  {
                     _loc6_ = new RoomObjectRoomMaskUpdateMessage(RoomObjectRoomMaskUpdateMessage.const_703,_loc5_);
                  }
               }
            }
         }
         ...
         var _loc8_:IRoomObjectController = this.method_5(param1,param2);
      ...
      public function addObjectUser(param1:int, param2:int, param3:int, param4:IVector3d, param5:IVector3d, param6:Number, param7:int, param8:String = null) : Boolean
      {
         ...
         if(events != null)
         {
            events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_290,param1,param2,param3,RoomObjectCategoryEnum.const_33));
         }
         return true;
      }
      ...
      public function updateObjectUser(param1:int, param2:int, param3:int, param4:IVector3d, param5:IVector3d, param6:IVector3d = null, param7:Number = NaN) : Boolean
      {
         ...
         if(isNaN(param7))
         {
            param7 = _loc8_.getModel().getNumber(RoomObjectVariableEnum.const_332);
         }
      ...
      private function disposeObject(param1:String, param2:int, param3:int) : void
      {
         ...
         if(_loc4_.disposeObject(param2,param3))
         {
            if(events != null)
            {
               events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_673,this.var_92,this.var_93,param2,param3));
            }
         }
      }
      ...
      private function roomObjectEventHandler(param1:RoomObjectEvent) : void
      {
         if(this.var_66 != null)
         {
            this.var_66.handleRoomObjectEvent(param1,this.var_92,this.var_93);
         }
      }
      ...
      public function getGenericRoomObjectImage(param1:String, param2:String, param3:IVector3d, param4:int, param5:IGetImageListener, param6:String = null, param7:uint = 0, param8:String = null) : ImageResult
      {
         ...
         var _loc10_:IRoomInstance = this.var_41.getRoom(const_544);
         if(_loc10_ == null)
         {
            _loc10_ = this.var_41.createRoom(const_544,null);
            if(_loc10_ == null)
            {
               return _loc9_;
            }
         }
         var _loc11_:int = this.var_663.reserveNumber();
            ...
            case RoomObjectCategoryEnum.const_75:
               if(param2 != null)
               {
                  ...
                  if(_loc17_.length >= 3)
                  {
                     ...
                     _loc21_.addPlane(RoomPlaneData.const_161,new Vector3d(0,0,0),new Vector3d(10,0,0),new Vector3d(0,10,0));
                     ...
                     _loc21_.addPlane(RoomPlaneData.const_306,new Vector3d(10,0,0),new Vector3d(-10,0,0),new Vector3d(0,0,10));
                     _loc22_ = _loc21_.getXML();
                     _loc13_.getEventHandler().initialize(_loc22_);
                     _loc13_.getModelController().setString(RoomObjectVariableEnum.const_626,_loc18_);
                     _loc13_.getModelController().setString(RoomObjectVariableEnum.const_783,_loc19_);
                     _loc13_.getModelController().setString(RoomObjectVariableEnum.const_722,_loc20_);
                     if(param6 != null)
                     {
                        _loc23_ = null;
         ...
         {
            this.var_1030.add(String(_loc11_),param5);
            _loc13_.getModelController().setNumber(RoomObjectVariableEnum.const_1054,param4,true);
         }
         else
         {
            _loc10_.disposeObject(_loc11_,_loc12_);
            this.var_663.freeNumber(_loc11_ - 1);
            _loc9_.id = 0;
         }
         _loc15_.dispose();
         return _loc9_;
      ...
      {
         return this.getRoomObjectBoundingRectangle(this.var_92,this.var_93,const_310,RoomObjectCategoryEnum.const_75,param1);
      }
      
      public function isRoomObjectContentAvailable(param1:String) : Boolean
      {
         return this.var_41.method_17(param1);
      }
      ...
      public function contentLoaded(param1:String, param2:Boolean = false) : void
      {
         ...
         var _loc13_:* = null;
         var _loc14_:Number = NaN;
         var _loc3_:IRoomInstance = this.var_41.getRoom(const_544);
         if(_loc3_ == null)
         {
            return;
         }
         ...
         while(_loc8_ >= 0)
         {
            ...
            if(_loc9_ != null && _loc9_.getModel() != null && _loc9_.getType() == param1)
            {
               ...
               if(_loc12_ != null)
               {
                  _loc14_ = _loc9_.getModel().getNumber(RoomObjectVariableEnum.const_1054);
               ...
               this.var_663.freeNumber(_loc10_ - 1);
               _loc13_ = this.var_1030.remove(String(_loc10_)) as IGetImageListener;
      ...
      private function showRoomAd(param1:AdEvent) : void
      {
         ...
         if(this.var_15 != null)
         {
            ...
            this.var_15.addGraphicAsset(this.var_15.getPublicRoomContentType(_loc2_),RoomObjectVariableEnum.const_347,param1.image,true);
            this.var_15.addGraphicAsset(this.var_15.getPublicRoomContentType(_loc2_),RoomObjectVariableEnum.const_922,param1.adWarningL,true);
            this.var_15.addGraphicAsset(this.var_15.getPublicRoomContentType(_loc2_),RoomObjectVariableEnum.const_950,param1.adWarningR,true);
            _loc3_ = this.method_5(param1.roomId,param1.roomCategory);
            if(_loc3_ == null)
            {
               return;
            }
            _loc4_ = null;
            _loc4_ = new RoomObjectRoomAdUpdateMessage(RoomObjectRoomAdUpdateMessage.const_939,RoomObjectVariableEnum.const_347,param1.clickUrl);
