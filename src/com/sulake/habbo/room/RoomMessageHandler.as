package com.sulake.habbo.room
{
   ...
   public class RoomMessageHandler
   {
      ...
      private var var_1361:int = -1.0E9;
      ...
      private function onUserUpdate(param1:IMessageEvent) : void
      {
         ...
         var _loc7_:Number = _loc6_.getNumber(RoomVariableEnum.const_700);
         var _loc8_:int = 0;
      ...
      private function onSlideUpdate(param1:IMessageEvent) : void
      {
         ...
         if(param1 is SlideObjectBundleMessageEvent)
         {
            ...
            if(_loc2_.avatar != null)
            {
               ...
               {
                  case SlideObjectMessageData.const_888:
                     _loc10_ = "mv";
                     break;
                  case SlideObjectMessageData.const_1067:
                     _loc10_ = "std";
               }
      ...
      private function onParkBusDoor(param1:IMessageEvent) : void
      {
         ...
         var _loc4_:int = _loc3_.roomId;
         var _loc5_:int = _loc3_.roomCategory;
         var _loc6_:IRoomObject = this.var_12.method_5(_loc4_,_loc5_);
         if(_loc6_ == null)
         {
            return;
         }
         ...
         if(_loc7_ != null)
         {
            _loc7_.setNumber(RoomObjectVariableEnum.const_1015,_loc3_.status);
         }
      }
