package com.sulake.habbo.room.object.logic.room
{
   ...
   public class RoomLogic extends ObjectLogicBase
   {
      ...
      private var var_1482:int = 255;
      
      private var var_1271:uint = 16777215;
      
      private var var_1596:int = 255;
      ...
      override public function initialize(param1:XML) : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc2_.setString(RoomObjectVariableEnum.const_877,param1.toString(),true);
      ...
      private function updateBackgroundColor(param1:int) : void
      {
         ...
         if(this.var_1018)
         {
            _loc2_ = param1;
            _loc3_ = this._color;
            _loc4_ = this.var_1482;
            if(_loc2_ - this.var_1018 >= this.var_1594)
            {
               _loc3_ = this.var_1019;
               _loc4_ = this.var_1595;
               this.var_1018 = 0;
            }
            else
            {
               _loc7_ = this.var_1271 >> 16 & 255;
               _loc8_ = this.var_1271 >> 8 & 255;
               _loc9_ = this.var_1271 & 255;
               _loc10_ = this.var_1019 >> 16 & 255;
               _loc11_ = this.var_1019 >> 8 & 255;
               _loc12_ = this.var_1019 & 255;
               _loc13_ = (_loc2_ - this.var_1018) / this.var_1594;
               _loc7_ += (_loc10_ - _loc7_) * _loc13_;
               _loc8_ += (_loc11_ - _loc8_) * _loc13_;
               _loc9_ += (_loc12_ - _loc9_) * _loc13_;
               _loc3_ = (_loc7_ << 16) + (_loc8_ << 8) + _loc9_;
               _loc4_ = this.var_1596 + (this.var_1595 - this.var_1596) * _loc13_;
               this._color = _loc3_;
               this.var_1482 = _loc4_;
            }
      ...
      private function updatePlaneProperties(param1:RoomObjectRoomUpdateMessage, param2:IRoomObjectModelController) : void
      {
         switch(param1.type)
         {
            case RoomObjectRoomUpdateMessage.const_564:
               param2.setString(RoomObjectVariableEnum.const_626,param1.value);
               break;
            case RoomObjectRoomUpdateMessage.const_798:
               param2.setString(RoomObjectVariableEnum.const_783,param1.value);
               break;
            case RoomObjectRoomUpdateMessage.const_566:
               param2.setString(RoomObjectVariableEnum.const_722,param1.value);
         }
      }
      ...
      private function updatePlaneMasks(param1:RoomObjectRoomMaskUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         switch(param1.type)
         {
            case RoomObjectRoomMaskUpdateMessage.const_513:
               ...
               this.var_424.addMask(param1.maskId,param1.maskType,param1.maskLocation,_loc5_);
               _loc4_ = true;
               break;
            case RoomObjectRoomMaskUpdateMessage.const_703:
               _loc4_ = this.var_424.removeMask(param1.maskId);
         }
         if(_loc4_)
         {
            _loc6_ = this.var_424.getXML();
            _loc7_ = _loc6_.toXMLString();
            param2.setString(RoomObjectVariableEnum.const_1065,_loc7_);
         }
      }
      ...
      private function updatePlaneVisibilities(param1:RoomObjectRoomPlaneVisibilityUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         switch(param1.type)
         {
            case RoomObjectRoomPlaneVisibilityUpdateMessage.const_1090:
               param2.setNumber(RoomObjectVariableEnum.const_724,_loc3_);
               break;
            case RoomObjectRoomPlaneVisibilityUpdateMessage.const_971:
      ...
      private function updateColors(param1:RoomObjectRoomColorUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         this.var_1271 = this._color;
         this.var_1596 = this.var_1482;
         this.var_1019 = _loc3_;
         this.var_1595 = _loc4_;
         this.var_1018 = getTimer();
         this.var_1594 = 1500;
      }
      ...
      override public function mouseEvent(param1:RoomSpriteMouseEvent, param2:IRoomGeometry) : void
      {
         ...
         if(_loc5_ < 1 || _loc5_ > this._planeParser.planeCount)
         {
            ...
            {
               _loc4_.setNumber(RoomObjectVariableEnum.const_445,0);
            }
            return;
         }
         _loc5_--;
         ...
         {
            _loc4_.setNumber(RoomObjectVariableEnum.const_1379,_loc20_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_1336,_loc21_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_1394,_loc22_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_445,_loc5_ + 1);
            var _loc23_:String = "";
            var _loc24_:int = 0;
            var _loc25_:* = null;
            switch(param1.type)
            {
               ...
               case MouseEvent.CLICK:
                  ...
                  {
                     if(_loc13_ == RoomPlaneData.const_161)
                     {
                        _loc25_ = new RoomObjectTileMouseEvent(_loc26_,param1.eventId,_loc24_,_loc23_,_loc20_,_loc21_,_loc22_);
                     }
                     else if(_loc13_ == RoomPlaneData.const_144 || _loc13_ == RoomPlaneData.const_306)
                     {
                        _loc27_ = 90;
                        if(_loc11_ != null)
                        {
