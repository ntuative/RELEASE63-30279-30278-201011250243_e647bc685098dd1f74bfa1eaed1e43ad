package com.sulake.habbo.room.object
{
   ...
   public class RoomPlaneParser
   {
      ...
      public function setTileHeight(param1:int, param2:int, param3:Number) : Boolean
      {
         ...
         {
            _loc4_ = this.var_140[param2] as Array;
            ...
            else
            {
               ...
               if(param2 == this.var_467 || param2 == this.var_466)
               {
                  _loc7_ = false;
                  _loc8_ = this.var_464;
      ...
      public function getTileHeight(param1:int, param2:int) : Number
      {
         ...
         var _loc3_:Array = this.var_140[param2] as Array;
      ...
      public function initializeFromTileData(param1:Boolean = false) : Boolean
      {
         var _loc7_:* = null;
         var _loc8_:int = 0;
         var _loc2_:Point = findEntranceTile(this.var_140);
         var _loc3_:int = 0;
         if(_loc2_ != null)
         {
         ...
         this.var_885 = getFloorHeight(this.var_140);
         if(!param1)
         {
         ...
         var _loc5_:* = [];
         var _loc6_:int = 0;
         while(_loc6_ < this.var_140.length)
         {
            _loc4_ = this.var_140[_loc6_];
            _loc7_ = [];
            _loc8_ = 0;
      ...
      {
         var _loc11_:* = null;
         this.addPlane(RoomPlaneData.const_144,param1,param2,param3,[param4]);
         this.addPlane(RoomPlaneData.const_306,param1,param2,param3,[param4]);
         var _loc9_:Vector3d = Vector3d.crossProduct(param2,param3);
         var _loc10_:Vector3d = Vector3d.product(_loc9_,1 / _loc9_.length * -this.var_1068);
         this.addPlane(RoomPlaneData.const_144,Vector3d.sum(param1,param3),param2,_loc10_,[_loc9_,param4]);
         if(param5)
         {
            this.addPlane(RoomPlaneData.const_144,Vector3d.sum(Vector3d.sum(param1,param2),param3),Vector3d.product(param3,-(param3.length + this.var_121) / param3.length),_loc10_,[_loc9_,param4]);
         }
         if(param6)
         {
            this.addPlane(RoomPlaneData.const_144,Vector3d.sum(param1,Vector3d.product(param3,-this.var_121 / param3.length)),Vector3d.product(param3,(param3.length + this.var_121) / param3.length),_loc10_,[_loc9_,param4]);
            if(param7)
            {
               _loc11_ = Vector3d.product(param2,this.var_1068 / param2.length);
               this.addPlane(RoomPlaneData.const_144,Vector3d.sum(Vector3d.sum(param1,param3),Vector3d.product(_loc11_,-1)),_loc11_,_loc10_,[_loc9_,param2,param4]);
            }
         }
      }
      ...
      {
         if(param1 == null || this.var_140 == null || param1 == this.var_140)
         {
            return false;
         }
         var _loc3_:int = 0;
         ...
         var _loc5_:* = null;
         var _loc6_:* = null;
         if(param1.length > this.var_140.length)
         {
            return false;
         }
         ...
         while(_loc3_ < _loc7_)
         {
            ...
            _loc6_ = this.var_140[_loc3_] as Array;
      ...
      {
         var _loc12_:RoomPlaneData = this.addPlane(RoomPlaneData.const_161,param1,param2,param3);
         ...
         if(_loc12_)
         {
            ...
            if(param6)
            {
               ...
               _loc14_ = this.addPlane(RoomPlaneData.const_161,_loc13_,new Vector3d(0,0,-this.var_121),param2);
               if(_loc14_ != null)
               {
                  if(param8 > 0)
                  {
            ...
            if(param7)
            {
               ...
               _loc14_ = this.addPlane(RoomPlaneData.const_161,_loc13_,new Vector3d(0,0,-this.var_121),Vector3d.product(param2,-1));
               if(_loc14_ != null)
               {
                  if(param9 > 0)
                  {
            ...
            if(param4)
            {
               ...
               _loc15_ = this.addPlane(RoomPlaneData.const_161,_loc13_,new Vector3d(0,0,-this.var_121),Vector3d.product(param3,-1));
               if(_loc15_ != null)
               {
                  if(param11 > 0)
                  {
            ...
            if(param5)
            {
               ...
               _loc15_ = this.addPlane(RoomPlaneData.const_161,_loc13_,new Vector3d(0,0,-this.var_121),param3);
               if(_loc15_ != null)
               {
                  if(param10 > 0)
                  {
      ...
      public function getPlaneType(param1:int) : int
      {
         if(param1 < 0 || param1 >= this.planeCount)
         {
            return RoomPlaneData.const_1083;
         }
         var _loc2_:RoomPlaneData = this.var_120[param1] as RoomPlaneData;
         if(_loc2_ != null)
         {
