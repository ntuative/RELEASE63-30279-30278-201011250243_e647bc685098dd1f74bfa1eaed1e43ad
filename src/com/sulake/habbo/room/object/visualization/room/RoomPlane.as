package com.sulake.habbo.room.object.visualization.room
{
   ...
   public class RoomPlane
   {
      ...
      private var var_886:IPlaneRasterizer = null;
      
      private var var_617:PlaneMaskManager = null;
      ...
      private var var_391:PlaneBitmapData = null;
      ...
      private var var_202:BitmapData = null;
      ...
      {
         return this._isVisible && this.var_705;
      }
      ...
      private function getTextureIdentifier(param1:Number) : String
      {
         ...
         {
            return this.var_886.getTextureIdentifier(param1,this.normal);
         }
      ...
      private function needsNewTexture(param1:IRoomGeometry, param2:int) : Boolean
      {
         ...
         var _loc3_:PlaneBitmapData = this.var_391;
         if(_loc3_ == null)
         {
         ...
         if(this.var_705 && (_loc3_ == null || _loc3_.timeStamp >= 0 && param2 > _loc3_.timeStamp || this.var_329))
         {
            return true;
         }
         return false;
      ...
      private function getTexture(param1:IRoomGeometry, param2:int) : BitmapData
      {
         ...
         {
            _loc5_ = this.var_269.length * param1.scale;
            _loc6_ = this.var_270.length * param1.scale;
            ...
            if(this.var_886 != null)
            {
               _loc3_ = this.var_886.render(_loc8_,this._id,_loc5_,_loc6_,param1.scale,_loc7_,this.var_1713,this.var_2375,this.var_2379,this.var_2378,this.var_2377,param2);
               if(_loc3_ != null)
               {
      ...
      public function update(param1:IRoomGeometry, param2:int) : Boolean
      {
         ...
         if(!geometryChanged || !this.var_705)
         {
            if(!this.visible)
            {
               return false;
         ...
         if(geometryChanged)
         {
            ...
            i = 0;
            while(i < this.var_1278.length)
            {
               cosAngle = Vector3d.cosAngle(geometry.directionAxis,this.var_1278[i]);
               if(cosAngle > -0.001)
               {
                  if(this._isVisible)
                  {
            ...
            originPos = geometry.getScreenPosition(this.var_1038);
            originZ = originPos.z;
            relativeDepth = Math.max(this.var_139.z - originZ,this.var_102.z - originZ,this.var_81.z - originZ,this.var_101.z - originZ);
            if(this._type == const_94)
            {
               relativeDepth += 0.02;
            }
            this.var_2228 = relativeDepth;
         ...
         if(geometryChanged || this.needsNewTexture(geometry,timeSinceStartMs))
         {
            ...
            Randomizer.setSeed(this.var_2376);
      ...
      private function renderTexture(param1:IRoomGeometry, param2:BitmapData) : void
      {
         ...
         if(this._type == const_110 || this._type == const_94)
         {
      ...
      private function draw(param1:BitmapData, param2:Matrix) : void
      {
         ...
         if(this._bitmapData != null)
         {
            if(param2.a == 1 && param2.d == 1 && param2.c == 0 && param2.b != 0 && Math.abs(param2.b) <= 1 && (this._type == const_110 || this._type == const_94))
            {
               _loc3_ = 0;
               _loc4_ = 0;
               _loc5_ = 0;
      ...
      private function updateMaskChangeStatus() : void
      {
         ...
         var _loc4_:* = null;
         if(this.var_241.length == this.var_888.length)
         {
            while(_loc1_ < this.var_241.length)
            {
               ...
               if(_loc4_ != null)
               {
                  ...
                  {
                     _loc7_ = this.var_888[_loc2_] as RoomPlaneBitmapMask;
                     if(_loc7_ != null)
                     {
         ...
         if(this.var_330.length > this.var_1340.length)
         {
            _loc3_ = false;
         }
         if(_loc3_)
      ...
      private function updateMask(param1:BitmapData, param2:IRoomGeometry) : void
      {
         ...
         var _loc13_:int = 0;
         var _loc14_:int = 0;
         if(!this.var_887 || this.var_241.length == 0 && this.var_330.length == 0 && !this.var_329 || this.var_617 == null)
         {
            return;
         }
         ...
         if(this.var_329)
         {
            ...
            _loc9_ = param2.getCoordinatePosition(this.var_563);
            _loc10_ = 0;
            _loc11_ = 0;
            _loc5_ = 0;
            while(_loc5_ < this.var_241.length)
            {
               ...
               if(_loc3_ != null)
               {
                  _loc10_ = this.var_65.width - this.var_65.width * _loc3_.leftSideLoc / this.var_269.length;
                  _loc11_ = this.var_65.height - this.var_65.height * _loc3_.rightSideLoc / this.var_270.length;
                  _loc12_ = _loc3_.type;
                  this.var_617.updateMask(this.var_65,_loc12_,param2.scale,_loc9_,_loc10_,_loc11_);
                  this.var_888.push(new RoomPlaneBitmapMask(_loc12_,_loc3_.leftSideLoc,_loc3_.rightSideLoc));
               }
               _loc5_++;
            }
            _loc6_ = 0;
            while(_loc6_ < this.var_330.length)
            {
               ...
               if(_loc4_ != null)
               {
                  _loc10_ = this.var_65.width - this.var_65.width * _loc4_.leftSideLoc / this.var_269.length;
                  _loc11_ = this.var_65.height - this.var_65.height * _loc4_.rightSideLoc / this.var_270.length;
                  _loc13_ = this.var_65.width * _loc4_.leftSideLength / this.var_269.length;
                  _loc14_ = this.var_65.height * _loc4_.rightSideLength / this.var_270.length;
                  this.var_65.fillRect(new Rectangle(_loc10_ - _loc13_,_loc11_ - _loc14_,_loc13_,_loc14_),4278190080);
                  this.var_1340.push(new RoomPlaneRectangleMask(_loc4_.leftSideLength,_loc4_.rightSideLoc,_loc4_.leftSideLength,_loc4_.rightSideLength));
               }
               _loc6_++;
            }
            this.var_329 = false;
      ...
      private function combineTextureMask(param1:BitmapData, param2:BitmapData) : void
      {
         ...
         if(this.var_202 != null && (this.var_202.width != param1.width || this.var_202.height != param1.height))
         {
            this.var_202.dispose();
            this.var_202 = null;
         }
         if(this.var_202 == null)
         {
            this.var_202 = new BitmapData(param1.width,param1.height,true,4294967295);
         }
         this.var_202.copyChannel(param1,param1.rect,new Point(0,0),BitmapDataChannel.ALPHA,BitmapDataChannel.RED);
         this.var_202.draw(param2,null,null,BlendMode.DARKEN);
         param1.copyChannel(this.var_202,this.var_202.rect,new Point(0,0),BitmapDataChannel.RED,BitmapDataChannel.ALPHA);
      }
   }
}
