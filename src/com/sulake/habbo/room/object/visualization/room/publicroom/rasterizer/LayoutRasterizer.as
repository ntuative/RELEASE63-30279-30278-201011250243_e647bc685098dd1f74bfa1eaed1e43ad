package com.sulake.habbo.room.object.visualization.room.publicroom.rasterizer
{
   ...
   public class LayoutRasterizer
   {
      ...
      private var var_1217:LayoutRasterizerData = null;
      ...
      public function set layout(param1:String) : void
      {
         if(param1 != this.var_798)
         {
            ...
            this._adBgIndex = -1;
            this._adImgIndex = -1;
            this.var_1217 = this.var_35.getValue(this.var_798);
         }
      }
      ...
      public function initialize(param1:XML) : void
      {
         ...
         this.var_2021 = new Vector3d(-0.5,0.5,0);
         this.var_797 = false;
      }
      ...
      public function initializeGeometry(param1:IRoomGeometry) : void
      {
         ...
         var _loc3_:Point = param1.getScreenPoint(this.var_2021);
         _loc3_.x -= _loc2_.x;
         _loc3_.y -= _loc2_.y;
      ...
      public function initializeAds(param1:int, param2:IRoomObjectSpriteVisualization) : void
      {
         ...
         var _loc11_:* = null;
         this.var_971 = param1;
         var _loc3_:LayoutRasterizerData = this.var_35.getValue(this.var_798);
         if(_loc3_ == null)
         {
            return;
         }
                  ...
                  if(_loc9_ != null)
                  {
                     if(_loc7_.@id.toString().length > 0)
                     {
                        ...
                        if(_loc10_ == "billboard_bg")
                        {
                           ...
                           {
                              this.var_1505 = RoomObjectVariableEnum.const_922;
                           }
                           if(_loc11_.indexOf("right") > -1)
                           {
                              this.var_1505 = RoomObjectVariableEnum.const_950;
                           }
                           if(param2 != null)
                           {
      ...
      {
         var _loc1_:LayoutRasterizerData = this.var_35.getValue(this.var_798);
         if(_loc1_ == null)
         {
            return 0;
         }
      ...
      {
         if(param2 == this.var_2020 && param3 == this.var_2022)
         {
            return;
         }
         ...
         {
            this.exchangeElementGraphics("billboard_img",this.var_1505);
         }
         ...
         if(param3)
         {
            ...
            _loc5_.tag = RoomObjectVariableEnum.const_494;
         }
         if(param2 != "")
         {
            _loc4_.visible = true;
      ...
      public function setElementToSprite(param1:int, param2:IRoomObjectSprite, param3:String = "", param4:Boolean = false) : void
      {
         ...
         var _loc5_:XMLList = this.var_1217.elementList;
         if(_loc5_ == null)
         {
            return;
         }
         ...
         if(_loc6_.@id.toString().length > 0)
         {
            ...
            if(this.var_355.indexOf(_loc10_) >= 0 && this.var_797)
            {
               param1 = this.var_355.indexOf(_loc10_);
               if(this.var_535[param1] != "")
               {
                  _loc9_ = this.var_1216.getAsset(this.var_535[param1]);
                  if(_loc9_ != null && _loc9_.asset != null)
                  {
                     param2.asset = _loc9_.asset.content as BitmapData;
                  }
               ...
               if(this.var_536[param1] != -1)
               {
                  param2.alpha = this.var_536[param1];
               }
               this.var_355.splice(param1,1);
      ...
      {
         this.var_797 = true;
         var _loc3_:int = this.var_355.indexOf(param1);
         if(_loc3_ < 0)
         {
