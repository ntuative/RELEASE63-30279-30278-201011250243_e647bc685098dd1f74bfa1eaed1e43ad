package com.sulake.habbo.room.object.visualization.room
{
   ...
   public class RoomVisualization extends RoomObjectSpriteVisualization
   {
      ...
      public static const const_1383:int = 16777215;
      
      public static const const_1359:int = 13421772;
      
      private static const const_815:int = 16777215;
      
      private static const const_816:int = 13421772;
      
      private static const const_814:int = 10066329;
      
      private static const const_817:int = 10066329;
      
      public static const const_1243:int = 16777215;
      
      public static const const_1426:int = 13421772;
      
      public static const const_1397:int = 10066329;
      ...
      private var var_1979:String = null;
      
      private var var_960:uint = 16777215;
      
      private var var_1983:int = 255;
      
      private var var_1982:int = 255;
      
      private var var_1977:int = 255;
      
      private var var_1480:Boolean = true;
      
      private var var_1479:int = 0;
      
      private var _lastUpdateTime:int = -1000;
      
      private const const_1781:int = 250;
      ...
      public function RoomVisualization()
      {
         ...
         this.var_424 = new RoomPlaneBitmapMaskParser();
         this.var_257["null"] = false;
         this.var_257["null"] = true;
         this.var_257["null"] = true;
         this.var_257["null"] = true;
      }
      ...
      override public function get boundingRectangle() : Rectangle
      {
         ...
         {
            this.var_632 = super.boundingRectangle;
         }
         return new Rectangle(this.var_632.x,this.var_632.y,this.var_632.width,this.var_632.height);
      }
      ...
      protected function initializeRoomPlanes() : void
      {
         ...
         var _loc2_:String = _loc1_.getModel().getString(RoomObjectVariableEnum.const_877);
         ...
         while(_loc7_ < this._planeParser.planeCount)
         {
            ...
            _loc13_ = null;
            if(_loc12_ == RoomPlaneData.const_161)
            {
            ...
            else if(_loc12_ == RoomPlaneData.const_1406)
            {
               _loc13_ = new RoomPlane(_loc1_.getLocation(),_loc8_,_loc9_,_loc10_,RoomPlane.const_110,true,_loc11_,_loc6_);
               if(_loc9_.length < 1 || _loc10_.length < 1)
               {
      ...
      override public function update(param1:IRoomGeometry, param2:int, param3:Boolean) : void
      {
         ...
         if(_loc8_ < this._lastUpdateTime + this.const_1781 && !_loc5_ && !_loc7_)
         {
            return;
         }
         ...
         {
            _loc9_ = 0;
            while(_loc9_ < this.var_296.length)
            {
               _loc10_ = this.var_528[_loc9_];
               _loc11_ = getSprite(_loc10_);
               _loc12_ = this.var_296[_loc9_] as RoomPlane;
               if(_loc11_ != null && _loc12_ != null && _loc12_.type != RoomPlane.const_94)
               {
                  if(this.var_1480)
                  {
                     _loc13_ = uint(_loc12_.color);
                     _loc14_ = uint((_loc13_ & 255) * this.var_1977 / 255);
                     _loc15_ = uint((_loc13_ >> 8 & 255) * this.var_1982 / 255);
                     _loc16_ = uint((_loc13_ >> 16 & 255) * this.var_1983 / 255);
      ...
      private function updateGeometry(param1:IRoomGeometry) : Boolean
      {
         ...
         if(param1.updateId != this.var_1637)
         {
            ...
            if(_loc3_ != null && (_loc3_.x != this.var_1294 || _loc3_.y != this.var_1980 || _loc3_.z != this.var_1981 || param1.scale != this.var_1978))
            {
               this.var_1294 = _loc3_.x;
               this.var_1980 = _loc3_.y;
               this.var_1981 = _loc3_.z;
      ...
      private function updateMasksAndColors(param1:IRoomObjectModel) : Boolean
      {
         ...
         var _loc2_:Boolean = false;
         if(var_211 != param1.getUpdateID())
         {
            _loc3_ = param1.getString(RoomObjectVariableEnum.const_1065);
            if(_loc3_ != this.var_1979)
            {
            ...
            if(_loc4_ != this.var_960)
            {
               this.var_960 = _loc4_;
               this.var_1977 = this.var_960 & 255;
               this.var_1982 = this.var_960 >> 8 & 255;
               this.var_1983 = this.var_960 >> 16 & 255;
               _loc2_ = true;
            }
      ...
      private function updatePlaneTexturesAndVisibilities(param1:IRoomObjectModel) : Boolean
      {
         ...
         if(var_211 != param1.getUpdateID())
         {
            _loc2_ = param1.getString(RoomObjectVariableEnum.const_783);
            _loc3_ = param1.getString(RoomObjectVariableEnum.const_626);
            _loc4_ = param1.getString(RoomObjectVariableEnum.const_722);
            this.updatePlaneTextureTypes(_loc3_,_loc2_,_loc4_);
            _loc5_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_724));
            _loc6_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_680));
            _loc7_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_654));
      ...
      {
         if(param1 != this.var_257["null"] || param2 != this.var_257["null"] || param3 != this.var_257["null"])
         {
            this.var_257["null"] = param1;
            this.var_257["null"] = param2;
            this.var_257["null"] = param3;
            this.var_296 = [];
            this.var_528 = [];
         }
      }
      ...
      protected function updatePlanes(param1:IRoomGeometry, param2:Boolean, param3:int) : Boolean
      {
         ...
         var _loc6_:Array = this.var_296;
         if(this.var_296.length == 0)
         {
            _loc6_ = this.var_120;
         }
         var _loc7_:Boolean = false;
         var _loc8_:* = this.var_296.length > 0;
         var _loc9_:int = 0;
               ...
               if(_loc12_ != null)
               {
                  if(_loc12_.update(param1,_loc5_))
                  {
                     if(_loc12_.visible)
                     {
                        ...
                        if(_loc12_.type != RoomPlane.const_190)
                        {
                  ...
                  if(_loc11_.visible != (_loc12_.visible && this.var_257[_loc12_.type]))
                  {
                  ...
                  if(_loc11_.visible)
                  {
                     if(!_loc8_)
                     {
                        this.var_296.push(_loc12_);
                        this.var_528.push(_loc9_);
                     }
                  }
               }
      ...
      protected function updatePlaneMasks(param1:String) : void
      {
         ...
         this.var_424.initialize(_loc2_);
         var _loc3_:* = null;
         var _loc4_:* = [];
         var _loc5_:* = [];
         var _loc6_:Boolean = false;
         ...
         var _loc8_:int = 0;
         while(_loc8_ < this.var_424.maskCount)
         {
            _loc10_ = this.var_424.getMaskType(_loc8_);
            _loc11_ = this.var_424.getMaskLocation(_loc8_);
            _loc12_ = this.var_424.getMaskCategory(_loc8_);
            if(_loc11_ != null)
            {
               _loc13_ = 0;
               while(_loc13_ < this.var_120.length)
               {
                  ...
                  if(_loc3_.type == RoomPlane.const_110 || _loc3_.type == RoomPlane.const_94)
                  {
                     if(_loc3_ != null && _loc3_.location != null && _loc3_.normal != null)
                     {
                        ...
                        if(_loc15_ < 0.01)
                        {
                           if(_loc3_.leftSide != null && _loc3_.rightSide != null)
                           {
                              ...
                              if(_loc3_.type == RoomPlane.const_110 || _loc3_.type == RoomPlane.const_94 && _loc12_ == RoomPlaneBitmapMaskData.const_242)
                              {
