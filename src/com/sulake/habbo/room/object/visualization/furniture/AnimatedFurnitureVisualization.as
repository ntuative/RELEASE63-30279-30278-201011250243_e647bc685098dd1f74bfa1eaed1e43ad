package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class AnimatedFurnitureVisualization extends FurnitureVisualization
   {
      ...
      override protected function updateObject(param1:Number, param2:Number) : Boolean
      {
         ...
         if(super.updateObject(param1,param2))
         {
            ...
            if(_loc4_ != this._state)
            {
               ...
               if(_loc5_ != null)
               {
                  _loc6_ = _loc5_.getNumber(RoomObjectVariableEnum.const_800);
                  this.var_1487 = _loc6_;
               }
            }
            return true;
         }
         ...
         if(super.updateModel(param1))
         {
            ...
            if(_loc2_ != null)
            {
               ...
               if(_loc3_ != null)
               {
                  ...
                  {
                     _loc4_ = _loc3_.getNumber(RoomObjectVariableEnum.const_800);
                     if(_loc4_ > this.var_1487)
                     {
      ...
      private function resetAnimationFrames() : void
      {
         ...
         this.var_966 = false;
         var _loc1_:int = 0;
         while(_loc1_ < this.var_1488)
         {
            this.var_428[_loc1_] = null;
            this.var_530[_loc1_] = false;
      ...
      protected function setAnimation(param1:int) : void
      {
         ...
         {
            if(this.var_427.hasAnimation(AnimationData.getTransitionAnimationId(param1),this.var_1489))
            {
               if(this.var_965 != AnimationData.getTransitionAnimationId(param1))
               {
      ...
      override protected function updateAnimation(param1:Number) : Array
      {
         ...
         if(param1 != this.var_1489)
         {
            this.var_1488 = this.var_427.getLayerCount(param1);
            this.resetAnimationFrames();
         }
         var _loc2_:Array = this.updateAnimationFrames(param1);
         if(this.var_966 && _loc2_ != null && AnimationData.isTransitionAnimation(this.var_965))
         {
            this.setAnimation(AnimationData.getAnimationId(this.var_965));
      ...
      private function updateAnimationFrames(param1:Number) : Array
      {
         ...
         if(this.var_635 == 0)
         {
            this.var_635 = this.var_427.getStartFrame(this.animationId,param1);
         }
         this.var_635 += 1;
         var _loc3_:* = null;
         this.var_966 = true;
         var _loc4_:int = this.var_1488 - 1;
         while(_loc4_ >= 0)
         {
            _loc5_ = this._animationPlayed[_loc4_];
            if(!_loc5_)
            {
               _loc6_ = this.var_530[_loc4_];
               ...
               if(_loc7_ == null || _loc7_.remainingFrameRepeats >= 0 && _loc9_ <= 0)
               {
                  ...
                  if(_loc8_ == AnimationFrame.const_924)
                  {
                     _loc7_ = this.var_427.getFrame(_loc4_,this.animationId,this.var_635,param1);
                  }
                  else
                  {
                     _loc7_ = this.var_427.getFrameFromSequence(_loc4_,this.animationId,_loc8_,_loc7_.activeSequenceOffset + _loc7_.repeats,this.var_635,param1);
                  }
               ...
               if(_loc7_ == null || _loc7_.remainingFrameRepeats == AnimationFrame.const_393)
               {
                  _loc6_ = true;
                  _loc5_ = true;
               }
