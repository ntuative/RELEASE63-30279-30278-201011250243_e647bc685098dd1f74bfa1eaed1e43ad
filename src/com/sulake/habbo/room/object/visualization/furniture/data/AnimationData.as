package com.sulake.habbo.room.object.visualization.furniture.data
{
   ...
   public class AnimationData
   {
      ...
      public function getStartFrame() : int
      {
         ...
         return Math.random() * this.var_351;
      }
      ...
      private function addLayer(param1:int, param2:int, param3:int, param4:Boolean, param5:XML) : Boolean
      {
         ...
         if(_loc11_ > this.var_351)
         {
            this.var_351 = _loc11_;
         }
         return true;
      }
      ...
      {
         var _loc3_:AnimationLayerData = this.var_108.getValue(param1) as AnimationLayerData;
         if(_loc3_ != null)
         {
      ...
      {
         var _loc5_:AnimationLayerData = this.var_108.getValue(param1) as AnimationLayerData;
         if(_loc5_ != null)
         {
