package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurniturePlanetSystemVisualizationPlanetObject
   {
      ...
      public function FurniturePlanetSystemVisualizationPlanetObject(param1:String, param2:int, param3:Number, param4:Number, param5:Number, param6:Number)
      {
         ...
         this.var_2446 = param4 * 0 * 2 / 360;
         this.var_1752 = param5 * 0 * 2 / 360;
         this._height = param6;
         this.var_1107 = 0;
      }
      ...
      {
         var _loc4_:* = null;
         this.var_1107 += this.var_2446 / const_1210;
      ...
      {
         var _loc3_:Number = this.var_1286 * Math.cos(this.var_1107 + this.var_1752);
         var _loc4_:Number = this.var_1286 * Math.sin(this.var_1107 + this.var_1752);
