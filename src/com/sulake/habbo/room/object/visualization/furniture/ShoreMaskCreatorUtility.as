package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class ShoreMaskCreatorUtility
   {
      ...
      {
         return param1 + param2 * const_1173;
      }
            ...
            if(param2.getAsset(_loc4_) == null)
            {
               if(param3 != null)
               {
                  ...
                  if(_loc5_ != null)
                  {
                     ...
                     _loc7_ = [const_135,const_74,const_64,const_135,const_74,const_64];
                     _loc8_ = [const_74,const_74,const_74,const_64,const_64,const_64];
                     _loc9_ = null;
                     _loc10_ = 0;
                     if(_loc6_ != null)
                     {
      ...
      private static function method_9(param1:BitmapData, param2:int) : void
      {
         var _loc3_:int = param1.width / 2 + param2 / 2;
