package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurnitureVisualization extends RoomObjectSpriteVisualization
   {
      ...
      protected static const const_1505:Number = Math.sqrt(0.5);
       
      
      protected var _direction:int;
      
      protected var var_2597:Number = NaN;
      
      protected var var_2596:int = -1;
      ...
      protected function updateSprites(param1:int, param2:Boolean, param3:Array) : void
      {
         var _loc5_:int = 0;
         var _loc6_:int = 0;
         if(this.var_1488 != spriteCount)
         {
            createSprites(this.var_1488);
         }
         var _loc4_:Boolean = false;
         ...
         if(_loc5_ != null)
         {
            ...
            if(_loc6_ != null && _loc6_.asset != null)
            {
               ...
               if(param1 < spriteCount - 1)
               {
                  ...
                  _loc5_.color = this.getSpriteColor(param1,this.var_2596,param2);
      ...
      protected function updateObject(param1:Number, param2:Number) : Boolean
      {
         ...
         if(var_407 != _loc3_.getUpdateID() || param1 != var_250 || param2 != this.var_2597)
         {
      ...
      protected function updateModel(param1:Number) : Boolean
      {
         ...
         if(var_211 != _loc3_.getUpdateID())
         {
            this.var_2596 = _loc3_.getNumber(RoomObjectVariableEnum.const_240);
            ...
            this.var_1163 = _loc3_.getString(RoomObjectVariableEnum.const_319);
            if(this.var_1163 == null || this.var_1163.indexOf("http") != 0)
            {
               this.var_1163 = null;
            }
            var_211 = _loc3_.getUpdateID();
            return true;
         }
         return false;
      }
      ...
      {
         if(this.include != param1 || this.var_2515 != param2)
         {
            this.var_903 = [];
            this.var_902 = [];
            this.var_728 = [];
            ...
            this.var_1488 = this._data.getLayerCount(param2) + 1;
         }
      }
      ...
      protected function getSpriteAssetName(param1:int, param2:Number) : String
      {
         ...
         var _loc6_:* = null;
         var _loc7_:int = 0;
         if(this._data == null || param1 >= FurnitureVisualizationData.const_1091.length)
         {
            return "";
         }
         var _loc3_:String = this.var_903[param1];
         var _loc4_:Boolean = this.var_902[param1];
         if(_loc3_ == null || _loc3_.length == 0)
         {
            ...
            if(param1 < spriteCount - 1)
            {
               ...
               _loc6_ = FurnitureVisualizationData.const_1091[param1];
            }
            else
            {
               _loc6_ = "sd";
      ...
      {
         if(this.var_734[param1] != null && !this.var_1790)
         {
