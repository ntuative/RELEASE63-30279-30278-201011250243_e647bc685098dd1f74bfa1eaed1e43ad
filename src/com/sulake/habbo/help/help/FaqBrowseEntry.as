package com.sulake.habbo.help.help
{
   ...
   public class FaqBrowseEntry extends SearchViewController implements IHelpViewController
   {
      ...
      override public function update(param1:* = null) : void
      {
         ...
         if(param1 != null)
         {
            this.var_198 = FaqItem(param1);
         }
         if(this.var_198 == null)
         {
            return;
         }
         if(!this.var_198.hasAnswer)
         {
            main.sendMessage(new GetFaqTextMessageComposer(this.var_198.questionId));
            return;
         }
         var _loc3_:FaqCategory = this.var_198.category;
         if(_loc3_ == null)
         {
            return;
         }
         ...
         if(_loc4_ != null)
         {
            _loc4_.text = this.var_198.questionText;
         }
         _loc4_ = container.findChildByTag("faq_answer_text") as ITextWindow;
         if(_loc4_ != null)
         {
            _loc4_.htmlText = this.hackHTML(this.var_198.answerText);
         }
         if(_loc3_ != null)
         {
            _loc5_ = _loc3_.getItemByIndex(this.var_198.index + 1);
         }
      ...
      override public function windowProcedure(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param2.name)
         {
            case "help_faq_back":
               if(this.var_198 != null)
               {
                  _loc3_ = this.var_198.category;
                  main.showUI(HabboHelpViewEnum.const_302);
                  main.tellUI(HabboHelpViewEnum.const_302,_loc3_);
               }
               break;
      ...
      private function getNextItem() : FaqItem
      {
         ...
         if(_loc1_ == null || this.var_198 == null)
         {
            return null;
         }
         var _loc2_:FaqCategory = this.var_198.category;
         if(_loc2_ == null)
         {
            return null;
         }
         return _loc2_.getItemByIndex(this.var_198.index + 1);
      }
   }
}
