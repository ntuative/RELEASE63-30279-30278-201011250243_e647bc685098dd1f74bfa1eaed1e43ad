package com.sulake.habbo.help.help.data
{
   ...
   public class FaqCategory
   {
      ...
      public function storeItem(param1:int, param2:String, param3:String = null) : void
      {
         ...
         if(_loc4_ == null)
         {
            _loc4_ = new FaqItem(param1,param2,this.var_132.length,this);
            this.var_132.add(param1,_loc4_);
         }
      }
      ...
      public function getItemByIndex(param1:int) : FaqItem
      {
         ...
         return this.var_132.getWithIndex(param1);
      }
      ...
      {
         return this.var_132.getValue(param1) != null;
      }
      ...
      public function getQuestionTitleArray() : Array
      {
         ...
         {
            _loc2_ = this.var_132.getWithIndex(_loc3_);
      ...
      {
         return this.var_132.length > 0 || this.hasUpdatedWithinHour();
      }
      
      public function setTimeStamp() : void
      {
         this.var_1429 = new Date();
      }
      ...
      public function getAgeSeconds() : Number
      {
         ...
         return (new Date().valueOf() - this.var_1429.valueOf()) / 1000;
      }
