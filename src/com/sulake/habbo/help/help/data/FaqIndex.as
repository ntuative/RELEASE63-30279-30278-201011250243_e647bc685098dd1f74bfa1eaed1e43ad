package com.sulake.habbo.help.help.data
{
   ...
   public class FaqIndex
   {
      ...
      private var var_714:FaqCategory;
      ...
      {
         super();
         this.var_716 = new FaqCategory(-999,"${help.faq.title.urgent}");
         this.var_715 = new FaqCategory(-9999,"${help.faq.title.normal}");
         this.var_714 = new FaqCategory(-99999,"${help.faq.title.searchresults}");
      ...
      public function storeAnswerText(param1:int, param2:String) : void
      {
         ...
         if(this.var_714.hasItem(param1))
         {
            this.var_714.getItem(param1).answerText = param2;
         }
         var _loc3_:int = 0;
      ...
      private function findItem(param1:int) : FaqItem
      {
         ...
         if(this.var_714.hasItem(param1))
         {
            return this.var_714.getItem(param1);
         }
         var _loc2_:int = 0;
