package com.sulake.habbo.help.help
{
   ...
   public class HelpUI
   {
      ...
      private static const const_1539:int = 0;
      
      private static const const_1540:int = 0;
      ...
      {
         this.var_332 = this._defaultViewId;
         ...
         this._windowManager.registerLocalizationParameter("info.client.version","version",new String(201011250236));
         this._toolbar = param5;
         this.var_96 = new Map();
         this.var_96.add(HabboHelpViewEnum.const_1363,IHelpViewController(new PlaceholderView(this,this._windowManager,this._assetLibrary)));
         this.var_96.add(HabboHelpViewEnum.const_154,IHelpViewController(new HelpMainView(this,this._windowManager,this._assetLibrary)));
         this.var_96.add(HabboHelpViewEnum.const_520,IHelpViewController(new FaqBrowseTopView(this,this._windowManager,this._assetLibrary)));
         this.var_96.add(HabboHelpViewEnum.const_302,IHelpViewController(new FaqBrowseCategoryView(this,this._windowManager,this._assetLibrary)));
         this.var_96.add(HabboHelpViewEnum.const_233,IHelpViewController(new FaqBrowseEntry(this,this._windowManager,this._assetLibrary)));
         this.var_96.add(HabboHelpViewEnum.const_686,IHelpViewController(new FaqBrowseSearchResults(this,this._windowManager,this._assetLibrary)));
         this.var_96.add(HabboHelpViewEnum.const_331,IHelpViewController(new CallForHelpTopicSelection(this,this._windowManager,this._assetLibrary)));
         this.var_96.add(HabboHelpViewEnum.const_598,IHelpViewController(new CallForHelpTextInput(this,this._windowManager,this._assetLibrary)));
         this.var_96.add(HabboHelpViewEnum.const_226,IHelpViewController(new CallForHelpSentView(this,this._windowManager,this._assetLibrary,"help_cfh_thanks")));
         this.var_96.add(HabboHelpViewEnum.const_1064,IHelpViewController(new CallForHelpSentView(this,this._windowManager,this._assetLibrary,"help_cfh_abusive")));
         this.var_96.add(HabboHelpViewEnum.const_1055,IHelpViewController(new CallForHelpPendingItemView(this,this._windowManager,this._assetLibrary)));
         this.var_96.add(HabboHelpViewEnum.const_704,IHelpViewController(new CallForHelpReportUserSelection(this,this._windowManager,this._assetLibrary)));
      }
      ...
      public function showUI(param1:String = null, param2:Boolean = true) : void
      {
         ...
         {
            if(this.var_706.length == 0 || param1 != this.var_332)
            {
               this.var_706.push(this.var_332);
            }
         }
         this.var_332 = param1;
         ...
         if(_loc4_ == null)
         {
            Logger.log("* No view controller found for " + this.var_332);
            return;
         }
         ...
         if(_loc3_)
         {
            ...
            {
               this._toolbar.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_51,HabboToolbarIconEnum.HELP,this._window));
            }
         }
      ...
      public function showCallForHelpResult(param1:String) : void
      {
         switch(param1)
         {
            ...
            case CallForHelpResultEnum.const_990:
               ...
               break;
            case CallForHelpResultEnum.const_916:
               this.showUI(HabboHelpViewEnum.const_1064);
         }
      }
      ...
      public function updateCallForGuideBotUI(param1:Boolean) : void
      {
         ...
         var _loc2_:IHelpViewController = this.var_96.getValue(HabboHelpViewEnum.const_154) as IHelpViewController;
      ...
      public function handleCallGuideBot() : void
      {
         ...
         this.hideUI();
         this._component.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_451));
      }
      ...
      {
         return this.var_96.getValue(this.var_332);
      }
      ...
      private function createWindow() : void
      {
         ...
         this.var_1716 = this._window.width - _loc3_.width;
      ...
      public function updateWindowDimensions() : void
      {
         ...
         this._window.height = _loc1_.height + this.var_1715;
         this._window.width = _loc1_.width + this.var_1716;
      }
         ...
         switch(param1.type)
         {
            case WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK:
               ...
               if(param2.tags.indexOf("back") > -1)
               {
                  ...
                  {
                     this.showUI(this.var_706.pop(),false);
                  }
                  return;
               }
               break;
      ...
      {
         var _loc3_:* = null;
         if(this.var_332 == HabboHelpViewEnum.const_154)
         {
            return;
         }
         if(this.var_586.length < 2)
         {
            _loc3_ = this._assetLibrary.getAssetByName("back_png") as BitmapDataAsset;
            this.var_586.push(_loc3_.content as BitmapData);
            _loc3_ = this._assetLibrary.getAssetByName("back_hi_png") as BitmapDataAsset;
            this.var_586.push(_loc3_.content as BitmapData);
         }
         var _loc2_:IBitmapWrapperWindow = this.var_477.findChildByName("back_image") as IBitmapWrapperWindow;
         if(_loc2_ == null)
         {
            return;
         }
         ...
         if(param1)
         {
            _loc2_.bitmap.copyPixels(this.var_586[1],this.var_586[1].rect,new Point(0,0));
         }
         else
         {
            _loc2_.bitmap.copyPixels(this.var_586[0],this.var_586[0].rect,new Point(0,0));
         }
      }
      ...
      private function addBackButtonWindow() : void
      {
         var _loc2_:* = null;
         var _loc3_:* = null;
         if(this.var_332 == HabboHelpViewEnum.const_154 || this.var_706.length == 0)
         {
            return;
         }
         if(this.var_477 == null)
         {
            ...
            this.var_477 = _loc2_.buildFromXML(XML(_loc3_.content)) as IWindowContainer;
         }
         var _loc1_:IItemListWindow = this._window.findChildByName("content_list") as IItemListWindow;
         if(_loc1_ == null || this.var_477 == null)
         {
            return;
         }
         if(_loc1_.getListItemIndex(this.var_477 as IWindow) > -1)
         {
            return;
         }
         _loc1_.addListItem(this.var_477 as IWindow);
         this.setBackButtonActiveState(false);
      }
   }
}
