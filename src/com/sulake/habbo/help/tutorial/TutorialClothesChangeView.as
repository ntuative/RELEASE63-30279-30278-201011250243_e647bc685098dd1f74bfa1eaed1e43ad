package com.sulake.habbo.help.tutorial
{
   ...
   public class TutorialClothesChangeView implements ITutorialUIView
   {
      ...
      public function TutorialClothesChangeView(param1:IItemListWindow, param2:TutorialUI)
      {
         ...
         this.var_44.help.toolbar.events.addEventListener(HabboToolbarShowMenuEvent.const_51,this.onShowMenuEvent);
      ...
      public function dispose() : void
      {
         ...
         this.var_44.help.toolbar.events.removeEventListener(HabboToolbarShowMenuEvent.const_51,this.onShowMenuEvent);
      }
      ...
      private function showToolbarIconHighlightArrow() : void
      {
         ...
         this.var_650 = this.var_44.buildXmlWindow("tutorial_arrow") as IWindowContainer;
         var _loc1_:IBitmapWrapperWindow = this.var_650.findChildByName("arrow") as IBitmapWrapperWindow;
         if(_loc1_ != null)
         {
         ...
         this.var_44.help.toolbar.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_51,HabboToolbarIconEnum.MEMENU_ARROW,this.var_650));
      }
      ...
      private function windowProcedure(param1:WindowEvent, param2:IWindow) : void
      {
         switch(param2.name)
         {
            case "button_cancel":
               ...
               {
                  this.var_44.showView(TutorialUI.const_82);
               }
         }
      }
   }
