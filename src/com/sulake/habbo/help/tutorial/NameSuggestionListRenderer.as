package com.sulake.habbo.help.tutorial
{
   ...
   public class NameSuggestionListRenderer
   {
      ...
      private const const_1787:int = 5;
      
      private const const_1786:int = 5;
      ...
      private var var_989:Rectangle = null;
      ...
      public function render(param1:Array, param2:IWindowContainer) : int
      {
         ...
         this._offsetX = 0;
         this.var_988 = 0;
         this.var_989 = param2.rectangle.clone();
         this.var_989.height = 150;
         var _loc4_:int = 0;
      ...
      {
         if(param1.width > this.var_989.width)
         {
            return false;
         }
         if(this.var_988 + param1.height > this.var_989.height)
         {
            return false;
         }
         if(this._offsetX + param1.width > this.var_989.width)
         {
            this._offsetX = 0;
            this.var_988 += param1.height + this.const_1786;
            return this.fit(param1);
         }
         param1.offset(this._offsetX,this.var_988);
         this._offsetX += param1.width + this.const_1787;
         return true;
      }
