package com.sulake.habbo.help.hotelmerge
{
   ...
   public class HotelMergeNameChangeView
   {
      ...
      private function showSelectionView() : void
      {
         if(!this.var_623)
         {
            this.var_623 = this.createWindow("hotel_merge_name_selection_xml") as IWindowContainer;
            if(!this.var_623)
            {
               return;
            }
      ...
      private function showConfirmationView() : void
      {
         if(!this.var_622)
         {
            this.var_622 = this.createWindow("hotel_merge_name_confirmation_xml") as IWindowContainer;
            if(!this.var_622)
            {
               return;
            }
