   ...
   public class MeMenuWidgetHandler implements IRoomWidgetHandler, IHabboAvatarEditorDataSaver, IAvatarImageListener
   {
      ...
      public function set container(param1:IRoomWidgetHandlerContainer) : void
      {
         if(this._container != null)
         {
            ...
            {
               this._container.sessionDataManager.events.removeEventListener(HabboSessionFigureUpdatedEvent.const_588,this.onFigureUpdate);
            }
            ...
            {
               this._container.habboHelp.events.removeEventListener(HabboHelpTutorialEvent.const_503,this.onHelpTutorialEvent);
         ...
         {
            this._container.sessionDataManager.events.addEventListener(HabboSessionFigureUpdatedEvent.const_588,this.onFigureUpdate);
         ...
         {
            (this._inventory as Component).events.addEventListener(HabboInventoryEffectsEvent.const_1094,this.onAvatarEffectsChanged);
            (this._inventory as Component).events.addEventListener(HabboInventoryHabboClubEvent.const_1021,this.onHabboClubSubscriptionChanged);
         }
         ...
         if(this._container.habboHelp)
         {
            this._container.habboHelp.events.addEventListener(HabboHelpTutorialEvent.const_503,this.onHelpTutorialEvent);
      ...
      public function getWidgetMessages() : Array
      {
         ...
         _loc1_.push(RoomWidgetDanceMessage.const_647);
         _loc1_.push(RoomWidgetGetEffectsMessage.const_616);
         _loc1_.push(RoomWidgetSelectEffectMessage.const_735);
         _loc1_.push(RoomWidgetSelectEffectMessage.const_777);
         _loc1_.push(RoomWidgetSelectEffectMessage.const_745);
         _loc1_.push(RoomWidgetOpenInventoryMessage.const_734);
         _loc1_.push(RoomWidgetOpenCatalogMessage.const_764);
         _loc1_.push(RoomWidgetStopEffectMessage.const_719);
         _loc1_.push(RoomWidgetNavigateToRoomMessage.const_1470);
         _loc1_.push(RoomWidgetNavigateToRoomMessage.const_886);
         _loc1_.push(RoomWidgetToolbarMessage.const_595);
         _loc1_.push(RoomWidgetToolbarMessage.const_659);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_356);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_1456);
         _loc1_.push(RoomWidgetSelectOutfitMessage.const_1000);
         _loc1_.push(RoomWidgetShowOwnRoomsMessage.const_790);
         _loc1_.push(RoomWidgetRequestWidgetMessage.const_662);
         _loc1_.push(RoomWidgetGetSettingsMessage.const_754);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_1449);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_778);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_561);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_619);
         _loc1_.push(RoomWidgetClothingChangeMessage.const_359);
         return _loc1_;
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetRequestWidgetMessage.const_662:
            ...
            case RoomWidgetWaveMessage.const_771:
               ...
               {
                  this._container.roomSession.method_11();
               }
               break;
            case RoomWidgetDanceMessage.const_647:
               if(this._container != null && this._container.roomSession != null)
               {
            ...
            case RoomWidgetGetEffectsMessage.const_616:
               ...
               break;
            case RoomWidgetSelectEffectMessage.const_735:
               if(this._inventory != null)
               {
               ...
               break;
            case RoomWidgetSelectEffectMessage.const_777:
               if(this._inventory != null)
               {
            ...
            case RoomWidgetOpenCatalogMessage.const_764:
               ...
               if(this._catalog != null && _loc2_.pageKey == RoomWidgetOpenCatalogMessage.const_885)
               {
            ...
            case RoomWidgetOpenInventoryMessage.const_734:
               ...
               break;
            case RoomWidgetSelectEffectMessage.const_745:
            case RoomWidgetStopEffectMessage.const_719:
            ...
            case RoomWidgetNavigateToRoomMessage.const_886:
               ...
               break;
            case RoomWidgetShowOwnRoomsMessage.const_790:
               if(this._container != null)
               {
            ...
            case RoomWidgetToolbarMessage.const_595:
               ...
               if(this._toolbar)
               {
                  this._toolbar.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_51,HabboToolbarIconEnum.MEMENU,_loc5_.window));
                  if(this._inventory != null)
                  {
                     _loc12_ = false;
                     if(this._container != null && this._container.sessionDataManager != null)
               ...
               break;
            case RoomWidgetToolbarMessage.const_659:
               ...
               {
                  this._toolbar.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_443,HabboToolbarIconEnum.MEMENU,_loc6_.window));
               }
               break;
            case RoomWidgetAvatarEditorMessage.const_356:
               ...
               if(this._container)
               {
                  ...
                  {
                     this._container.habboHelp.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_483));
                  }
               }
               break;
            case RoomWidgetGetSettingsMessage.const_754:
               this._container.events.dispatchEvent(new RoomWidgetSettingsUpdateEvent(RoomWidgetSettingsUpdateEvent.const_322,this._container.soundManager.volume));
               break;
            case RoomWidgetStoreSettingsMessage.const_778:
            ...
            case RoomWidgetAvatarEditorMessage.const_619:
               if(this._container.habboHelp && this._container.habboHelp.events)
               {
                  this._container.habboHelp.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_476));
               }
               break;
            case RoomWidgetClothingChangeMessage.const_359:
               this._container.events.dispatchEvent(new RoomWidgetAvatarEditorUpdateEvent(RoomWidgetAvatarEditorUpdateEvent.const_632));
               break;
            default:
      ...
      private function onAvatarEditorClosed(param1:Event = null) : void
      {
         ...
         this._container.events.dispatchEvent(new RoomWidgetAvatarEditorUpdateEvent(RoomWidgetAvatarEditorUpdateEvent.const_629));
      }
      ...
      private function onHelpTutorialEvent(param1:HabboHelpTutorialEvent) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case HabboHelpTutorialEvent.const_503:
               this._container.events.dispatchEvent(new RoomWidgetTutorialEvent(RoomWidgetTutorialEvent.const_491));
         }
      }
