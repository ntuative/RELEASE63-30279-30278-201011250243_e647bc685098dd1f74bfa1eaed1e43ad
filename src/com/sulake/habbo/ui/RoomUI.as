package com.sulake.habbo.ui
{
   ...
   public class RoomUI extends Component implements IRoomUI, IUpdateReceiver
   {
      ...
      private var var_1007:IRoomWidgetFactory;
      ...
      private var var_1566:IHabboAvatarEditor = null;
      ...
      private var var_1006:IHabboHelp;
      
      private var var_821:IHabboModeration;
      ...
      private var var_1008:IHabboUserDefinedRoomEvents;
      
      public function RoomUI(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         this.var_1259 = RoomDesktop.const_488;
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_1007.release(new IIDHabboRoomWidget());
            this.var_1007 = null;
         }
         ...
         {
            this.var_564.release(new IIDHabboSoundManager());
            this.var_564 = null;
         }
         ...
         {
            this.var_418.release(new IIDAvatarRenderManager());
            this.var_418 = null;
         }
         ...
         {
            this.var_1006.release(new IIDHabboHelp());
            this.var_1006 = null;
         }
         ...
         {
            this.var_821.release(new IIDHabboModeration());
            this.var_821 = null;
         }
         ...
         {
            this.var_398.release(new IIDSessionDataManager());
            this.var_398 = null;
         }
         ...
         if(this.var_1008)
         {
            this.var_1008.release(new IIDHabboUserDefinedRoomEvents());
            this.var_1008 = null;
         }
         this.var_1566 = null;
      ...
      private function onRoomWidgetFactoryReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_1007 = param2 as IRoomWidgetFactory;
      }
      ...
      private function onAvatarRenderManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_418 = param2 as IAvatarRenderManager;
      }
      ...
      private function onAvatarEditorReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_1566 = param2 as IHabboAvatarEditor;
      }
      ...
      private function onAdManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(this.var_263 != null && this.var_263.events != null)
         {
            this.var_263.events.addEventListener(AdEvent.const_465,this.adEventHandler);
            this.var_263.events.addEventListener(AdEvent.const_453,this.adEventHandler);
            this.var_263.events.addEventListener(AdEvent.const_523,this.adEventHandler);
         }
      }
      ...
      private function onHabboHelpReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_1006 = param2 as IHabboHelp;
      }
      ...
      private function onHabboModerationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_821 = param2 as IHabboModeration;
         Logger.log("XXXX GOT HABBO MODERATION: " + this.var_821);
      }
      ...
      private function onSoundManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_564 = param2 as IHabboSoundManager;
      }
      ...
      private function registerSessionEvents() : void
      {
         if(this.var_19)
         {
            this.var_19.events.addEventListener(RoomSessionEvent.const_212,this.roomSessionStateEventHandler);
            this.var_19.events.addEventListener(RoomSessionEvent.const_88,this.roomSessionStateEventHandler);
            this.var_19.events.addEventListener(RoomSessionEvent.const_90,this.roomSessionStateEventHandler);
            this.var_19.events.addEventListener(RoomSessionChatEvent.const_169,this.roomSessionEventHandler);
            this.var_19.events.addEventListener(RoomSessionChatEvent.const_439,this.roomSessionEventHandler);
            this.var_19.events.addEventListener(RoomSessionUserBadgesEvent.const_126,this.roomSessionEventHandler);
            this.var_19.events.addEventListener(RoomSessionDoorbellEvent.const_108,this.roomSessionEventHandler);
            this.var_19.events.addEventListener(RoomSessionDoorbellEvent.const_127,this.roomSessionEventHandler);
            this.var_19.events.addEventListener(RoomSessionDoorbellEvent.const_42,this.roomSessionEventHandler);
            this.var_19.events.addEventListener(RoomSessionPresentEvent.const_259,this.roomSessionEventHandler);
            ...
            this.var_19.events.addEventListener(RoomSessionErrorMessageEvent.const_658,this.roomSessionDialogEventHandler);
            this.var_19.events.addEventListener(RoomSessionErrorMessageEvent.const_951,this.roomSessionDialogEventHandler);
            this.var_19.events.addEventListener(RoomSessionErrorMessageEvent.const_1026,this.roomSessionDialogEventHandler);
            this.var_19.events.addEventListener(RoomSessionErrorMessageEvent.const_243,this.roomSessionDialogEventHandler);
            this.var_19.events.addEventListener(RoomSessionErrorMessageEvent.const_255,this.roomSessionDialogEventHandler);
            this.var_19.events.addEventListener(RoomSessionErrorMessageEvent.const_213,this.roomSessionDialogEventHandler);
            this.var_19.events.addEventListener(RoomSessionErrorMessageEvent.const_207,this.roomSessionDialogEventHandler);
            ...
            this.var_19.events.addEventListener(RoomSessionErrorMessageEvent.const_760,this.roomSessionDialogEventHandler);
            this.var_19.events.addEventListener(RoomSessionErrorMessageEvent.const_187,this.roomSessionDialogEventHandler);
            this.var_19.events.addEventListener(RoomSessionErrorMessageEvent.const_762,this.roomSessionDialogEventHandler);
            this.var_19.events.addEventListener(RoomSessionErrorMessageEvent.const_552,this.roomSessionDialogEventHandler);
            this.var_19.events.addEventListener(RoomSessionQueueEvent.const_518,this.roomSessionEventHandler);
            this.var_19.events.addEventListener(RoomSessionVoteEvent.const_117,this.roomSessionEventHandler);
            this.var_19.events.addEventListener(RoomSessionVoteEvent.const_128,this.roomSessionEventHandler);
            this.var_19.events.addEventListener(RoomSessionPollEvent.const_131,this.roomSessionEventHandler);
            this.var_19.events.addEventListener(RoomSessionPollEvent.const_66,this.roomSessionEventHandler);
            this.var_19.events.addEventListener(RoomSessionPollEvent.const_140,this.roomSessionEventHandler);
            this.var_19.events.addEventListener(RoomSessionDimmerPresetsEvent.const_501,this.roomSessionEventHandler);
            this.var_19.events.addEventListener(RoomSessionFriendRequestEvent.const_134,this.roomSessionEventHandler);
         }
      }
         ...
         switch(param1.type)
         {
            ...
            case RoomSessionEvent.const_90:
               if(param1.session != null)
               {
                  ...
                  this._toolbar.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_143,HabboToolbarIconEnum.ZOOM));
                  this._toolbar.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_143,HabboToolbarIconEnum.MEMENU));
                  this._toolbar.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_143,HabboToolbarIconEnum.INVENTORY));
               }
         }
      }
      ...
      private function roomSessionDialogEventHandler(param1:RoomSessionEvent) : void
      {
         ...
         switch(event.type)
         {
            ...
            case RoomSessionErrorMessageEvent.const_628:
               ...
               break;
            case RoomSessionErrorMessageEvent.const_760:
      ...
      {
         this.var_1008 = param2 as IHabboUserDefinedRoomEvents;
      }
      ...
      private function initializeRoomEngineEvents() : void
      {
         if(this._roomEngine != null && this._roomEngine.events != null)
         {
            ...
            this._roomEngine.events.addEventListener(RoomEngineEvent.const_633,this.roomEventHandler);
            this._roomEngine.events.addEventListener(RoomEngineEvent.const_556,this.roomEventHandler);
            this._roomEngine.events.addEventListener(RoomEngineEvent.const_410,this.roomEngineEventHandler);
            ...
            this._roomEngine.events.addEventListener(RoomEngineRoomColorEvent.const_679,this.roomEventHandler);
            this._roomEngine.events.addEventListener(RoomEngineObjectEvent.const_728,this.roomObjectEventHandler);
            this._roomEngine.events.addEventListener(RoomEngineObjectEvent.const_487,this.roomObjectEventHandler);
            this._roomEngine.events.addEventListener(RoomEngineObjectEvent.const_290,this.roomObjectEventHandler);
            ...
            this._roomEngine.events.addEventListener(RoomEngineObjectEvent.const_97,this.roomObjectEventHandler);
      ...
      private function roomEngineEventHandler(param1:RoomEngineEvent) : void
      {
         ...
         else if(param1.type == RoomEngineEvent.const_434 || param1.type == RoomEngineEvent.const_410)
         {
      ...
      private function roomEventHandler(param1:RoomEngineEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomEngineEvent.const_633:
               ...
               if(this.var_1259 != RoomDesktop.const_488)
               {
                  _loc3_.initializeWidget(RoomWidgetEnum.const_266,this.var_1259);
               }
               if(this.var_263 != null)
               {
                  this.var_263.showRoomAd();
               }
               break;
            case RoomEngineEvent.const_556:
               this.disposeDesktop(_loc2_);
               break;
            case RoomEngineRoomColorEvent.const_679:
      ...
      public function createDesktop(param1:IRoomSession) : IRoomDesktop
      {
         ...
         _loc3_.roomWidgetFactory = this.var_1007;
         _loc3_.sessionDataManager = this.var_398;
         _loc3_.roomSessionManager = this.var_19;
         _loc3_.friendList = this._friendList;
         _loc3_.avatarRenderManager = this.var_418;
         _loc3_.inventory = this._inventory;
         _loc3_.toolbar = this._toolbar;
         _loc3_.navigator = this._navigator;
         _loc3_.avatarEditor = this.var_1566;
         _loc3_.catalog = this._catalog;
         _loc3_.adManager = this.var_263;
         _loc3_.localization = this._localization;
         _loc3_.habboHelp = this.var_1006;
         _loc3_.moderation = this.var_821;
         _loc3_.config = this._config;
         _loc3_.soundManager = this.var_564;
         _loc3_.habboTracking = this._habboTracking;
         _loc3_.userDefinedRoomEvents = this.var_1008;
      ...
      public function disposeDesktop(param1:String) : void
      {
         ...
         if(_loc2_ != null)
         {
            ...
            if(_loc3_ != RoomDesktop.const_488)
            {
               this.var_1259 = _loc3_;
            }
            _loc2_.dispose();
         }
      }
