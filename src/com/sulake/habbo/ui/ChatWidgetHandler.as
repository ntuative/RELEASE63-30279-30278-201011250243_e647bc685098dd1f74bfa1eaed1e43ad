package com.sulake.habbo.ui
{
   ...
   public class ChatWidgetHandler implements IRoomWidgetHandler, IPetImageListener, IAvatarImageListener
   {
      ...
      private var var_916:Map = null;
      
      private var _connection:IConnection = null;
      
      private var var_1140:Number = 0.0;
      
      private var var_742:Point = null;
      ...
      public function dispose() : void
      {
         ...
         if(this.var_400 != null)
         {
            ...
            {
               _loc2_ = this.var_400.getWithIndex(_loc1_) as BitmapData;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
      ...
      {
         return [RoomWidgetChatMessage.const_591,RoomWidgetChatSelectAvatarMessage.const_727];
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetChatMessage.const_591:
               ...
               break;
            case RoomWidgetChatSelectAvatarMessage.const_727:
      ...
      {
         return [RoomSessionChatEvent.const_169];
      }
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case RoomSessionChatEvent.const_169:
                  ...
                  if(_loc4_ != null)
                  {
                     ...
                     if(_loc5_ != null)
                     {
                        ...
                        if(_loc10_ != null)
                        {
                           ...
                           {
                              _loc13_ = this.var_400.getValue(_loc16_) as BitmapData;
                           }
                           else
                           {
                              _loc13_ = this.var_399.getValue(_loc16_) as BitmapData;
                           }
                           _loc12_ = uint(this.var_916.getValue(_loc16_));
                           if(_loc13_ == null)
                           {
                              if(this._container.avatarRenderManager != null)
                              {
                                 ...
                                 if(_loc10_.type == RoomObjectTypeEnum.const_239)
                                 {
                                    if(_loc13_ != null)
                                    {
                                       this.var_400.add(_loc17_.getFigure().getFigureString(),_loc13_);
                                    }
                                 }
                                 ...
                                 if(_loc12_ != 0)
                                 {
                                    this.var_916.add(_loc16_,_loc12_);
                                 }
                                 if(_loc17_ != null)
                                 {
                                    _loc17_.dispose();
      ...
      private function updateWidgetPosition() : void
      {
         ...
         if(_loc4_ != null)
         {
            ...
            if(this.var_1140 > 0)
            {
               _loc5_ = Number(_loc4_.scale / this.var_1140);
            }
            if(this.var_742 == null)
            {
               ...
               this.var_495.y = 0;
               this.var_495.z = 0;
               this.var_742 = _loc4_.getScreenPoint(this.var_495);
               this.var_1140 = _loc4_.scale - 10;
            }
            _loc6_ = "";
            _loc7_ = null;
            this.var_495.x = 0;
            this.var_495.y = 0;
            this.var_495.z = 0;
            _loc8_ = _loc4_.getScreenPoint(this.var_495);
            if(_loc8_ != null)
            {
               ...
               if(_loc8_.x != this.var_742.x || _loc8_.y != this.var_742.y)
               {
                  _loc10_ = PointMath.sub(_loc8_,PointMath.mul(this.var_742,_loc5_));
