package com.sulake.habbo.ui
{
   ...
   public class FriendRequestWidgetHandler implements IRoomWidgetHandler
   {
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomWidgetGetUserLocationMessage.const_558);
         _loc1_.push(RoomWidgetFriendRequestMessage.const_576);
         _loc1_.push(RoomWidgetFriendRequestMessage.const_776);
         return _loc1_;
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetGetUserLocationMessage.const_558:
            ...
            case RoomWidgetFriendRequestMessage.const_576:
               ...
               break;
            case RoomWidgetFriendRequestMessage.const_776:
      ...
      public function getProcessedEvents() : Array
      {
         ...
         _loc1_.push(FriendRequestEvent.const_42);
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case RoomSessionFriendRequestEvent.const_134:
               ...
               break;
            case FriendRequestEvent.const_42:
