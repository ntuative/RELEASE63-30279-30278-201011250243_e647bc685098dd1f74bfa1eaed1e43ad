package com.sulake.habbo.ui
{
   ...
   public class InfoStandWidgetHandler implements IRoomWidgetHandler
   {
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomWidgetRoomObjectMessage.const_329);
         ...
         _loc1_.push(RoomWidgetFurniActionMessage.const_303);
         _loc1_.push(RoomWidgetFurniActionMessage.const_711);
         _loc1_.push(RoomWidgetFurniActionMessage.const_572);
         _loc1_.push(RoomWidgetRoomTagSearchMessage.const_581);
         _loc1_.push(RoomWidgetGetBadgeDetailsMessage.const_786);
         ...
         _loc1_.push(RoomWidgetUserActionMessage.const_1277);
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         if(_loc4_ != null)
         {
            ...
            if(_loc4_.type == RoomWidgetUserActionMessage.const_435)
            {
               _loc3_ = this._container.roomSession.userDataManager.getUserDataByIndex(_loc2_);
            }
            else if(param1.type == RoomWidgetUserActionMessage.const_373 || param1.type == RoomWidgetUserActionMessage.const_533 || param1.type == RoomWidgetUserActionMessage.const_485)
            {
         ...
         switch(param1.type)
         {
            case RoomWidgetRoomObjectMessage.const_329:
            ...
            case RoomWidgetUserActionMessage.const_737:
               _loc8_ = new RoomWidgetChatInputContentUpdateEvent(RoomWidgetChatInputContentUpdateEvent.const_883,_loc3_.name);
            ...
            case RoomWidgetUserActionMessage.const_373:
               ...
               break;
            case RoomWidgetRoomTagSearchMessage.const_581:
               ...
               break;
            case RoomWidgetGetBadgeDetailsMessage.const_786:
            ...
            case RoomWidgetPetCommandMessage.const_765:
               ...
               this._container.roomSession.method_19(_loc12_.petId);
               break;
      ...
      private function handleGetObjectInfoMessage(param1:RoomWidgetRoomObjectMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.category)
         {
            ...
            case RoomObjectCategoryEnum.const_27:
               ...
               _loc6_ = new RoomWidgetFurniInfoUpdateEvent(RoomWidgetFurniInfoUpdateEvent.const_772);
               _loc6_.id = param1.id;
               ...
               {
                  _loc22_ = _loc7_.getModel().getNumber(RoomObjectVariableEnum.const_368);
               ...
               _loc9_ = _loc7_.getModel().getNumber(RoomObjectVariableEnum.const_1093);
            ...
            case RoomObjectCategoryEnum.const_33:
               ...
               if(_loc11_.type == RoomObjectTypeEnum.const_239)
               {
                  this._container.roomSession.userDataManager.requestPetInfo(_loc11_.webID);
                  return null;
               }
               if(_loc11_.type == RoomObjectTypeEnum.const_378)
               {
                  _loc12_ = "null";
               ...
               {
                  if(_loc11_.type != RoomObjectTypeEnum.const_879)
                  {
                     return null;
                  }
                  _loc12_ = "null";
               ...
               if(_loc16_ != null)
               {
                  _loc13_.carryItem = _loc16_.getModel().getNumber(RoomObjectVariableEnum.const_411);
               }
               if(_loc12_ == RoomWidgetUserInfoUpdateEvent.const_244)
               {
               ...
               if(_loc12_ == RoomWidgetUserInfoUpdateEvent.const_220)
               {
                  ...
                  if(_loc16_ != null)
                  {
                     _loc30_ = _loc16_.getModel().getString(RoomObjectVariableEnum.const_756);
                  ...
                  _loc13_.method_4 = this._container.sessionDataManager.method_4(_loc11_.name);
                  ...
                  _loc13_.canTradeReason = RoomWidgetUserInfoUpdateEvent.const_1300;
                  if(!_loc25_)
                  {
                  ...
                  if(!_loc26_)
                  {
                     _loc13_.canTradeReason = RoomWidgetUserInfoUpdateEvent.const_881;
                  }
                  if(!_loc27_)
                  {
                     _loc13_.canTradeReason = RoomWidgetUserInfoUpdateEvent.const_905;
                  }
               ...
               if(_loc12_ == RoomWidgetUserInfoUpdateEvent.BOT)
               {
                  ...
                  _loc14_.push(RoomWidgetUserInfoUpdateEvent.const_1349);
               }
               else
               {
      ...
      private function onPetInfo(param1:RoomSessionPetInfoUpdateEvent) : void
      {
         ...
         if(this._container != null && this._container.events != null)
         {
            ...
            if(_loc13_ != null)
            {
               ...
               if(_loc14_ != null)
               {
                  _loc15_ = _loc14_.getModel().getString(RoomObjectVariableEnum.const_756);
