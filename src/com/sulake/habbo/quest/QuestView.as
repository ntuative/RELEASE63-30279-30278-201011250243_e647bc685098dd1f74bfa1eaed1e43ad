package com.sulake.habbo.quest
{
   ...
   public class QuestView implements IGetImageListener, IDisposable
   {
      ...
      private var var_2492:IScrollableListWindow;
      ...
      private function createView() : void
      {
         switch(this.var_109.type)
         {
            ...
            case QuestTypeEnum.FIND_HIDDEN_STUFF:
               ...
               this.var_2492 = this.find("quest.content.itemlist") as IScrollableListWindow;
               if(!this._view)
               {
      ...
      public function onActivateQuest(param1:Event, param2:IWindow = null) : void
      {
         if(this.var_109)
         {
            this.var_68.controller.activateQuest(this.var_109);
         }
      }
      ...
      private function localize() : void
      {
         ...
         var _loc33_:* = null;
         var _loc34_:* = null;
         var _loc1_:String = ["quest",this.var_68.id,this.var_109.localizationCode].join("_");
         var _loc2_:String = ["quest_" + this.var_68.id,"type_" + this.var_109.type.toLowerCase()].join(".");
         ...
         {
            _loc32_ = this.var_68.controller.questEngine.sessionDataManager.getFloorItemDataByName(this.var_109.roomItemTypeName);
            if(_loc32_)
            {
               _loc33_ = this.var_68.controller.questEngine.roomEngine.getFurnitureImage(_loc32_.id,new Vector3d(90,0,0),64,this,"");
               this.var_1764 = _loc33_.id;
         ...
         this.var_68.controller.questEngine.localization.registerParameter(_loc14_,"amount",this.var_109.rewardCurrencyAmount.toString());
         ...
         var _loc31_:String = "icon_" + this.var_68.id + "_reward_" + this.var_109.rewardCurrencyAmount;
