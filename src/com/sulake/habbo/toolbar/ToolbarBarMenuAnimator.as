package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarBarMenuAnimator
   {
      ...
      private static const const_1129:Number = 25;
      
      private static const const_1192:Number = 90;
      
      private static const const_811:int = 50;
      ...
      private var var_1193:ToolbarView;
      ...
      public function ToolbarBarMenuAnimator(param1:IHabboWindowManager, param2:ToolbarView)
      {
         ...
         this.var_627 = new Timer(const_1129);
         this.var_627.addEventListener(TimerEvent.TIMER,this.animationUpdate);
      }
      ...
      public function refresh() : void
      {
         ...
         {
            this.repositionWindow(this.var_292[_loc1_],true);
            _loc1_++;
         }
      }
      ...
      {
         return param1.x + param1.width < const_811 + this._toolbarSize || param1.y < 0 || param1.desktop.width - param1.x < const_811 || param1.desktop.height - param1.y < const_1128;
      }
      ...
      private function createItemObject(param1:String, param2:ToolbarIcon) : MenuAnimatorItem
      {
         ...
         if(_loc3_ == null)
         {
            ...
            _loc4_ = this.var_1193.getIconByMenuId(param1);
            if(_loc4_ == null)
            {
               return null;
            }
            ...
            this.var_292.push(_loc3_.menuId);
         }
         return _loc3_;
      }
      ...
      {
         var _loc2_:Point = this.var_1193.getIconLoc(param1.iconId);
      ...
      {
         return this.var_516[this.var_517.indexOf(param1)];
      }
      
      private function getWindowMenuId(param1:String) : String
      {
         return this.var_517[this.var_516.indexOf(param1)];
      }
      ...
      private function registerWindow(param1:IWindowContainer, param2:String) : void
      {
         ...
         if(_loc3_ > -1)
         {
            ...
            this.var_516.splice(_loc3_,1);
         }
         this.var_516.push(param1.name);
         this.var_517.push(param2);
         param1.addEventListener(WindowEvent.const_325,this.windowEventListener);
         param1.addEventListener(WindowEvent.const_228,this.windowEventListener);
      }
      ...
      public function removeItem(param1:String) : void
      {
         if(this.var_292.indexOf(param1) > -1)
         {
            ...
            else
            {
               ...
               this.var_292.splice(this.var_292.indexOf(param1),1);
            }
         }
      }
      ...
      public function windowEventListener(param1:WindowEvent) : void
      {
         ...
         var _loc4_:int = 0;
         var _loc2_:int = 0;
         while(_loc2_ < this.var_516.length)
         {
            if(this.var_516[_loc2_] == param1.window.name)
            {
      ...
      private function animationUpdate(param1:TimerEvent) : void
      {
         ...
         var _loc7_:int = 0;
         while(_loc7_ < this.var_292.length)
         {
            _loc2_ = this._itemList[this.var_292[_loc7_]];
            if(_loc2_.active)
            {
