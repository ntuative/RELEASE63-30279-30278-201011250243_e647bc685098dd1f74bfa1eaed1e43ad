package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarIconGroup
   {
      ...
      private var var_515:ToolbarBarMenuAnimator;
      ...
      private var var_1935:int = 5;
      
      private var var_2387:int;
      
      private var var_142:Number;
      
      private var var_2388:XML;
      ...
      {
         return this.var_1345.indexOf(param1) > -1;
      }
      ...
      public function getMenuYieldList(param1:String) : Array
      {
         ...
         var _loc3_:XMLList = this.var_2388.elements("menu");
         var _loc5_:int = 0;
      ...
      public function get size() : Number
      {
         ...
         {
            if(this.var_275[_loc2_].exists)
            {
               _loc1_ += this.var_1344;
            }
            _loc2_++;
         }
         return _loc1_;
      ...
      private function alignItems() : void
      {
         ...
         var _loc3_:* = 0;
         var _loc4_:int = 0;
         while(_loc4_ < this.var_1346.length)
         {
            _loc2_ = this.var_707.indexOf(this.var_1346[_loc4_]);
            if(_loc2_ > -1)
            {
               _loc1_ = this.var_275[_loc2_];
               if(_loc1_.exists)
               {
                  _loc1_.changePosition(this.var_1107 + _loc3_);
                  _loc3_ += this.var_1344;
               }
            }
            _loc4_++;
         }
      ...
      public function getIconById(param1:String) : ToolbarIcon
      {
         ...
         return this.var_275[this.var_707.indexOf(param1)];
      }
      ...
      private function createIconObject(param1:String) : ToolbarIcon
      {
         ...
         _loc2_ = new ToolbarIcon(this,this._windowManager,this._assetLibrary,param1,this._events,this.var_515);
         this.var_34.addChild(_loc2_.window);
         this.var_707.push(param1);
         this.var_275.push(_loc2_);
         return _loc2_;
      }
   }
}
