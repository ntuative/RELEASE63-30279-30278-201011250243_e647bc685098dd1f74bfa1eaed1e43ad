package com.sulake.habbo.widget.infostand
{
   ...
   public class InfoStandUserView
   {
      ...
      protected function createWindow(param1:String, param2:Boolean) : void
      {
         ...
         var _loc6_:IBitmapWrapperWindow = this.var_203.findChildByName("home_icon") as IBitmapWrapperWindow;
         ...
         var _loc7_:IWindow = this.var_203.findChildByTag("close");
         if(_loc7_ != null)
         {
         ...
         while(_loc8_ < 5)
         {
            _loc10_ = this.var_203.findChildByName("badge_" + _loc8_);
            if(_loc10_ != null)
            {
         ...
         _loc10_ = this.var_203.findChildByName("badge_group");
      ...
      protected function updateButtons(param1:RoomWidgetUserInfoUpdateEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetUserInfoUpdateEvent.const_244:
            ...
            case RoomWidgetUserInfoUpdateEvent.const_220:
               ...
               this.updateIgnoreButton(param1.method_4);
      ...
      protected function setTradeButtonTooltip(param1:int) : void
      {
         ...
         switch(param1)
         {
            case RoomWidgetUserInfoUpdateEvent.TRADE_REASON_NO_OWN_RIGHT:
               ...
               break;
            case RoomWidgetUserInfoUpdateEvent.const_881:
