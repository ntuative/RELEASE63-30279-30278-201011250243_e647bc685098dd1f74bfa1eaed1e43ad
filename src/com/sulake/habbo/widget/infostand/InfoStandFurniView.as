package com.sulake.habbo.widget.infostand
{
   ...
   public class InfoStandFurniView
   {
      ...
      private function createWindow(param1:String) : void
      {
         ...
         this.var_895 = this.var_203.findChildByTag("catalog");
         if(this.var_895 != null)
         {
            this.var_895.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onCatalogButtonClicked);
         }
      }
      ...
      private function showCatalogButton(param1:Boolean) : void
      {
         if(param1)
         {
            ...
            {
               this.var_49.addListItem(this.var_895);
            }
            this.var_895.visible = param1;
         }
         else
         {
            this.var_49.removeListItem(this.var_895);
         }
      }
   }
}
