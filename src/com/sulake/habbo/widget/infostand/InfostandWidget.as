package com.sulake.habbo.widget.infostand
{
   ...
   public class InfostandWidget extends RoomWidgetBase
   {
      ...
      private var var_1322:InfostandUserData;
      
      private var var_471:InfostandFurniData;
      
      private var var_1364:InfoStandPetData;
      ...
      private const const_1792:int = 3000;
      ...
      public function InfostandWidget(param1:IHabboWindowManager, param2:IAssetLibrary, param3:IHabboLocalizationManager, param4:IHabboConfigurationManager, param5:IHabboCatalog)
      {
         ...
         this.var_1080 = new InfoStandFurniView(this,this.const_1533,this._catalog);
         this.var_163 = new InfoStandUserView(this,this.const_1534);
         this.var_325 = new InfoStandPetView(this,this.const_1532);
         this.var_387 = new InfoStandBotView(this,this.const_1531);
         this.var_1322 = new InfostandUserData();
         this.var_471 = new InfostandFurniData();
         this.var_1364 = new InfoStandPetData();
         this.var_141 = new Timer(this.const_1792);
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetRoomObjectUpdateEvent.const_343,this.onRoomObjectSelected);
         param1.addEventListener(RoomWidgetRoomObjectUpdateEvent.const_254,this.onClose);
         ...
         param1.addEventListener(RoomWidgetFurniInfoUpdateEvent.const_772,this.onFurniInfo);
         ...
         param1.addEventListener(RoomWidgetBadgeImageUpdateEvent.const_716,this.onBadgeImage);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetRoomObjectUpdateEvent.const_343,this.onRoomObjectSelected);
         param1.removeEventListener(RoomWidgetRoomObjectUpdateEvent.const_254,this.onClose);
         ...
         param1.removeEventListener(RoomWidgetFurniInfoUpdateEvent.const_772,this.onFurniInfo);
         ...
         param1.removeEventListener(RoomWidgetBadgeImageUpdateEvent.const_716,this.onBadgeImage);
      ...
      private function onUpdateTimer(param1:TimerEvent) : void
      {
         ...
         messageListener.processWidgetMessage(new RoomWidgetUserActionMessage(RoomWidgetUserActionMessage.const_373,this.var_325.getCurrentPetId()));
      }
      ...
      private function onUserTags(param1:RoomWidgetUserTagsUpdateEvent) : void
      {
         ...
         {
            this.var_163.setTags(param1.tags,this.var_2326);
         }
      }
