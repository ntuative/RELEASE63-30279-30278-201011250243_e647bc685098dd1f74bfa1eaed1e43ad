package com.sulake.habbo.widget.infostand
{
   ...
   public class InfoStandPetView
   {
      ...
      private const const_1805:int = 158;
      
      private const const_1801:int = 16;
      
      private const const_1799:uint = 11184810;
      
      private const const_1800:uint = 6710886;
      
      private const const_1803:uint = 3355443;
      
      private const const_1807:String = "level";
      
      private const const_1802:String = "experience";
      
      private const const_1806:String = "energy";
      
      private const const_1804:String = "nutrition";
      ...
      {
         if(this.var_49 == null || this.var_203 == null || this.var_61 == null)
         {
            return;
         }
         ...
         this.var_203.height = this.var_49.height + 20;
         this._window.width = Math.max(this.var_203.width,this.var_61.width);
         this._window.height = this._window.scrollableRegion.height;
         if(this.var_203.width < this.var_61.width)
         {
      ...
      public function update(param1:InfoStandPetData) : void
      {
         ...
         this.updateStateElement(this.const_1807,param1.level,param1.levelMax);
         this.updateStateElement(this.const_1802,param1.experience,param1.experienceMax);
         this.updateStateElement(this.const_1806,param1.energy,param1.energyMax);
         this.updateStateElement(this.const_1804,param1.nutrition,param1.nutritionMax);
         ...
         this.updateWindow();
         this.var_537 = param1.id;
         this.var_1364.remove(param1.id);
         this.var_1364.add(param1.id,param1);
      ...
      private function createPercentageBar(param1:int, param2:int) : BitmapData
      {
         ...
         var _loc5_:BitmapData = new BitmapData(this.const_1805,this.const_1801,false);
         _loc5_.fillRect(new Rectangle(0,0,_loc5_.width,_loc5_.height),this.const_1799);
         var _loc6_:Rectangle = new Rectangle(1,1,_loc5_.width - 2,_loc5_.height - 2);
         _loc5_.fillRect(_loc6_,this.const_1803);
         var _loc7_:Rectangle = new Rectangle(1,1,_loc5_.width - 2,_loc5_.height - 2);
         _loc7_.width = _loc3_ * _loc7_.width;
         _loc5_.fillRect(_loc7_,this.const_1800);
         return _loc5_;
      }
      ...
      private function openTrainView() : void
      {
         ...
         var _loc1_:InfoStandPetData = this.var_1364.getValue(this.var_537) as InfoStandPetData;
         if(_loc1_ != null)
         {
      ...
      private function createWindow(param1:String) : void
      {
         ...
         {
            this.var_49 = this.var_203.findChildByName("infostand_element_list") as IItemListWindow;
         }
      ...
      protected function onButtonClicked(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc4_.name)
         {
            case "btn_pick":
               _loc3_ = "null";
               if(this.var_184 && this.var_184.getPetId() == this.var_537)
               {
            ...
            case "btn_petrespect":
               ...
               break;
            case "btn_kick":
               _loc2_ = new RoomWidgetUserActionMessage(RoomWidgetUserActionMessage.const_415,this._widget.petData.ownerId);
