package com.sulake.habbo.widget.roomchat
{
   ...
   public class RoomChatHistoryPulldown
   {
      ...
      private static const const_851:int = 150;
      
      private static const const_852:int = 250;
      ...
      private var var_2320:BitmapData;
      ...
      public function RoomChatHistoryPulldown(param1:RoomChatWidget, param2:IHabboWindowManager, param3:IWindowContainer, param4:IAssetLibrary)
      {
         ...
         this.var_34 = param3;
         this.var_2320 = (this._assetLibrary.getAssetByName("chat_grapbar_bg") as BitmapDataAsset).content as BitmapData;
         this.var_1678 = (this._assetLibrary.getAssetByName("chat_grapbar_grip") as BitmapDataAsset).content as BitmapData;
         this.var_2319 = (this._assetLibrary.getAssetByName("chat_grapbar_handle") as BitmapDataAsset).content as BitmapData;
         this.var_1680 = (this._assetLibrary.getAssetByName("chat_grapbar_x") as BitmapDataAsset).content as BitmapData;
         this.var_1679 = (this._assetLibrary.getAssetByName("chat_grapbar_x_hi") as BitmapDataAsset).content as BitmapData;
         this.var_2318 = (this._assetLibrary.getAssetByName("chat_grapbar_x_pr") as BitmapDataAsset).content as BitmapData;
         this.var_2321 = (this._assetLibrary.getAssetByName("chat_history_bg") as BitmapDataAsset).content as BitmapData;
         this.var_67 = this._windowManager.createWindow("chat_history_bg","",HabboWindowType.const_295,HabboWindowStyle.const_35,HabboWindowParam.const_59,new Rectangle(0,0,param3.width,param3.height - const_79),null,0,0) as IBitmapWrapperWindow;
         ...
         this._region = this._windowManager.createWindow("REGIONchat_pulldown","",WindowType.const_577,HabboWindowStyle.const_38,0 | 0 | 0 | 0,new Rectangle(0,0,param3.width,param3.height - const_79),null,0) as IRegionWindow;
      ...
      public function update(param1:uint) : void
      {
         ...
         {
            case const_466:
               this.var_67.blend += param1 / const_852;
               this._window.blend += param1 / const_852;
               if(this._window.blend >= 1)
               {
                  this.state = const_354;
               }
               break;
            case const_847:
      ...
      public function containerResized(param1:Rectangle) : void
      {
         ...
         if(this._region != null)
         {
            ...
            this._region.width = this.var_34.width - this.var_2322;
         }
         if(this.var_67 != null)
         {
      ...
      private function buildWindowGraphics() : void
      {
         ...
         if(this.var_2317 == this._window.width)
         {
            return;
         }
         this.var_2317 = this._window.width;
         ...
         {
            _loc5_.bitmap = this.var_2319;
            _loc5_.disposesBitmap = false;
            _loc2_.bitmap = this.var_1680;
            _loc2_.disposesBitmap = false;
            this.var_2322 = this._window.width - _loc2_.x;
         }
         ...
         if(_loc1_ != null && _loc3_ != null && _loc4_ != null)
         {
            if(_loc1_.width > 0 && _loc1_.height > 0)
            {
               ...
               this.tileBitmapHorz(this.var_2320,_loc7_);
            ...
            if(_loc3_.width > 0 && _loc3_.height > 0)
            {
               ...
               this.tileBitmapHorz(this.var_1678,_loc8_);
            ...
            if(_loc4_.width > 0 && _loc4_.height > 0)
            {
               ...
               this.tileBitmapHorz(this.var_1678,_loc9_);
         ...
         this.var_67.bitmap = this.var_2321;
