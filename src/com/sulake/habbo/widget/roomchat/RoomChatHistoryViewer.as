package com.sulake.habbo.widget.roomchat
{
   ...
   public class RoomChatHistoryViewer implements IDisposable
   {
      ...
      private static const const_1118:int = 18;
      
      private static const SCROLLBAR_WIDTH:int = 20;
      
      public static const const_1069:int = 3;
      ...
      public function RoomChatHistoryViewer(param1:RoomChatWidget, param2:IHabboWindowManager, param3:IWindowContainer, param4:IAssetLibrary)
      {
         ...
         this.var_153.state = RoomChatHistoryPulldown.const_208;
         ...
         this.var_42 = param2.createWindow("chatscroller","",HabboWindowType.const_931,HabboWindowStyle.const_38,0 | 0,new Rectangle(param3.rectangle.right - SCROLLBAR_WIDTH,param3.y,SCROLLBAR_WIDTH,param3.height - 0),null,0) as IScrollbarWindow;
      ...
      public function set visible(param1:Boolean) : void
      {
         ...
         this.var_153.state = param1 == true ? 0 : int(RoomChatHistoryPulldown.const_208);
      }
      ...
      {
         return !!this.var_347 ? Number(SCROLLBAR_WIDTH) : Number(0);
      }
      ...
      public function get visible() : Boolean
      {
         ...
         return this.var_153.state == RoomChatHistoryPulldown.const_354 || this.var_153.state == RoomChatHistoryPulldown.const_466;
      }
      ...
      {
         if(!this.var_347 && !this.var_1820)
         {
            this.var_347 = true;
            this.setHistoryViewerScrollbar(true);
            this.var_153.state = RoomChatHistoryPulldown.const_354;
            if(this._widget != null)
            {
      ...
      public function containerResized(param1:Rectangle, param2:Boolean = false) : void
      {
         if(this.var_42 != null)
         {
            ...
            if(param2)
            {
               this.var_42.scrollV = this.var_514;
            }
         }
         if(this.var_153 != null)
         {
      ...
      private function processDrag(param1:Number, param2:Boolean = false) : void
      {
         ...
         if(this.var_348 > 0 && param2)
         {
            if(this.var_1432)
            {
               if(Math.abs(param1 - this.var_348) <= const_1069)
               {
                  return;
               }
               this.var_1432 = false;
            ...
            if(this.var_347)
            {
               ...
               _loc5_ = (param1 - this.var_348) / this.var_42.height;
               _loc3_ = this.var_514 - _loc5_ / _loc4_;
               _loc3_ = Math.max(0,_loc3_);
               _loc3_ = Math.min(1,_loc3_);
               _loc6_ = param1 - this.var_348;
               _loc7_ = true;
               _loc8_ = true;
               if(this.var_42.scrollV < 1 - const_1118 / this.var_42.scrollable.scrollableRegion.height)
               {
                  _loc8_ = false;
               }
               if(_loc8_ || this.var_1433)
               {
      ...
      public function beginDrag(param1:Number, param2:Boolean = false) : void
      {
         ...
         if(this.var_42 != null)
         {
            this.var_514 = this.var_42.scrollV;
         }
         if(this.var_42 != null)
         {
      ...
      private function moveHistoryScroll() : void
      {
         ...
         var _loc1_:Number = this.var_514 - this.var_42.scrollV;
         if(_loc1_ == 0)
         {
            return;
         }
