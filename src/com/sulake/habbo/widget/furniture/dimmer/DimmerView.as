package com.sulake.habbo.widget.furniture.dimmer
{
   ...
   public class DimmerView
   {
      ...
      private var var_545:DimmerViewColorGrid;
      
      private var var_370:DimmerViewAlphaSlider;
      ...
      private function createWindow() : void
      {
         ...
         this._window = this._widget.windowManager.createWindow("dimmerui_container","",HabboWindowType.const_58,HabboWindowStyle.const_35,0 | 0,new Rectangle(const_1121,const_1122,2,2),null,0) as IWindowContainer;
         ...
         if(_loc1_ != null)
         {
            ...
            if(_loc5_ != null)
            {
               this.var_545 = new DimmerViewColorGrid(this,_loc5_ as IItemGridWindow,this._widget.windowManager,this._widget.assets);
            }
         }
         _loc1_ = this._window.findChildByName("brightness_container");
         if(_loc1_ != null)
         {
            this.var_370 = new DimmerViewAlphaSlider(this,_loc1_ as IWindowContainer,this._widget.assets);
         }
      ...
      private function selectPreset(param1:int) : void
      {
         ...
         this.var_1239 = _loc2_.light;
         if(this.var_370 != null)
         {
            this.var_370.method_1(this.var_1239);
         }
         this.var_438 = this.colors.indexOf(_loc2_.color);
         if(this.var_545 != null)
         {
            this.var_545.setSelectedColorIndex(this.var_438);
         }
      ...
      private function get windowXML() : XML
      {
         ...
         this.var_1240 = XML(_loc1_.content);
         return this.var_1240;
      }
      ...
      public function set selectedType(param1:int) : void
      {
         ...
         if(this.var_370 != null)
         {
            this.var_370.min = this._widget.minLights[param1 - 1];
         }
      }
      ...
      public function set selectedColorIndex(param1:int) : void
      {
         ...
         if(this.var_545 != null)
         {
            this.var_545.setSelectedColorIndex(param1);
         }
         this._widget.previewCurrentSetting();
      }
