      ...
      private function onButtonClicked(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc3_)
         {
            case "dance":
               ...
               this._widget.changeView(MeMenuWidget.const_1002);
               break;
            case "wave":
               if(this._widget.hasEffectOn)
               {
               ...
               if(this._widget.isDancing)
               {
                  this._widget.messageListener.processWidgetMessage(new RoomWidgetDanceMessage(RoomWidgetDanceMessage.const_920));
            ...
            case "effects":
               ...
               this._widget.changeView(MeMenuWidget.const_611);
               break;
            case "rooms":
            ...
            case "badges":
               ...
               break;
            case "clothes":
               this._widget.changeView(MeMenuWidget.const_289);
               break;
            case "hc":
               this._widget.messageListener.processWidgetMessage(new RoomWidgetOpenCatalogMessage(RoomWidgetOpenCatalogMessage.const_885));
               this._widget.hide();
               break;
            case "settings":
