package com.sulake.habbo.widget.chatinput
{
   ...
   public class RoomChatInputView
   {
      ...
      private static const const_540:int = 10;
      
      private static const const_809:int = 16;
      
      private static const const_1117:int = 40;
      
      private static const const_1509:int = 5;
      ...
      private var var_485:Number = 600;
      ...
      public function RoomChatInputView(param1:RoomChatInputWidget, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IHabboLocalizationManager)
      {
         ...
         this.var_935 = this._localization.getKey("widgets.chatinput.mode.whisper",":tell");
         this.var_1900 = this._localization.getKey("widgets.chatinput.mode.shout",":shout");
         this._chatModeIdSpeak = this._localization.getKey("widgets.chatinput.mode.speak",":speak");
         this.var_768 = new Timer(1000,1);
         this.var_768.addEventListener(TimerEvent.TIMER_COMPLETE,this.onTypingTimerComplete);
         this.var_934 = new Timer(5000,1);
         this.var_934.addEventListener(TimerEvent.TIMER_COMPLETE,this.onIdleTimerComplete);
         this.createWindow();
         this.refreshView();
      }
      ...
      private function createWindow() : void
      {
         ...
         _loc4_.addEventListener(WindowKeyboardEvent.const_149,this.windowKeyEventProcessor);
         ...
         this._window.addEventListener(WindowEvent.const_325,this.onWindowMoved);
         this.var_1428 = true;
         this.var_414 = "";
      }
      ...
      private function refreshView() : void
      {
         ...
         var _loc12_:* = 0;
         var _loc13_:* = 0;
         this.var_1899 = _loc2_.width + const_809 + _loc6_.width + const_1116;
         if(_loc7_ != null)
         {
         ...
         if(_loc8_ != null)
         {
            _loc13_ = Number(Math.max(const_1117,_loc8_.width) + const_809);
            _loc8_.x = _loc12_;
      ...
      {
         this.var_485 = param1 - this.var_1899;
         ...
         {
            _loc3_ = Math.min(int(_loc2_.textWidth),this.var_485);
         }
         else
         {
            _loc3_ = Math.min(_loc3_,this.var_485);
         }
      ...
      private function windowKeyEventProcessor(param1:Event = null, param2:IWindow = null) : void
      {
         ...
         if(_loc4_ == Keyboard.BACKSPACE)
         {
            ...
            if(_loc8_ != null)
            {
               ...
               if(_loc10_[0] == this.var_935 && _loc10_.length == 3 && _loc10_[2] == "")
               {
                  _loc8_.text = "";
                  this.var_414 = "";
               }
      ...
      private function onInputChanged(param1:WindowEvent) : void
      {
         ...
         {
            if(!this._widget.allowPaste && _loc2_.text.length > this.var_414.length + 1)
            {
               _loc2_.text = "";
            }
            this.var_414 = _loc2_.text;
            if(!this.var_767)
            {
               this.var_767 = true;
               this.var_768.reset();
      ...
      private function sendTypingMessage() : void
      {
         ...
         var _loc1_:RoomWidgetChatTypingMessage = new RoomWidgetChatTypingMessage(this.var_767);
      ...
      private function checkInputFieldLimits() : void
      {
         ...
         if(_loc1_.textWidth >= this.var_485)
         {
