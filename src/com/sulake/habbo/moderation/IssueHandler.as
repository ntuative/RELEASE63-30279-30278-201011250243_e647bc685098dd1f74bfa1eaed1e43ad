package com.sulake.habbo.moderation
{
   ...
   public class IssueHandler implements TrackedWindow
   {
      ...
      private var var_429:UserInfoCtrl;
      ...
      private function createView() : void
      {
         ...
         this.var_429 = new UserInfoCtrl(this._window,this.var_58,_loc3_.message);
         this.var_968 = new UserInfoCtrl(this._window,this.var_58,_loc3_.message);
         this.var_429.load(IWindowContainer(this._window.findChildByName("caller_user_info")),this.var_115.getHighestPriorityIssue().reporterUserId);
         ...
         {
            this.var_968.load(_loc4_,this.var_115.reportedUserId);
         }
         else
         {
      ...
      {
         if(this.var_58 != null && this.var_58.issueManager != null && this.var_115 != null)
         {
            this.var_58.issueManager.removeHandler(this.var_115.id);
         }
         this.dispose();
      }
      ...
      private function onCloseUseless(param1:WindowMouseEvent) : void
      {
         ...
         this.var_58.issueManager.closeBundle(this.var_115.id,1);
      ...
      private function onCloseAbusive(param1:WindowMouseEvent) : void
      {
         ...
         this.var_58.issueManager.closeBundle(this.var_115.id,2);
         this.checkAutoHandling();
         this.dispose();
      }
      ...
      private function onCloseResolved(param1:WindowMouseEvent) : void
      {
         ...
         this.var_58.issueManager.closeBundle(this.var_115.id,3);
         this.checkAutoHandling();
         this.dispose();
      }
      ...
      private function onRelease(param1:WindowMouseEvent) : void
      {
         ...
         this.var_58.issueManager.releaseBundle(this.var_115.id);
         this.checkAutoHandling();
         this.dispose();
      }
      ...
      private function onShowChatlog(param1:WindowMouseEvent) : void
      {
         ...
         this.var_58.windowTracker.show(new ChatlogCtrl(new GetCfhChatlogMessageComposer(_loc2_),this.var_58,WindowTracker.const_898,_loc2_),this._window,false,false,true);
      }
      ...
      private function onReporterClicked(param1:WindowMouseEvent) : void
      {
         ...
         if(_loc2_ != 0)
         {
            ...
            this.var_429 = new UserInfoCtrl(this._window,this.var_58,_loc3_.message);
            this.var_429.load(IWindowContainer(this._window.findChildByName("caller_user_info")),_loc2_);
         }
      }
