package com.sulake.habbo.moderation
{
   ...
   public class ModerationMessageHandler
   {
      ...
      public function ModerationMessageHandler(param1:ModerationManager)
      {
         ...
         this._connection.addMessageEvent(new IssueDeletedMessageEvent(this.method_15));
      ...
      private function method_15(param1:IssueDeletedMessageEvent) : void
      {
         if(param1 == null || this.var_58 == null)
         {
            return;
      ...
      private function onCfhChatlog(param1:CfhChatlogEvent) : void
      {
         ...
         this.onChatlog("Call For Help Chatlog: " + _loc2_.data.chatRecordId,WindowTracker.const_898,_loc2_.data.callId,_loc3_,_loc4_);
      }
      ...
      private function onRoomChatlog(param1:RoomChatlogEvent) : void
      {
         ...
         var _loc4_:Dictionary = new Dictionary();
         this.onChatlog("Room Chatlog: " + _loc2_.data.roomName,WindowTracker.const_578,_loc2_.data.roomId,_loc3_,_loc4_);
      }
      ...
      private function onUserChatlog(param1:UserChatlogEvent) : void
      {
         ...
         this.onChatlog("User Chatlog: " + _loc2_.data.userName,WindowTracker.const_938,_loc2_.data.userId,_loc2_.data.rooms,_loc3_);
      }
      
      private function onChatlog(param1:String, param2:int, param3:int, param4:Array, param5:Dictionary) : void
      {
         var _loc6_:* = null;
         for each(_loc6_ in this.var_1114)
         {
      ...
      private function onRoomEnter(param1:RoomEntryInfoMessageEvent) : void
      {
         ...
         for each(_loc3_ in this.var_896)
         {
            _loc3_.onRoomChange();
         }
      }
      ...
      private function onRoomExit(param1:CloseConnectionMessageEvent) : void
      {
         ...
         for each(_loc2_ in this.var_896)
         {
            _loc2_.onRoomChange();
         }
      }
