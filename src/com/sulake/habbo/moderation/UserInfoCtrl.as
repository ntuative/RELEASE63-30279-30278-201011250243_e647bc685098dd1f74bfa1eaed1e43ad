package com.sulake.habbo.moderation
{
   ...
   public class UserInfoCtrl implements IDisposable
   {
      ...
      private static const const_860:int = 60;
      
      private static const const_861:int = 3600;
      
      private static const const_863:int = 86400;
      
      private static const const_862:int = 31536000;
      ...
      {
         if(param1 < 2 * const_860)
         {
            return param1 + " secs ago";
         }
         if(param1 < 2 * const_861)
         {
            return Math.round(param1 / const_860) + " mins ago";
         }
         if(param1 < 2 * const_863)
         {
            return Math.round(param1 / const_861) + " hours ago";
         }
         if(param1 < 2 * const_862)
         {
            return Math.round(param1 / const_863) + " days ago";
         }
         return Math.round(param1 / const_862) + " years ago";
      }
      ...
      {
         var _loc1_:IWindowContainer = IWindowContainer(this.var_1108.findChildByName("user_info"));
         if(_loc1_ == null)
         {
            _loc1_ = IWindowContainer(this.var_44.getXmlWindow("user_info"));
            this.var_1108.addChild(_loc1_);
      ...
      private function onChatlogButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_44.windowTracker.show(new ChatlogCtrl(new GetUserChatlogMessageComposer(this._data.userId),this.var_44,WindowTracker.const_938,this._data.userId),this._callerFrame,this.var_1109,false,true);
      }
      ...
      private function onRoomVisitsButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_44.windowTracker.show(new RoomVisitsCtrl(this.var_44,this._data.userId),this._callerFrame,this.var_1109,false,true);
      }
      ...
      private function onMessageButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_44.windowTracker.show(new SendMsgsCtrl(this.var_44,this._data.userId,this._data.userName,this.var_1379),this._callerFrame,this.var_1109,false,true);
      }
      ...
      private function onModActionButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_44.windowTracker.show(new ModActionCtrl(this.var_44,this._data.userId,this._data.userName,this.var_1379),this._callerFrame,this.var_1109,false,true);
      }
