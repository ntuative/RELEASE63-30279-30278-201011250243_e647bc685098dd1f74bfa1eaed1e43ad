package com.sulake.habbo.moderation
{
   ...
   public class IssueBrowser
   {
      ...
      private const const_1796:String = "my_issues";
      
      private const const_1797:String = "open_issues";
      
      private const const_1795:String = "picked_issues";
      
      private const const_1814:String = "closed_issues";
      ...
      private var var_333:IIssueBrowserView;
      
      private var var_1719:IIssueBrowserView;
      
      private var var_1718:IIssueBrowserView;
      
      private var var_1720:PickedIssuesView;
      ...
      private function selectView(param1:String) : void
      {
         ...
         if(this.var_333 == _loc2_)
         {
            return;
         }
         if(this.var_333 != null)
         {
            this.var_333.visible = false;
         }
         this.var_333 = _loc2_;
         if(this.var_333 == null)
         {
         ...
         this.var_333.view.width = this.var_242.container.width;
         this.var_333.view.height = this.var_242.container.height;
         this.var_333.visible = true;
         this.var_333.update();
      }
      ...
      private function getView(param1:String) : IIssueBrowserView
      {
         switch(param1)
         {
            case this.const_1796:
               ...
               {
                  this.var_1719 = new MyIssuesView(this.issueManager,this,this.var_242.container);
               }
               return this.var_1719;
            case this.const_1797:
               if(this.var_1718 == null)
               {
                  this.var_1718 = new OpenIssuesView(this.issueManager,this,this.var_242.container);
               }
               return this.var_1718;
            case this.const_1795:
               if(this.var_1720 == null)
               {
                  this.var_1720 = new PickedIssuesView(this.issueManager,this,this.var_242.container);
               }
