package com.sulake.habbo.friendlist
{
   ...
   public class HabboFriendList extends Component implements IHabboFriendList, IAvatarImageListener
   {
      ...
      private var var_958:IAvatarRenderManager;
      
      private var var_629:ISessionDataManager;
      
      private var var_1974:FriendListLookAndFeel;
      
      private var var_386:FriendListTabs;
      ...
      private var var_293:FriendRequests;
      ...
      {
         this.var_1974 = new FriendListLookAndFeel();
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_958)
         {
            this.var_958.release(new IIDAvatarRenderManager());
            this.var_958 = null;
         }
         if(this.var_835)
         {
         ...
         if(this.var_629)
         {
            this.var_629.release(new IIDSessionDataManager());
            this.var_629 = null;
         }
         super.dispose();
      }
      ...
      public function openHabboWebPage(param1:String, param2:Dictionary, param3:int, param4:int) : void
      {
         ...
         {
            this.var_1476 = new OpenedToWebPopup(this);
         }
         this.var_1476.show(x,y);
      }
      ...
      public function refreshToolBarIcon() : void
      {
         ...
         _loc1_.iconState = String(this.var_293.getCountOfOpenRequests() > 0 ? "2" : "0");
      ...
      public function getButton(param1:String, param2:String, param3:Function, param4:int = 0, param5:int = 0, param6:int = 0) : IBitmapWrapperWindow
      {
         ...
         var _loc8_:IBitmapWrapperWindow = this._windowManager.createWindow(param1,"",HabboWindowType.const_295,HabboWindowStyle.const_38,0 | 0,new Rectangle(param4,param5,_loc7_.width,_loc7_.height),param3,param6) as IBitmapWrapperWindow;
      ...
      {
         var _loc2_:IAvatarImage = this.var_958.createAvatarImage(param1,AvatarScaleType.const_83,null,this);
         if(!_loc2_)
         {
            return null;
         }
      ...
      private function onAvatarRenderedReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_958 = param2 as IAvatarRenderManager;
      ...
      {
         this.var_835 = param2 as IHabboNotifications;
      ...
      private function onMessengerInit(param1:IMessageEvent) : void
      {
         ...
         this.var_293 = new FriendRequests(new FriendRequestsDeps(this),_loc2_.userFriendLimit,_loc2_.extendedFriendLimit,_loc2_.evenMoreExtendedFriendLimit);
         for each(_loc3_ in _loc2_.categories)
         {
            this.var_90.addCategory(new FriendCategory(_loc3_.id,_loc3_.name));
         }
         this.var_90.addCategory(new FriendCategory(FriendCategory.const_958,this.getText("friendlist.friends")));
         this.var_90.addCategory(new FriendCategory(FriendCategory.const_340,this.getText("friendlist.friends.offlinecaption")));
         for each(_loc4_ in this.getSortedFriends(_loc2_.friends))
         {
            this.var_90.addFriend(new Friend(_loc4_));
         }
         this.var_386 = new FriendListTabs(new FriendListTabsDeps(this));
         if(!this.var_526)
         {
         ...
         {
            _loc5_ = this.var_90.findCategory(FriendCategory.const_340);
            if(_loc5_)
            {
               _loc5_.setOpen(true);
            }
      ...
      private function toggleWindow() : void
      {
         ...
         {
            this._view.openFriendList();
            _loc1_ = this.var_386.findSelectedTab();
            if(_loc1_ == null)
            {
               events.dispatchEvent(new Event(HabboFriendListTrackingEvent.const_326));
            }
            else
            {
               switch(_loc1_.id)
      ...
      private function onBuddyRequests(param1:IMessageEvent) : void
      {
         ...
         this.var_293.clearAndUpdateView(false);
         for each(_loc3_ in _loc2_.reqs)
         {
            this.var_293.addRequest(new FriendRequest(_loc3_));
         }
         if(_loc2_.reqs.length > 0)
         {
            this.var_386.findTab(FriendListTab.const_93).setNewMessageArrived(true);
      ...
      private function onNewBuddyRequest(param1:IMessageEvent) : void
      {
         ...
         this.var_293.addRequestAndUpdateView(_loc3_);
         var _loc4_:FriendListTab = this.var_386.findTab(FriendListTab.const_93);
      ...
      {
         var _loc2_:FriendListTab = this.var_386.findTab(FriendListTab.const_93);
         if(!_loc2_)
         {
            return;
         }
      ...
      {
         if(!this.var_629 || !this.var_293)
         {
            return;
         }
         var _loc2_:int = 0;
         if(this.var_629.hasUserRight("fuse_super_extended_buddylist"))
         {
            _loc2_ = this.var_293.vipLimit;
         }
         else if(this.var_629.hasUserRight("fuse_extended_buddylist"))
         {
            _loc2_ = this.var_293.clubLimit;
         }
         if(_loc2_ > this.var_293.limit)
         {
            this.var_293.limit = _loc2_;
         }
      }
