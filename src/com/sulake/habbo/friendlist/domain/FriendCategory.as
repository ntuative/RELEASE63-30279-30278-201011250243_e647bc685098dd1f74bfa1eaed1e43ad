package com.sulake.habbo.friendlist.domain
{
   ...
   public class FriendCategory implements IDisposable
   {
      ...
      {
         var _loc4_:* = null;
         if(this.var_190.indexOf(param1) >= 0)
         {
            return;
         }
         ...
         {
            _loc4_ = this.var_190[_loc3_];
            if(_loc2_ < _loc4_.name.toLowerCase())
            {
               this.var_190.splice(_loc3_,0,param1);
               return;
            }
            _loc3_++;
         }
      ...
      public function removeFriend(param1:int) : Friend
      {
         ...
         if(_loc2_ != null)
         {
            Util.remove(this.var_190,_loc2_);
            return _loc2_;
         }
         return null;
      }
      ...
      {
         return Math.ceil(this.var_190.length / const_330);
      }
      
      public function getStartFriendIndex() : int
      {
         this.checkPageIndex();
         return this.var_785 * const_330;
      }
      
      public function getEndFriendIndex() : int
      {
         this.checkPageIndex();
         return Math.min((this.var_785 + 1) * const_330,this.var_190.length);
      }
