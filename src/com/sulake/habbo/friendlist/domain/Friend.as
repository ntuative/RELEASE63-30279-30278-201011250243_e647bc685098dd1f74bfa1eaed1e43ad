package com.sulake.habbo.friendlist.domain
{
   ...
   public class Friend implements IFriend, IDisposable
   {
      ...
      public static const const_1733:int = "M".charCodeAt(0);
      ...
      public function Friend(param1:FriendData)
      {
         ...
         this.var_696 = param1.online;
         this.var_1419 = param1.followingAllowed && param1.online;
         this.var_553 = param1.figure;
         this.var_1418 = param1.motto;
         this.var_1416 = param1.lastAccess;
         this.var_1305 = param1.categoryId;
         this.var_1417 = param1.realName;
