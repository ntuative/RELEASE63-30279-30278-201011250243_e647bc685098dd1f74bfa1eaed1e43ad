package com.sulake.habbo.friendlist
{
   ...
   public class FriendListView
   {
      ...
      private static const const_1528:String = "noconvinfo";
      
      private static const const_1529:String = "messageinput";
       
      
      private var _friendList:HabboFriendList;
      
      private var var_1282:FriendListTabsView;
      ...
      public function FriendListView(param1:HabboFriendList)
      {
         ...
         this.var_1282 = new FriendListTabsView(this._friendList);
      }
      ...
      private function prepare() : void
      {
         ...
         this.var_786 = IWindowContainer(this.var_16.content.findChildByName("main_content"));
         this.var_244 = IWindowContainer(this.var_16.content.findChildByName("footer"));
         this.var_1282.prepare(this.var_786);
         this.var_16.procedure = this.onWindow;
         this.var_16.content.setParamFlag(HabboWindowParam.const_1087,false);
         this.var_16.content.setParamFlag(HabboWindowParam.const_1076,true);
         this.var_16.header.setParamFlag(HabboWindowParam.const_682,false);
         this.var_16.header.setParamFlag(HabboWindowParam.const_758,true);
         this.var_16.content.setParamFlag(HabboWindowParam.const_682,false);
         this.var_16.content.setParamFlag(HabboWindowParam.const_758,true);
         this.var_16.findChildByName("open_edit_ctgs_but").procedure = this.onEditCategoriesButtonClick;
         this.var_1283 = ITextWindow(this.var_16.findChildByName("info_text"));
         this.var_1283.text = "";
      ...
      private function onWindow(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc3_:int = this.var_1622 == -1 ? 0 : int(this.var_16.height - this.var_1622);
         var _loc4_:int = this.var_1621 == -1 ? 0 : int(this.var_16.width - this.var_1621);
      ...
      private function refreshWindowSize() : void
      {
         ...
         this.var_16.scaler.setParamFlag(HabboWindowParam.const_1095,this._friendList.tabs.findSelectedTab() != null);
         this.var_16.scaler.setParamFlag(HabboWindowParam.const_682,false);
         this.var_16.scaler.setParamFlag(HabboWindowParam.const_1087,false);
         ...
         this.var_1622 = this.var_16.height;
         this.var_1621 = this.var_16.width;
