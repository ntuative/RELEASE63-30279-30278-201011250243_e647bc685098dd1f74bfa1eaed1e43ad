package com.sulake.habbo.notifications
{
   ...
   public class HabboNotifications extends Component implements IHabboNotifications, IUpdateReceiver, IGetImageListener
   {
      ...
      private static const const_1222:String = "pixelbalance";
      
      private static const const_1221:String = "badges";
      
      private static const const_1227:String = "selectbadge";
      
      private static const const_1226:String = "inventory";
      
      private static const const_1223:String = "selectfurni";
      
      private static const const_1220:String = "credits";
      
      private static const const_1225:String = "friendlist";
      
      private static const const_1224:String = "pet_inventory";
      ...
      private var var_740:IHabboToolbar;
      ...
      private var var_492:HabboNotificationViewManager;
      
      private var var_209:HabboAlertDialogManager;
      
      private var var_741:ParkBusDialogManager;
      
      private var var_2554:Boolean;
      
      private var var_912:ClubGiftNotification;
      
      private var var_911:ClubEndingNotification;
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_740)
         {
            this.var_740.release(new IIDHabboToolbar());
            this.var_740 = null;
         }
      ...
      public function addItem(param1:String, param2:String, param3:BitmapData = null, param4:String = null) : int
      {
         ...
         this.var_1138.push(_loc8_);
         return this.var_1138.length;
      }
      
      private function getNextItemFromQueue() : HabboNotificationItem
      {
         var _loc1_:Array = this.var_1138.splice(0,1);
      ...
      private function onLocalizationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_209 = new HabboAlertDialogManager(this._windowManager,this._localization);
      ...
      {
         this.var_740 = IHabboToolbar(param2);
         this.var_740.events.addEventListener(HabboToolbarEvent.const_70,this.onHabboToolbarEvent);
      }
      ...
      public function onHabboToolbarEvent(param1:HabboToolbarEvent) : void
      {
         if(param1.type == HabboToolbarEvent.const_70)
         {
            ...
            this.var_492 = new HabboNotificationViewManager(this._assetLibrary,this._windowManager,this.var_914["styles"],this.var_914["view"],this.var_740);
            ...
            registerUpdateReceiver(this.var_492,1);
            registerUpdateReceiver(this,2);
            this.var_398.events.addEventListener(BadgeImageReadyEvent.const_137,this.onBadgeImage);
            this.var_740.events.addEventListener(HabboToolbarEvent.TOOLBAR_ORIENTATION,this.onToolbarRepositionEvent);
         }
      }
      ...
      function onAchievementNotication(param1:IMessageEvent) : void
      {
         ...
         this.var_1391[_loc2_.badgeID] = new AchievementNotification(_loc2_.badgeID,_loc2_.achievementID,_loc2_.level,_loc2_.points,_loc2_.levelRewardPoints,_loc2_.levelRewardPointType,_loc2_.bonusPoints,assets,this._windowManager,this._localization,this._config,this._communication,this.var_398);
      }
      ...
      function onAchievementShareId(param1:IMessageEvent) : void
      {
         ...
         var _loc3_:AchievementNotification = this.var_1391[_loc2_.badgeID] as AchievementNotification;
         delete this.var_1391[_loc2_.badgeID];
         if(_loc3_)
         {
      ...
      function onActivityPointNotication(param1:IMessageEvent) : void
      {
         ...
         {
            this.addItem(_loc4_.value,NotificationType.const_1232);
         }
      }
      ...
      function onRespectNotification(param1:IMessageEvent) : void
      {
         ...
         if(this.var_398.userId == _loc2_.userId)
         {
            ...
            if(_loc3_)
            {
               this.addItem(_loc3_.value,NotificationType.const_1027);
            }
            if(_loc4_)
            {
               this.addItem(_loc4_.value,NotificationType.const_1027);
            }
         }
      }
      ...
      public function addSongPlayingNotification(param1:String, param2:String) : void
      {
         ...
         if(_loc3_)
         {
            this.addItem(_loc3_.value,NotificationType.const_1436);
         }
      }
      ...
      public function addOnlineNotification(param1:String, param2:String, param3:String = "") : void
      {
         ...
         var _loc9_:* = null;
         var _loc4_:* = null;
         var _loc7_:IAvatarImage = this.var_418.createAvatarImage(param2,AvatarScaleType.const_48);
         if(_loc7_ != null)
         {
      ...
      private function onPurchaseOK(param1:IMessageEvent) : void
      {
         ...
         if(_loc4_ != null)
         {
            ...
            if(_loc8_)
            {
               ...
               {
                  _loc9_ = this.var_398.getFloorItemData(_loc8_.furniClassId);
               }
               else if(_loc8_.productType == CatalogPageMessageProductData.const_80)
               {
                  _loc9_ = this.var_398.getWallItemData(_loc8_.furniClassId);
               }
               _loc5_ = this.getProductImage(_loc8_.productType,_loc8_.furniClassId,_loc8_.extraParam);
            }
            _loc6_ = this.var_398.getProductData(_loc4_.localizationId);
         }
         if(!_loc6_)
         {
            return;
         ...
         if(_loc7_)
         {
            this.addItem(_loc7_.value,NotificationType.const_1341,_loc5_);
         }
      ...
      private function onRecyclerFinished(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_ == null || _loc2_.recyclerFinishedStatus != RecyclerFinishedMessageEvent.const_989)
         {
            return;
         }
      ...
      private function onSubscriptionInfo(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_.responseType == ScrSendUserInfoMessageParser.const_1265)
         {
         ...
         else
         {
            ...
            if(_loc8_ > 0 && _loc2_.daysToPeriodEnd > 0 && _loc2_.daysToPeriodEnd <= _loc8_ && _loc2_.periodsSubscribedAhead == 0)
            {
               ...
               this.var_911 = new ClubEndingNotification(_loc2_.daysToPeriodEnd,_loc2_.isVIP,assets,this._windowManager,this._catalog,this._localization);
            }
      ...
      {
         if(this.var_492.isSpaceAvailable() && this.var_1138.length > 0)
         {
            this.var_492.showItem(this.getNextItemFromQueue());
         }
      }
      ...
      public function onExecuteLink(param1:String) : void
      {
         switch(param1)
         {
            ...
            case const_1221:
               ...
               {
                  this._inventory.toggleInventoryPage(InventoryCategory.const_264);
               }
               break;
            case const_1227:
               break;
            ...
            case const_1224:
               if(this._inventory != null && this._inventory.hasRoomSession)
               {
                  this._inventory.toggleInventoryPage(InventoryCategory.const_142);
               }
               break;
            case const_1223:
               break;
      ...
      private function onBadgeImage(param1:BadgeImageReadyEvent) : void
      {
         ...
         {
            this.var_492.replaceIcon(param1);
         }
      }
      ...
      private function onModMessageEvent(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_ == null || this.var_209 == null)
         {
            return;
         }
         this.var_209.handleModMessage(_loc2_.message,_loc2_.url);
      }
      ...
      private function onUserBannedMessageEvent(param1:IMessageEvent) : void
      {
         ...
         this.var_209.handleUserBannedMessage(_loc2_.message);
      }
      ...
      private function onHotelClosing(param1:IMessageEvent) : void
      {
         ...
         this.var_209.handleHotelClosingMessage(_loc2_.minutesUntilClosing);
      }
      ...
      private function onHotelClosed(param1:IMessageEvent) : void
      {
         ...
         this.var_209.handleHotelClosedMessage(_loc2_.openHour,_loc2_.openMinute,_loc2_.userThrownOutAtClose);
      }
      ...
      private function onLoginFailedHotelClosed(param1:IMessageEvent) : void
      {
         ...
         this.var_209.handleLoginFailedHotelClosedMessage(_loc2_.openHour,_loc2_.openMinute);
      }
      ...
      private function onParkBusMessageEvent(param1:IMessageEvent) : void
      {
         ...
         if(this.var_741 == null)
         {
            this.var_741 = new ParkBusDialogManager(this._windowManager,assets,this._localization);
         }
         if(_loc2_ != null || this.var_741 != null)
         {
            this.var_741.handleParkBusCannotEnter(_loc2_.reason);
         }
      }
      ...
      private function onPetLevelNotification(param1:PetLevelNotificationEvent) : void
      {
         ...
         var _loc4_:IAvatarImage = this.var_418.createPetImageFromFigure(_loc2_.figure,AvatarScaleType.const_48);
         if(_loc4_ == null)
         {
            return;
         }
         ...
         if(_loc3_)
         {
            this.addItem(_loc3_.value,NotificationType.const_979,_loc5_);
         }
      }
      ...
      private function onPetReceived(param1:PetReceivedMessageEvent) : void
      {
         ...
         var _loc4_:IAvatarImage = this.var_418.createPetImageFromFigure(_loc2_.pet.figure,AvatarScaleType.const_48);
         if(_loc4_ == null)
         {
            return;
         }
      ...
      private function onRoomEnter(param1:IMessageEvent) : void
      {
         ...
         if(!this.var_2554)
         {
            ...
            this.addItem(_loc2_,NotificationType.const_1047);
            this.var_2554 = true;
      ...
      {
         if(param2.type == WindowEvent.const_181 || param2.type == WindowEvent.const_557)
         {
            param1.dispose();
         }
      }
      ...
      private function onClubGiftNotification(param1:ClubGiftNotificationEvent) : void
      {
         ...
         if(_loc2_.method_12 < 1)
         {
            return;
         }
         if(this.var_912 && this.var_912.visible)
         {
            return;
         }
         this.var_912 = new ClubGiftNotification(_loc2_.method_12,assets,this._windowManager,this._catalog);
      }
      ...
      private function onClubGiftSelected(param1:ClubGiftSelectedEvent) : void
      {
         ...
         this.addItem(_loc5_,NotificationType.const_1047,_loc6_);
      }
   }
}
