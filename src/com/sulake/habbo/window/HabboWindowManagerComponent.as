package com.sulake.habbo.window
{
   ...
   public class HabboWindowManagerComponent extends Component implements IHabboWindowManager, ICoreWindowManager, IWindowFactory, IUpdateReceiver, IWindowContextStateListener
   {
      ...
      private static const const_383:uint = 3;
      ...
      private var var_1268:IEventDispatcher;
      
      private var var_1015:Boolean = false;
      
      private var var_1588:ProfilerOutput;
      
      private var var_1267:ProfilerAgentTask;
      
      private var var_1269:ProfilerAgentTask;
      ...
      private function initialize(param1:IID, param2:IUnknown) : void
      {
         ...
         this._windowRenderer = new WindowRenderer(this.var_827);
         this.var_177 = new Array(const_383);
         ...
         this.var_216 = this.var_177[const_1175];
         _loc7_ = new Bitmap(assets.getAssetByName("habbo_cursor_link_png").content as BitmapData);
         this.var_216.getMouseCursor().defineCustomCursorType(MouseCursorType.const_348,_loc7_);
         _loc7_ = new Bitmap(assets.getAssetByName("habbo_cursor_drag_png").content as BitmapData);
         this.var_216.getMouseCursor().defineCustomCursorType(MouseCursorType.const_1464,_loc7_);
         unlock();
      ...
      private function receiveProfilerInterface(param1:IID, param2:IUnknown) : void
      {
         ...
         if(_loc3_ != null)
         {
            if(!this.var_1588)
            {
               this.var_1588 = new ProfilerOutput(context,this,this._windowRenderer);
            }
            this.var_1588.profiler = _loc3_;
            this.var_1267 = new ProfilerAgentTask("Update","Event processing");
            _loc3_.getProfilerAgentForReceiver(this).addSubTask(this.var_1267);
            this.var_1269 = new ProfilerAgentTask("Redraw","Window rasterizer");
            _loc3_.getProfilerAgentForReceiver(this).addSubTask(this.var_1269);
            this.var_1015 = true;
         }
      }
      ...
      {
         return this.var_216.create(param1,param7,param2,param3,param4,param5,param6,param10,param8,param11,param9);
      }
      ...
      {
         return this.var_216.getWindowParser().windowToXMLString(param1);
      }
      
      public function getLayoutByTypeAndStyle(param1:uint, param2:uint) : XML
      {
         var _loc3_:Dictionary = this.var_307[param2] as Dictionary;
         if(_loc3_ == null)
         {
            return null;
         }
         var _loc4_:XML = _loc3_[param1] as XML;
         return _loc4_ == null ? this.var_307[0][param1] as XML : _loc4_;
      }
      ...
      {
         return this.var_177[param1].getDesktopWindow().getChildAt(this.var_216.getDesktopWindow().numChildren - 1);
      }
      ...
      public function update(param1:uint) : void
      {
         ...
         if(WindowContext.var_340.length > 0)
         {
            this.var_1268.dispatchEvent(new Event(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_INPUT));
            _loc2_ = const_383 - 1;
            while(_loc2_ >= 0)
            {
         ...
         this.var_1268.dispatchEvent(new Event(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_RENDER));
         _loc2_ = 0;
         while(_loc2_ < const_383)
         {
         ...
         if(WindowContext.var_340.length > 0)
         {
            WindowContext.var_340.flush();
         }
         this.var_1268.dispatchEvent(new Event(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_SLEEP));
      }
      ...
      public function mouseEventReceived(param1:String, param2:IWindow) : void
      {
         if(param2 != null)
         {
            ...
            {
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1345,new Date().getTime().toString());
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1254,param2.name + ": " + param2.toString());
            }
            else if(param1 == MouseEvent.MOUSE_UP)
            {
               ...
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1417,param2.name + ": " + param2.toString());
            }
         }
      }
   }
