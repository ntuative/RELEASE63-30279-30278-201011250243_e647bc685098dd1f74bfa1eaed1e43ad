package com.sulake.habbo.roomevents.userdefinedroomevents.common
{
   ...
   public class SliderWindowController extends EventDispatcher
   {
      ...
      public function method_1(param1:Number, param2:Boolean = true) : void
      {
      ...
      private function updateSliderPosition() : void
      {
         ...
         if(_loc1_ != null)
         {
            _loc1_.x = this.getSliderPosition(this.var_825);
         }
      ...
      {
         return int(this.var_1578 * (Number(param1 - this._minValue) / (this.var_1010 - this._minValue)));
      }
      
      private function getValueAtPosition(param1:Number) : Number
      {
         return param1 / this.var_1578 * (this.var_1010 - this._minValue) + this._minValue;
      }
      ...
      private function sliderProcedure(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(this.var_826)
         {
            if(param1.type == WindowMouseEvent.const_57 || param1.type == WindowMouseEvent.const_162)
            {
               this.var_826 = false;
            }
         }
         if(!this.var_826 || param1.type != WindowEvent.const_325)
         {
            return;
         }
         if(this.var_556 != 0)
         {
            ...
            _loc4_ = Math.round(_loc3_ / this.var_556) * this.var_556;
            this.method_1(_loc4_,false);
         }
      }
      ...
      private function sliderButtonRightProcedure(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            ...
            if(this.var_556 != 0)
            {
               _loc3_ = this.var_825 + this.var_556;
               this.method_1(_loc3_);
            }
         }
      }
      ...
      private function displaySlider() : void
      {
         ...
         if(_loc2_ != null && this.var_651 != null)
         {
            _loc2_.bitmap = new BitmapData(this.var_651.width,this.var_651.height,true,16777215);
            _loc2_.bitmap.copyPixels(this.var_651,this.var_651.rect,new Point(0,0),null,null,true);
         }
         ...
         if(_loc1_ != null)
         {
            ...
            if(_loc2_ != null && this.var_652 != null)
            {
               ...
               this.var_1578 = _loc1_.width - _loc2_.width;
            }
         }
      ...
      private function storeAssets(param1:IAssetLibrary) : void
      {
         ...
         this.var_651 = BitmapData(_loc2_.content);
