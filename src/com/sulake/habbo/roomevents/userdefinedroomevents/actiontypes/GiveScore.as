package com.sulake.habbo.roomevents.userdefinedroomevents.actiontypes
{
   ...
   public class GiveScore implements ActionType
   {
      ...
      private var var_999:SliderWindowController;
      ...
      public function readIntParamsFromForm(param1:IWindowContainer) : Array
      {
         ...
         _loc2_.push(this.var_999.getValue());
         return _loc2_;
      }
      ...
      public function onInit(param1:IWindowContainer, param2:HabboUserDefinedRoomEvents) : void
      {
         ...
         this.var_962.method_1(1);
         this.var_999 = new SliderWindowController(param2,this.getCounterInput(param1),param2.assets,1,10,1);
         this.var_999.addEventListener(Event.CHANGE,this.onCounterSliderChange);
         this.var_999.method_1(1);
      }
      ...
      public function onEditStart(param1:IWindowContainer, param2:Triggerable) : void
      {
         ...
         this.var_962.method_1(_loc3_);
         this.var_999.method_1(_loc4_);
      }
