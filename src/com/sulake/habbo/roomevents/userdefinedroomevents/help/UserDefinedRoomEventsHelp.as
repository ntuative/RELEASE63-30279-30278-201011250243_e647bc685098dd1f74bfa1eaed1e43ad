package com.sulake.habbo.roomevents.userdefinedroomevents.help
{
   ...
   public class UserDefinedRoomEventsHelp
   {
      ...
      private var var_1036:IContainerButtonWindow;
      
      private var var_1035:IContainerButtonWindow;
      ...
      private function prepareWindow() : void
      {
         ...
         this.var_1633 = IWindowContainer(this.find(this._window,"help_container"));
         this.var_1035 = this.var_1633.findChildByName("button_previous") as IContainerButtonWindow;
         if(this.var_1035)
         {
            this.var_1035.procedure = this.onButtonClick;
         }
         this.var_1036 = this.var_1633.findChildByName("button_next") as IContainerButtonWindow;
         if(this.var_1036)
         {
            this.var_1036.procedure = this.onButtonClick;
         }
      ...
      {
         if(this.var_227 >= this._localizations.length - 1)
         {
            this.var_1036.disable();
         }
         else
         {
            this.var_1036.enable();
         }
         if(this.var_227 <= 0)
         {
      ...
      {
         ++this.var_227;
         this.var_227 = Math.min(this.var_227,this._localizations.length - 1);
         this.openPage();
      }
      ...
      {
         --this.var_227;
         this.var_227 = Math.max(this.var_227,0);
         this.openPage();
      }
      ...
      private function localize() : void
      {
         ...
         if(_loc1_)
         {
            _loc1_.text = ILocalization(this._localizations[this.var_227][0]).value;
         }
         if(_loc2_)
         {
            _loc2_.text = ILocalization(this._localizations[this.var_227][2]).value;
         }
         if(_loc3_)
         {
            _loc4_ = ILocalization(this._localizations[this.var_227][1]).value;
