package com.sulake.habbo.roomevents.userdefinedroomevents
{
   ...
   public class UserDefinedRoomEventsCtrl
   {
      ...
      private var var_1656:TriggerConfs;
      
      private var var_1655:ActionTypes;
      
      private var var_1657:ConditionTypes;
      
      private var var_228:Dictionary;
      
      private var var_57:Triggerable;
      
      private var var_679:RoomObjectHightLighter;
      
      private var var_169:UserDefinedRoomEventsHelp;
      
      private var var_1052:SliderWindowController;
      
      public function UserDefinedRoomEventsCtrl(param1:HabboUserDefinedRoomEvents)
      {
         this.var_1656 = new TriggerConfs();
         this.var_1655 = new ActionTypes();
         this.var_1657 = new ConditionTypes();
         this.var_228 = new Dictionary();
         super();
         this.var_86 = param1;
         this.var_679 = new RoomObjectHightLighter(param1);
         this.var_169 = new UserDefinedRoomEventsHelp(param1);
      }
      ...
      public function stuffSelected(param1:int, param2:String) : void
      {
         ...
         if(this.var_228[param1])
         {
            delete this.var_228[param1];
            this.var_679.hide(param1);
         }
         else if(this.getStuffIds().length < this.var_57.furniLimit)
         {
            this.var_228[param1] = param2;
            this.var_679.show(param1);
         }
         this.refresh();
      }
      ...
      private function prepareWindow() : void
      {
         ...
         this.var_1052 = new SliderWindowController(this.var_86,IWindowContainer(this.find(this.var_87,"delay_slider_container")),this.var_86.assets,0,20,1);
         this.var_1052.addEventListener(Event.CHANGE,this.onDelaySliderChange);
         this.var_1052.method_1(0);
      ...
      public function close() : void
      {
         if(this._window)
         {
            ...
            this.var_679.hideAll(this.var_228);
         }
      }
      ...
      private function onSave(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(this.var_57 as TriggerDefinition != null)
         {
            this.var_86.send(new UpdateTriggerMessageComposer(this.var_57.id,this.resolveIntParams(),this.resolveStringParam(),this.getStuffIds()));
         }
         else if(this.var_57 as ActionDefinition != null)
         {
            this.var_86.send(new UpdateActionMessageComposer(this.var_57.id,this.resolveIntParams(),this.resolveStringParam(),this.getStuffIds(),this.getActionDelay()));
         }
         else if(this.var_57 as ConditionDefinition != null)
         {
            this.var_86.send(new UpdateConditionMessageComposer(this.var_57.id,this.resolveIntParams(),this.resolveStringParam(),this.getStuffIds()));
         }
         this.close();
      }
      ...
      public function getActionDelay() : int
      {
         ...
         return !!_loc1_.allowDelaying ? int(this.var_1052.getValue()) : 0;
      }
      ...
      private function onHelp(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_169.open(this._window.x + this._window.width + 5,this._window.y);
      }
      ...
      private function onApplySnapshot(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_86.send(new ApplySnapshotMessageComposer(this.var_57.id));
      }
      ...
      private function refresh() : void
      {
         ...
         this.refreshConfigureElement(this.var_1656);
         this.refreshConfigureElement(this.var_1655);
         this.refreshConfigureElement(this.var_1657);
