package com.sulake.habbo.tracking
{
   ...
   public class HabboTracking extends Component implements IHabboTracking, IUpdateReceiver
   {
      ...
      private static const const_853:uint = 11;
      ...
      private var var_573:LagWarningLogger = null;
      
      private var var_572:ToolbarClickTracker = null;
      ...
      public function HabboTracking(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_235 = new PerformanceTracker();
         this.var_571 = new FramerateTracker();
         this.var_236 = new LatencyTracker();
         this.var_573 = new LagWarningLogger();
         this.var_572 = new ToolbarClickTracker(this);
         this.var_1327 = new Array(const_853);
         var _loc4_:int = 0;
         while(_loc4_ < const_853)
         {
            this.var_1327[_loc4_] = 0;
            _loc4_++;
         }
         ...
         if(_loc5_ != null)
         {
            ...
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1457,!true ? ExternalInterface.call("window.navigator.userAgent.toString") : "unknown");
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1404,Capabilities.serverString);
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_720,String(false));
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1058,String(0));
         }
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            ...
            if(this.var_56)
            {
               this.var_56.release(new IIDHabboRoomWidget());
               this.var_56 = null;
            }
            if(this._navigator)
            {
            ...
            if(this.var_179)
            {
               if(!this.var_179.disposed)
               {
                  ...
                  Component(this.var_179).events.removeEventListener(HabboFriendListTrackingEvent.const_326,this.onFriendlistTrackingEvent);
               }
            ...
            if(this.var_169)
            {
               ...
               {
                  this.var_169.events.removeEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_CLOSED,this.onHelpTrackingEvent);
                  this.var_169.events.removeEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_DEFAULT,this.onHelpTrackingEvent);
               }
               this.var_169.release(new IIDHabboHelp());
               this.var_169 = null;
            }
            if(this._toolbar)
            {
      ...
      private function onConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(this.var_164)
         {
            if(this.var_236 != null)
            {
               this.var_236.configuration = this.var_164;
            }
            if(this.var_235 != null)
            {
               this.var_235.configuration = this.var_164;
            }
            ...
            if(this.var_164)
            {
               ...
               {
                  this.var_573.configure(this.var_164);
               }
               if(this.var_571 != null)
               {
                  this.var_571.configure(this.var_164);
               }
               if(this.var_572 != null)
               {
                  this.var_572.configure(this.var_164);
               }
            }
         }
      }
      ...
      private function onLocalizationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.trackLoginStep(HabboLoginTrackingStep.const_155);
      }
      ...
      private function onCommunicationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         Component(context).events.addEventListener(HabboCommunicationEvent.const_607,this.onConnectionEvent);
         ...
         Component(context).events.addEventListener(HabboHotelViewEvent.const_690,this.onHotelViewEvent);
         Component(context).events.addEventListener(HabboHotelViewEvent.const_66,this.onHotelViewEvent);
         Component(context).events.addEventListener(HabboHotelViewEvent.const_504,this.onHotelViewEvent);
      }
      ...
      private function onConnectionReady(param1:IConnection) : void
      {
         ...
         if(param1 != null)
         {
            ...
            if(this.var_235 != null)
            {
               this.var_235.connection = param1;
            }
            if(this.var_236 != null)
            {
               this.var_236.communication = this._communication;
               this.var_236.connection = param1;
            }
            if(this.var_573 != null)
            {
               this.var_573.connection = param1;
            }
         }
      }
      ...
      private function onHotelViewEvent(param1:Event) : void
      {
         ...
         {
            this.trackLoginStep(HabboLoginTrackingStep.const_1287);
         }
         else if(param1.type == HabboHotelViewEvent.const_504)
         {
      ...
      private function onConnectionEvent(param1:Event) : void
      {
         switch(param1.type)
         {
            case HabboCommunicationEvent.INIT:
               ...
               break;
            case HabboCommunicationEvent.const_607:
               this.trackLoginStep(HabboLoginTrackingStep.const_1313,String(this._communication.port));
               break;
         ...
         if(param1.critical && !this._crashed)
         {
            ...
            if(this.var_164)
            {
               if(this.var_164.keyExists("client.fatal.error.url"))
               {
                  ...
                  _loc8_ = "";
                  for each(_loc9_ in this.var_1327)
                  {
                  ...
                  if(this.var_235 != null)
                  {
                     _loc4_["null"] = this.var_235.flashVersion;
                     _loc4_["null"] = this.var_235.averageUpdateInterval;
                  }
      ...
      {
         this.trackLoginStep(HabboLoginTrackingStep.const_1062);
         if(context && false)
         {
            context.root.events.removeEventListener(HabboLoginTrackingStep.const_1062,this.onCoreRunning);
         }
      }
      ...
      private function onFriendlistReady(param1:IID, param2:IUnknown) : void
      {
         ...
         Component(this.var_179).events.addEventListener(HabboFriendListTrackingEvent.const_326,this.onFriendlistTrackingEvent);
      }
      ...
      private function onFriendlistTrackingEvent(param1:Event) : void
      {
         switch(param1.type)
         {
            ...
            case HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_REQUEST:
               ...
               break;
            case HabboFriendListTrackingEvent.const_326:
      ...
      {
         this.var_56 = param2 as IRoomWidgetFactory;
         Component(this.var_56).events.addEventListener(HabboMeMenuTrackingEvent.HABBO_MEMENU_TRACKING_EVENT_CLOSE,this.onWidgetTrackingEvent);
         Component(this.var_56).events.addEventListener(HabboMeMenuTrackingEvent.HABBO_MEMENU_TRACKING_EVENT_DEFAULT,this.onWidgetTrackingEvent);
         Component(this.var_56).events.addEventListener(HabboMeMenuTrackingEvent.HABBO_MEMENU_TRACKING_EVENT_DANCE,this.onWidgetTrackingEvent);
         Component(this.var_56).events.addEventListener(HabboMeMenuTrackingEvent.HABBO_MEMENU_TRACKING_EVENT_EFFECTS,this.onWidgetTrackingEvent);
      }
      ...
      {
         this.var_169 = param2 as IHabboHelp;
         this.var_169.events.addEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_CLOSED,this.onHelpTrackingEvent);
         this.var_169.events.addEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_DEFAULT,this.onHelpTrackingEvent);
      }
      ...
      private function onRoomEnter(param1:IMessageEvent) : void
      {
         if(!this.var_2329)
         {
            this.trackLoginStep(HabboLoginTrackingStep.const_1476);
            this.var_2329 = true;
         }
         var _loc2_:RoomEntryInfoMessageParser = RoomEntryInfoMessageEvent(param1).getParser();
         if(_loc2_.guestRoom)
         {
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1058,String(_loc2_.guestRoomId));
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_720,String(true));
      ...
      private function onRoomEngineReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         Component(this._roomEngine).events.addEventListener(RoomObjectRoomAdEvent.const_274,this.onRoomAdClick);
      }
      
      private function onAdManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         this.var_263 = param2 as IAdManager;
         this.var_263.events.addEventListener(AdEvent.const_523,this.onRoomAdLoad);
      }
      ...
      private function onToolbarClick(param1:HabboToolbarEvent) : void
      {
         if(this.var_572)
         {
            this.var_572.track(param1.iconName);
         }
      }
      ...
      {
         this.var_573.chatLagDetected();
      }
      
      public function update(param1:uint) : void
      {
         var _loc2_:int = getTimer();
         if(this.var_1082 > -1 && _loc2_ < this.var_1082)
         {
            ++this.var_1685;
            ErrorReportStorage.addDebugData("Invalid time counter","Invalid times: " + this.var_1685);
         }
         if(this.var_1082 > -1 && _loc2_ - this.var_1082 > 15000)
         {
            ++this.var_1684;
            ErrorReportStorage.addDebugData("Time leap counter","Time leaps: " + this.var_1684);
         }
         this.var_1082 = _loc2_;
         if(this.var_235 != null)
         {
            this.var_235.update(param1);
         }
         if(this.var_236 != null)
         {
            this.var_236.update(param1);
         }
         if(this.var_571 != null)
         {
            this.var_571.trackUpdate(param1,this);
         }
         if(this.var_573 != null)
         {
            this.var_573.update();
