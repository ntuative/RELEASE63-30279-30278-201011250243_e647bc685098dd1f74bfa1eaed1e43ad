package com.sulake.habbo.sound
{
   ...
   public class PlayListController implements IDisposable
   {
      ...
      private const const_1784:String = "type_sound_machine";
      
      private const const_1519:String = "type_jukebox";
      
      private var var_564:HabboSoundManagerFlash10;
      ...
      public function PlayListController(param1:HabboSoundManagerFlash10, param2:IEventDispatcher, param3:IEventDispatcher, param4:IConnection)
      {
         ...
         this._events.addEventListener(SoundCompleteEvent.const_794,this.onSongFinishedPlayingEvent);
         this.var_86.addEventListener(RoomObjectSoundMachineStateUpdateEvent.const_787,this.onSoundMachinePlayEvent);
         this.var_86.addEventListener(RoomObjectSoundMachineStateUpdateEvent.const_801,this.onSoundMachineStopEvent);
         this.var_86.addEventListener(RoomObjectSoundMachineStateUpdateEvent.const_770,this.onJukeboxInitEvent);
         this.var_86.addEventListener(RoomObjectSoundMachineStateUpdateEvent.const_528,this.onDisposeEvent);
      }
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            ...
            if(this._events)
            {
               this._events.removeEventListener(SoundCompleteEvent.const_794,this.onSongFinishedPlayingEvent);
               this._events = null;
            }
            if(this.var_86)
            {
               this.var_86.removeEventListener(RoomObjectSoundMachineStateUpdateEvent.const_787,this.onSoundMachinePlayEvent);
               this.var_86.removeEventListener(RoomObjectSoundMachineStateUpdateEvent.const_801,this.onSoundMachineStopEvent);
               this.var_86.removeEventListener(RoomObjectSoundMachineStateUpdateEvent.const_770,this.onJukeboxInitEvent);
               this.var_86.removeEventListener(RoomObjectSoundMachineStateUpdateEvent.const_528,this.onDisposeEvent);
               this.var_86 = null;
            }
            if(this.var_354)
            {
      ...
      {
         this.startPlaying(this.const_1784);
      }
      ...
      {
         this.startPlaying(this.const_1519);
      }
      ...
      public function startPlaying(param1:String) : void
      {
         ...
         if(_loc2_ != null)
         {
            this.var_259 = _loc2_.id;
            this.playSong(this.var_259);
         }
      }
      ...
      {
         var _loc1_:IHabboSound = this.var_354[this.var_259] as IHabboSound;
         if(_loc1_ != null)
         {
            _loc1_.stop();
         }
      ...
      {
         var _loc2_:IHabboSound = this.var_354.getValue(this.var_259) as IHabboSound;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      private function playSong(param1:int) : void
      {
         var _loc6_:* = null;
         this.var_259 = param1;
         var _loc2_:IHabboSound = this.var_354.getValue(param1) as IHabboSound;
         if(_loc2_ == null)
         {
         ...
         _loc2_.volume = this.var_564.volume;
         _loc2_.play();
         if(_loc3_.length >= 4)
         {
            this.var_564.notifyPlayedSong(_loc3_.name,_loc3_.creator);
         }
         var _loc5_:PlayListEntry = this.getNextEntry();
         if(_loc5_ != null && _loc5_.id != this.var_259)
         {
            _loc6_ = this.var_354[_loc5_.id] as IHabboSound;
            if(_loc6_ == null)
            {
      ...
      {
         if(this.var_1503 == this.const_1519)
         {
            this.var_72.shift();
         }
         var _loc2_:PlayListEntry = this.getNextEntry();
      ...
      private function requestSongInfo(param1:int) : void
      {
         ...
         if(this.var_534.indexOf(param1) == -1)
         {
      ...
      private function onSongInfoMessage(param1:IMessageEvent) : void
      {
         ...
         this.var_534 = this.var_534.splice(this.var_534.indexOf(_loc3_.id),1);
         if(_loc4_)
         {
            _loc7_ = this.var_354[_loc3_.id] as IHabboSound;
            if(_loc7_ == null)
            {
               _loc7_ = this.var_564.loadTraxSong(_loc3_.id,_loc3_.data);
               this.var_354.add(_loc3_.id,_loc7_);
            }
