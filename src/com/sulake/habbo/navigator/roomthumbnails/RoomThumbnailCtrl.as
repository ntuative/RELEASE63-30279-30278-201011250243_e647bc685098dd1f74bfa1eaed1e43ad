package com.sulake.habbo.navigator.roomthumbnails
{
   ...
   public class RoomThumbnailCtrl
   {
      ...
      private var var_1706:IButtonWindow;
      
      private var var_1708:IButtonWindow;
      
      private var var_1707:IButtonWindow;
      ...
      private function prepareWindow(param1:IWindowContainer) : void
      {
         ...
         this.var_1706 = IButtonWindow(this.find("bg_tab"));
         this.var_1708 = IButtonWindow(this.find("top_tab"));
         this.var_1707 = IButtonWindow(this.find("obj_tab"));
         this.var_2362 = IWindowContainer(this.find("tile_grid"));
         this.var_2363 = IWindowContainer(this.find("now_editing_container"));
         Util.setProcDirectly(this.find("save"),this.onSaveButton);
         Util.setProcDirectly(this.find("cancel"),this.onCancelButton);
         Util.setProcDirectly(this.var_1706,this.onBgTabButton);
         Util.setProcDirectly(this.var_1708,this.onTopTabButton);
         Util.setProcDirectly(this.var_1707,this.onObjTabButton);
      }
      ...
      {
         this.setEnabled(this.var_1706,this.var_62.mode != ThumbnailEditorModel.const_36);
         this.setEnabled(this.var_1708,this.var_62.mode != ThumbnailEditorModel.const_56);
         this.setEnabled(this.var_1707,this.var_62.mode != ThumbnailEditorModel.const_34);
      }
      
      private function refreshEditArea() : void
      {
         var _loc1_:IWindowContainer = this.var_2363;
      ...
      private function refreshPositionGrid() : void
      {
         ...
         var _loc4_:* = null;
         var _loc5_:* = null;
         var _loc1_:IWindowContainer = this.var_2362;
         _loc1_.visible = true;
         if(_loc1_.numChildren == 0)
         {
            while(_loc3_ <= RoomThumbnailRenderer.const_456)
            {
      ...
      private function populateImgList(param1:IItemListWindow, param2:int) : void
      {
         ...
         while(_loc8_ < _loc6_.length)
         {
            ...
            if(_loc9_ == 0)
            {
               _loc7_ = IWindowContainer(this._navigator.windowManager.createWindow("row_" + _loc8_,"",HabboWindowType.const_58,HabboWindowStyle.const_35,HabboWindowParam.const_59,new Rectangle(0,0,param1.width,66)));
               param1.addListItem(_loc7_);
            }
            _loc10_ = _loc6_[_loc8_];
            _loc11_ = IBitmapWrapperWindow(this._navigator.windowManager.createWindow("img_" + _loc8_,"",HabboWindowType.const_295,HabboWindowStyle.const_38,0 | 0,new Rectangle(_loc9_ * 66,0,66,66),this.onImgSel,_loc10_.id));
