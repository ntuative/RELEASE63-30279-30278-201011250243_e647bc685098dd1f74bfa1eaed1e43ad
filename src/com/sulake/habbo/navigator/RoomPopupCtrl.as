package com.sulake.habbo.navigator
{
   ...
   public class RoomPopupCtrl extends PopupCtrl
   {
      ...
      private var var_99:GuestRoomData;
      ...
      public function RoomPopupCtrl(param1:HabboNavigator, param2:int, param3:int)
      {
         ...
         this.var_2039 = new RoomThumbnailRenderer(param1);
      ...
      override public function refreshContent(param1:IWindowContainer) : void
      {
         ...
         this.refreshRoomName(this.var_157,this.var_99);
         if(this.var_99.ownerName != "" && this.var_99.ownerName != "-")
         {
         }
         this.refreshOwnerName();
         this.refreshTextWithCaption("roomctg",this.var_157,!!this.var_99.event ? this.getEventCtg(this.var_99.categoryId) : this.getRoomCtg(this.var_99.categoryId));
         this.refreshRoomDesc(this.var_157,this.var_99);
         this.refreshExtraCont();
         this.refreshInfo(this.var_157,"trading_allowed",this.var_99.allowTrading);
         this.refreshInfo(this.var_157,"doormode_doorbell",this.var_99.doorMode == 1);
         this.refreshInfo(this.var_157,"doormode_password",this.var_99.doorMode == 2);
      ...
      {
         this.refreshTextWithCaption("roomowner",this.var_157,this.var_99.ownerName);
      ...
      private function refreshExtraCont() : void
      {
         ...
         this.var_986.refreshTags(_loc1_,this.var_99.tags);
         this.refreshTextWithCaption("rating",_loc1_,"" + this.var_99.score);
         if(this.var_99.event)
         {
            this.refreshTextWithCaption("startedat",_loc1_,"" + this.var_99.eventCreationTime);
         }
         this.var_2039.refreshThumbnail(_loc1_,this.var_99.thumbnail,false);
      ...
      private function onOwnerName(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(_loc3_ != null)
         {
            navigator.mainViewCtrl.startSearch(Tabs.const_252,Tabs.const_251,_loc3_.text);
            this.hideInstantly();
         }
      }
   }
