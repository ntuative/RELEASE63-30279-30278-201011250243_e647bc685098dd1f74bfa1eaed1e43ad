package com.sulake.habbo.navigator.roomsettings
{
   ...
   public class RoomCreateViewCtrl
   {
      ...
      private var var_947:RoomLayout;
      ...
      public function RoomCreateViewCtrl(param1:HabboNavigator)
      {
         ...
         this.var_520 = new Timer(100);
         this.var_520.addEventListener(TimerEvent.TIMER,this.updateArrowPos);
         this.var_35 = new Array();
         this.var_35.push(new RoomLayout(HabboClubLevelEnum.const_49,104,"a"));
         this.var_35.push(new RoomLayout(HabboClubLevelEnum.const_49,94,"b"));
         this.var_35.push(new RoomLayout(HabboClubLevelEnum.const_49,36,"c"));
         this.var_35.push(new RoomLayout(HabboClubLevelEnum.const_49,84,"d"));
         this.var_35.push(new RoomLayout(HabboClubLevelEnum.const_49,80,"e"));
         this.var_35.push(new RoomLayout(HabboClubLevelEnum.const_49,80,"f"));
         this.var_35.push(new RoomLayout(HabboClubLevelEnum.const_49,416,"i"));
         this.var_35.push(new RoomLayout(HabboClubLevelEnum.const_49,320,"j"));
         this.var_35.push(new RoomLayout(HabboClubLevelEnum.const_49,448,"k"));
         this.var_35.push(new RoomLayout(HabboClubLevelEnum.const_49,352,"l"));
         this.var_35.push(new RoomLayout(HabboClubLevelEnum.const_49,384,"m"));
         this.var_35.push(new RoomLayout(HabboClubLevelEnum.const_49,372,"n"));
         ...
         this.var_35.push(new RoomLayout(HabboClubLevelEnum.const_53,540,"t"));
         this.var_35.push(new RoomLayout(HabboClubLevelEnum.const_53,512,"w"));
         this.var_35.push(new RoomLayout(HabboClubLevelEnum.const_53,396,"x"));
         this.var_35.push(new RoomLayout(HabboClubLevelEnum.const_53,440,"y"));
         this.var_35.push(new RoomLayout(HabboClubLevelEnum.const_53,456,"z"));
         this.var_35.push(new RoomLayout(HabboClubLevelEnum.const_53,208,"0"));
      }
      ...
      public function dispose() : void
      {
         if(this.var_520)
         {
            this.var_520.removeEventListener(TimerEvent.TIMER,this.updateArrowPos);
            this.var_520.reset();
            this.var_520 = null;
         }
      }
      ...
      {
         var _loc3_:IBitmapWrapperWindow = IBitmapWrapperWindow(this.var_947.view.findChildByName("select_arrow"));
         var _loc6_:int = Math.abs(_loc3_.y - 0) < 2 || Math.abs(_loc3_.y - 15) < 2 ? 1 : 2;
         _loc3_.y += !!this.var_1451 ? _loc6_ : -_loc6_;
         if(_loc3_.y < 0)
         {
            this.var_1451 = true;
            _loc3_.y = 1;
      ...
      private function prepare() : void
      {
         ...
         this.var_155 = IWindowContainer(this._navigator.getXmlWindow("roc_create_room"));
         this.var_54 = IItemListWindow(this.var_155.findChildByName("item_list"));
         ...
         var _loc1_:IWindow = this.var_155.findChildByTag("close");
         _loc1_.procedure = this.onCancelButtonClick;
         this.var_946 = new TextFieldManager(this._navigator,ITextFieldWindow(this.var_155.findChildByName("room_name_input")),25,null,this._navigator.getText("navigator.createroom.roomnameinfo"));
         var _loc2_:Rectangle = Util.getLocationRelativeTo(this.var_155.desktop,this.var_155.width,this.var_155.height);
         this.var_155.x = _loc2_.x;
         this.var_155.y = _loc2_.y;
      }
      
      public function refresh() : void
      {
         this.var_946.goBackToInitialState();
         this.var_946.input.textBackgroundColor = 4294967295;
         this.var_947 = this.var_35[0];
         this.refreshRoomThumbnails();
      ...
      {
         return IWindowContainer(this._navigator.windowManager.createWindow("","",HabboWindowType.const_58,HabboWindowStyle.const_35,HabboWindowParam.const_59,new Rectangle(0,0,100,300)));
      }
      
      private function isMandatoryFieldsFilled() : Boolean
      {
         var _loc1_:Boolean = this.var_946.checkMandatory(this._navigator.getText("navigator.createroom.nameerr"));
         return Boolean(_loc1_);
      }
      
      private function getCreateButton() : IButtonWindow
      {
         return IButtonWindow(this.var_155.findChildByName("create_button"));
      }
      
      private function getCancelButton() : IButtonWindow
      {
         return IButtonWindow(this.var_155.findChildByName("back_button"));
      }
      ...
      private function onCreateButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc3_:String = this.var_946.getText();
         var _loc4_:String = "model_" + this.var_947.name;
