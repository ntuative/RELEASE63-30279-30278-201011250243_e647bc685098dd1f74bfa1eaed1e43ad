package com.sulake.habbo.navigator.roomsettings
{
   ...
   public class RoomSettingsCtrl
   {
      ...
      private var var_359:IRoomSettingsCtrlOwner;
      ...
      private var var_640:TextFieldManager;
      ...
      private var var_978:TextFieldManager;
      
      private var var_982:ICheckBoxWindow;
      
      private var var_981:ICheckBoxWindow;
      
      private var var_977:ICheckBoxWindow;
      
      private var var_538:ICheckBoxWindow;
      ...
      private var var_980:IWindowContainer;
      ...
      {
         this.var_300 = param1;
         this._navigator.send(new GetRoomSettingsMessageComposer(this.var_300));
      ...
      public function onRoomSettings(param1:RoomSettingsData) : void
      {
         ...
         this._active = true;
         this.var_1512 = true;
         this.var_359.roomSettingsRefreshNeeded();
      }
      
      public function onFlatControllerAdded(param1:int, param2:FlatControllerData) : void
      {
         if(param1 != this.var_300)
         {
            return;
         }
      ...
      {
         if(param1 != this.var_300 || this.var_979 < 1)
         {
            return;
         }
         this.close();
      ...
      public function onRoomSettingsSaveError(param1:int, param2:int, param3:String) : void
      {
         ...
         {
            this.var_640.displayError("${navigator.roomsettings.roomnameismandatory}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1259)
         {
            this.var_640.displayError("${navigator.roomsettings.unacceptablewords}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1479)
         {
            this.var_975.displayError("${navigator.roomsettings.unacceptablewords}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1235)
         {
            this.setTagError(this.var_802,param3,"${navigator.roomsettings.unacceptablewords}");
            this.setTagError(this.var_801,param3,"${navigator.roomsettings.unacceptablewords}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1361)
         {
            this.setTagError(this.var_802,param3,"${navigator.roomsettings.nonuserchoosabletag}");
            this.setTagError(this.var_801,param3,"${navigator.roomsettings.nonuserchoosabletag}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1332)
         {
            this.var_800.displayError("${navigator.roomsettings.passwordismandatory}");
         }
         else
         {
            this.var_640.displayError("Update failed: error " + param2);
         }
      }
      ...
      private function prepareWindow(param1:IWindowContainer) : void
      {
         ...
         _loc2_.addEventListener(WindowEvent.const_519,this.onDoorModePasswordSelect);
         _loc2_.addEventListener(WindowEvent.const_742,this.onDoorModePasswordUnselect);
         ...
         this.var_640 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("room_name")),60);
         this.var_975 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("description")),255);
         this.var_802 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("tag1")),30);
         this.var_801 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("tag2")),30);
         this.var_800 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("password")),30);
         this.var_978 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("password_confirm")),30);
         this.var_982 = ICheckBoxWindow(this._window.findChildByName("allow_pets_checkbox"));
         this.var_981 = ICheckBoxWindow(this._window.findChildByName("allow_foodconsume_checkbox"));
         this.var_977 = ICheckBoxWindow(this._window.findChildByName("allow_walk_through_checkbox"));
         this.var_538 = ICheckBoxWindow(this._window.findChildByName("hide_walls_checkbox"));
         this.var_1509 = IWindowContainer(this._window.findChildByName("header_container"));
         this.var_1222 = IWindowContainer(this._window.findChildByName("thumbnail_container"));
         this.var_974 = IWindowContainer(this._window.findChildByName("basic_settings_container"));
         this.var_980 = IWindowContainer(this._window.findChildByName("advanced_settings_container"));
         this.var_1511 = IWindowContainer(this._window.findChildByName("switch_view_container"));
         this.var_1221 = IWindowContainer(this._window.findChildByName("footer_container"));
         this.var_222 = IWindowContainer(this._window.findChildByName("flat_controllers_container"));
         this.var_976 = IWindowContainer(this._window.findChildByName("password_container"));
         this.var_2028 = ITextWindow(this._window.findChildByName("basic_caption"));
         this.var_2027 = ITextWindow(this._window.findChildByName("advanced_caption"));
         this.var_1510 = ITextWindow(this._window.findChildByName("switch_view_text"));
         this.var_1510.procedure = this.onSwitchView;
         this.var_976.visible = false;
         if(!this._inRoom)
         {
      ...
      public function refresh(param1:IWindowContainer) : void
      {
         ...
         this.var_1509.visible = this._inRoom;
         this.var_1511.visible = this._inRoom;
         this.var_2027.visible = this.var_430;
         this.var_2028.visible = !this.var_430;
         if(this.var_430)
         {
            this.var_980.visible = true;
            this.var_1221.visible = false;
            this.refreshFlatControllers();
            this.var_980.height = Util.getLowestPoint(this.var_980) + 4;
         }
         else
         {
            this.populateForm();
            this.var_974.visible = true;
            this.var_1221.visible = true;
            this.var_1222.visible = this._inRoom;
            this._navigator.thumbRenderer.refreshThumbnail(IWindowContainer(this.var_1222.findChildByName("picframe")),this._navigator.data.enteredGuestRoom.thumbnail,false);
            this.var_974.height = Util.getLowestPoint(this.var_974) + 4;
         }
         this.var_1510.text = !!this.var_430 ? "${navigator.roomsettings.tobasicsettings}" : "${navigator.roomsettings.toadvancedsettings}";
         Util.moveChildrenToColumn(this._window,[this.var_1509.name,this.var_1222.name,this.var_974.name,this.var_980.name,this.var_1221.name,this.var_1511.name],0,0);
      ...
      private function populateForm() : void
      {
         ...
         this.var_640.setText(_loc1_.name);
         this.var_975.setText(_loc1_.description);
         this.var_800.setText("");
         this.var_978.setText("");
         ...
         this.setTag(this.var_802,_loc1_.tags[0]);
         this.setTag(this.var_801,_loc1_.tags[1]);
         if(this.var_982)
         {
            if(_loc1_.allowPets)
            {
         ...
         if(this.var_538)
         {
            ...
            {
               this.var_538.unselect();
            }
            _loc6_ = 1;
            _loc7_ = 16777215;
            if(!this.hideWallsAllowed())
            {
               this.var_538.disable();
               _loc6_ = 0.5;
               _loc7_ = 8421504;
            }
            else
      ...
      private function onSaveButtonClick(param1:WindowMouseEvent) : void
      {
         ...
         _loc2_.name = this.var_640.getText();
         _loc2_.description = this.var_975.getText();
         ...
         switch(_loc4_.name)
         {
            ...
            case "doormode_password":
               ...
               break;
            default:
               _loc2_.doorMode = RoomSettingsFlatInfo.const_400;
         }
         if(_loc2_.doorMode == RoomSettingsFlatInfo.const_116)
         {
            _loc8_ = this.var_800.getText();
            _loc9_ = this.var_978.getText();
            if(_loc8_ != _loc9_)
            {
               this.var_800.clearErrors();
               this.var_978.displayError("${navigator.roomsettings.invalidconfirm}");
               return;
            }
            if(_loc8_ != "")
            {
         ...
         _loc2_.allowFoodConsume = this.var_981.isSelected;
         _loc2_.allowWalkThrough = this.var_977.isSelected;
         _loc2_.hideWalls = this.var_538.isSelected;
         _loc2_.tags = new Array();
         this.addTag(this.var_802,_loc2_.tags);
         this.addTag(this.var_801,_loc2_.tags);
         this.clearErrors();
         this.var_979 = _loc2_.roomId;
      ...
      {
         Logger.log("[RoomSettingsCtrl.onDeleteButtonClick] " + this.var_300);
         this._navigator.registerParameter("navigator.roomsettings.deleteroom.confirm.message","room_name",this.var_73.name);
         var _loc2_:ConfirmDialogView = new ConfirmDialogView(IFrameWindow(this._navigator.getXmlWindow("ros_room_delete_confirm")),this,this.onConfirmRoomDelete,[this.var_300]);
         _loc2_.show();
      }
      ...
      private function onConfirmRoomDelete(param1:WindowMouseEvent, param2:int) : void
      {
         ...
         this._navigator.toolbar.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_143,HabboToolbarIconEnum.ROOMINFO));
      }
      ...
      {
         return IWindowContainer(this._navigator.windowManager.createWindow(param1,"",HabboWindowType.const_58,HabboWindowStyle.const_35,HabboWindowParam.const_59,new Rectangle(0,0,100,20)));
      }
      ...
      private function onRemoveAllFlatCtrlsClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this._navigator.send(new RemoveAllRightsMessageComposer(this.var_300));
      }
