package com.sulake.habbo.navigator
{
   ...
   public class PopupCtrl
   {
      ...
      public function showPopup(param1:IWindow) : void
      {
         if(this.var_48 == null)
         {
            this.var_48 = IWindowContainer(this._navigator.getXmlWindow(this.var_1337));
            this.var_48.visible = false;
            this.var_48.setParamFlag(HabboWindowParam.const_37,true);
         ...
         this.var_48.x = _loc2_.x + this.var_2206 + param1.width;
