package com.sulake.habbo.navigator.mainview
{
   ...
   public class MainViewCtrl implements IUpdateReceiver, IDisposable
   {
      ...
      private static const const_856:int = 1;
      
      private static const const_549:int = 2;
      
      private static const const_857:int = 3;
      
      private static const const_1206:int = 4;
      ...
      private var var_890:PopularTagsListCtrl;
      
      private var var_891:GuestRoomListCtrl;
      
      private var var_1104:OfficialRoomListCtrl;
      ...
      private var var_1105:IRegionWindow;
      ...
      public function MainViewCtrl(param1:HabboNavigator)
      {
         ...
         this.var_890 = new PopularTagsListCtrl(this._navigator);
         this.var_891 = new GuestRoomListCtrl(this._navigator);
         this.var_1104 = new OfficialRoomListCtrl(this._navigator);
         this.var_432 = new Timer(300,1);
         this.var_432.addEventListener(TimerEvent.TIMER,this.onResizeTimer);
      }
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            ...
            if(this.var_432)
            {
               this.var_432.removeEventListener(TimerEvent.TIMER,this.onResizeTimer);
               this.var_432.reset();
               this.var_432 = null;
            }
            if(this.var_890)
      ...
      private function prepare() : void
      {
         ...
         this.var_155 = IWindowContainer(this.var_16.findChildByName("tab_content"));
         ...
         this.var_244 = IWindowContainer(this.var_16.findChildByName("custom_footer"));
         this.var_1354 = this.var_16.findChildByName("loading_text");
         var _loc1_:IWindow = this.var_16.findChildByTag("close");
         _loc1_.procedure = this.onWindowClose;
         this.var_1105 = IRegionWindow(this.var_16.findChildByName("to_hotel_view"));
         if(!this.var_1105)
         {
            ErrorReportStorage.addDebugData("MainViewCtrl","prepare: _toHotelView is null!");
         }
         this.var_1105.procedure = this.onHotelView;
         ...
         this.var_16.scaler.setParamFlag(HabboWindowParam.const_1402,true);
      }
      ...
      public function refresh() : void
      {
         ...
         Util.moveChildrenToColumn(this.var_155,["custom_content","list_content"],this.var_205.y,8);
         this.var_183.height = this.var_183.height + _loc1_ - this.var_183.y - this.var_244.height + this.var_2417;
         Util.moveChildrenToColumn(this.var_155,["list_content","custom_footer"],this.var_183.y,0);
         this.var_2417 = this.var_244.height;
      ...
      {
         this.refreshList(param1,param2,this.var_890,"popular_tags");
      }
      
      private function refreshOfficialRooms(param1:Boolean, param2:Boolean) : void
      {
         this.refreshList(param1,param2,this.var_1104,"official_rooms");
      }
      ...
      public function update(param1:uint) : void
      {
         ...
         if(this.var_593 == const_856)
         {
            _loc3_ = Math.min(1,Math.max(0,this.var_183.blend - _loc2_));
            this.var_183.blend = _loc3_;
            this.var_205.blend = !!this.var_1103 ? Number(_loc3_) : Number(1);
            this.var_244.blend = !!this.var_1103 ? Number(_loc3_) : Number(1);
            if(_loc3_ == 0)
            {
               this.var_593 = const_549;
            }
         }
         else if(this.var_593 == const_549)
         {
            if(this.var_1355 % 10 == 1)
            {
               this.var_1354.visible = !this.var_1354.visible;
            }
            ++this.var_1355;
            if(!this._navigator.data.isLoading())
            {
               this.var_593 = const_857;
            }
         }
         else if(this.var_593 == const_857)
         {
            this.refresh();
            this.var_593 = const_1206;
         }
         else
         {
      ...
      {
         this.refreshScrollbar(this.var_890);
      ...
      {
         this._navigator.refreshButton(this.var_1105,"icon_hotelview",!param1,null,0);
         this._navigator.refreshButton(this.var_1105,"icon_hotelview_reactive",param1,null,0);
      }
