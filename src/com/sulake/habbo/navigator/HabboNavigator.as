package com.sulake.habbo.navigator
{
   ...
   public class HabboNavigator extends Component implements IHabboNavigator
   {
      ...
      private var var_539:RoomInfoViewCtrl;
      
      private var var_983:RoomCreateViewCtrl;
      
      private var _data:NavigatorData;
      
      private var var_386:Tabs;
      
      private var _assetLibrary:IAssetLibrary;
      
      private var var_2646:Dictionary;
      ...
      private var var_2039:RoomThumbnailRenderer;
      
      private var var_800:GuestRoomPasswordInput;
      
      private var var_324:GuestRoomDoorbell;
      ...
      public function HabboNavigator(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_260 = new MainViewCtrl(this);
         this.var_539 = new RoomInfoViewCtrl(this);
         this.var_983 = new RoomCreateViewCtrl(this);
         this.var_2039 = new RoomThumbnailRenderer(this);
         this.var_800 = new GuestRoomPasswordInput(this);
         this.var_324 = new GuestRoomDoorbell(this);
         this.var_386 = new Tabs(this);
      ...
      public function getButton(param1:String, param2:String, param3:Function, param4:int = 0, param5:int = 0, param6:int = 0) : IBitmapWrapperWindow
      {
         ...
         var _loc8_:IBitmapWrapperWindow = IBitmapWrapperWindow(this._windowManager.createWindow(param1,"",HabboWindowType.const_295,HabboWindowStyle.const_38,0 | 0,new Rectangle(param4,param5,_loc7_.width,_loc7_.height),param3,param6));
      ...
      private function onToolbarReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_539.registerToolbarEvents();
      }
      ...
      public function animateWindowOpen(param1:IWindowContainer) : void
      {
         ...
         {
            this._toolbar.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_51,HabboToolbarIconEnum.NAVIGATOR,param1));
         }
      }
      ...
      {
         var _loc1_:Boolean = this.var_260.onNavigatorToolBarIconClick();
         if(_loc1_)
         {
      ...
      public function performTagSearch(param1:String) : void
      {
         ...
         this.var_260.startSearch(Tabs.const_252,Tabs.const_312,param1);
         this.var_260.mainWindow.activate();
      }
      ...
      public function showOwnRooms() : void
      {
         ...
         this.var_260.startSearch(Tabs.const_298,Tabs.const_198);
         this.var_386.getTab(Tabs.const_298).tabPageDecorator.tabSelected();
      }
