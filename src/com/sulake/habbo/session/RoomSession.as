package com.sulake.habbo.session
{
   ...
   public class RoomSession implements IRoomSession
   {
      ...
      private const const_1778:int = 2500;
      ...
      private var var_953:UserDataManager;
      ...
      public function RoomSession(param1:int, param2:int, param3:IHabboTracking, param4:String = "", param5:String = "")
      {
         ...
         this.var_953 = new UserDataManager();
      }
      ...
      public function set connection(param1:IConnection) : void
      {
         ...
         {
            this.var_953.connection = param1;
         }
      }
      ...
      {
         this._connection.send(new ChatMessageComposer(param1,this.var_1199));
         this.var_1200.add(this.var_1199,getTimer());
         ++this.var_1199;
      }
      
      public function receivedChatWithTrackingId(param1:int) : void
      {
         var _loc2_:Object = this.var_1200.remove(param1);
         if(_loc2_ != null)
         {
            if(getTimer() - int(_loc2_) > this.const_1778)
            {
      ...
      public function method_19(param1:int) : void
      {
      ...
      {
         return this.var_953 as IUserDataManager;
      }
