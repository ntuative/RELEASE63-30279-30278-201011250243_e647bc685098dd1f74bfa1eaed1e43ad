package com.sulake.room.renderer.utils
{
   ...
   public class ExtendedSprite extends Bitmap
   {
      ...
      {
         if(param1 != this.var_1549 || param2 != this.var_1550)
         {
      ...
      {
         if(this.var_1245 > 255 || bitmapData == null)
         {
            return false;
         }
