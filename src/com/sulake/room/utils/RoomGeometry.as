package com.sulake.room.utils
{
   ...
   public class RoomGeometry implements IRoomGeometry
   {
      ...
      public static const const_791:Number = 64;
      ...
      private var var_364:Number = 1.0;
      
      private var var_365:Number = 1.0;
      
      private var var_366:Number = 1.0;
      
      private var var_1520:Number = 1.0;
      
      private var var_1521:Number = 1.0;
      
      private var var_1519:Number = 1.0;
      
      private var var_74:Vector3d;
      
      private var var_223:Vector3d;
      
      private var var_2611:Number = -500.0;
      
      private var var_2610:Number = 500.0;
      ...
      public function RoomGeometry(param1:Number, param2:IVector3d, param3:IVector3d, param4:IVector3d = null)
      {
         ...
         this.var_987 = new Vector3d();
         this.var_1520 = 1;
         this.var_1521 = 1;
         this.x_scale = 1;
         this.y_scale = 1;
         this.var_1519 = Math.sqrt(0.5) / Math.sqrt(0.75);
         this.z_scale = 1;
      ...
      {
         return new Vector3d(this.var_74.x * this.var_364,this.var_74.y * this.var_365,this.var_74.z * this.var_366);
      }
      
      public function get direction() : IVector3d
      {
         return new Vector3d(this.var_223.x,this.var_223.y,this.var_223.z);
      }
      
      public function set x_scale(param1:Number) : void
      {
         if(this.var_364 != param1 * this.var_1520)
         {
            this.var_364 = param1 * this.var_1520;
            ++this.var_133;
         }
      }
      ...
      {
         if(this.var_365 != param1 * this.var_1521)
         {
            this.var_365 = param1 * this.var_1521;
            ++this.var_133;
         }
      }
      ...
      {
         if(this.var_366 != param1 * this.var_1519)
         {
            this.var_366 = param1 * this.var_1519;
            ++this.var_133;
         }
      }
      ...
      public function set location(param1:IVector3d) : void
      {
         ...
         this.var_74.x /= this.var_364;
         this.var_74.y /= this.var_365;
         this.var_74.z /= this.var_366;
      ...
      public function set direction(param1:IVector3d) : void
      {
         ...
         var _loc2_:Number = this.var_223.x;
         var _loc3_:Number = this.var_223.y;
         var _loc4_:Number = this.var_223.z;
         this.var_223.assign(param1);
         if(this.var_223.x != _loc2_ || this.var_223.y != _loc3_ || this.var_223.z != _loc4_)
         {
            ++this.var_133;
         }
      ...
      public function setDepthVector(param1:IVector3d) : void
      {
         ...
         if(_loc7_ != 0)
         {
            ...
            this.var_987.assign(_loc22_);
         }
         else
         {
            this.var_987.assign(_loc17_);
         }
         ++this.var_133;
      }
      ...
      public function getScreenPosition(param1:IVector3d) : IVector3d
      {
         ...
         _loc2_.x *= this.var_364;
         _loc2_.y *= this.var_365;
         _loc2_.z *= this.var_366;
         var _loc3_:Number = Vector3d.scalarProjection(_loc2_,this.var_987);
         if(_loc3_ < this.var_2611 || _loc3_ > this.var_2610)
         {
            return null;
         }
         ...
         if(_loc6_ != null)
         {
            ...
            _loc2_.y *= this.var_365;
            _loc2_.z *= this.var_366;
            _loc3_ = Vector3d.scalarProjection(_loc2_,this.var_987);
         }
      ...
      public function getPlanePosition(param1:Point, param2:IVector3d, param3:IVector3d, param4:IVector3d) : Point
      {
         ...
         var _loc8_:Vector3d = new Vector3d(this.var_74.x * this.var_364,this.var_74.y * this.var_365,this.var_74.z * this.var_366);
         var _loc9_:IVector3d = Vector3d.sum(_loc8_,_loc7_);
         var _loc10_:IVector3d = this.var_167;
         var _loc11_:Vector3d = new Vector3d(param2.x * this.var_364,param2.y * this.var_365,param2.z * this.var_366);
         var _loc12_:Vector3d = new Vector3d(param3.x * this.var_364,param3.y * this.var_365,param3.z * this.var_366);
         var _loc13_:Vector3d = new Vector3d(param4.x * this.var_364,param4.y * this.var_365,param4.z * this.var_366);
      ...
      public function performZoom() : void
      {
         ...
         {
            this.scale = const_791;
         }
      }
      
      public function isZoomedIn() : Boolean
      {
         return this.scale == const_791;
      }
