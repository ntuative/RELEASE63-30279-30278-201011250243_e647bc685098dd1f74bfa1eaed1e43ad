   ...
   public class RoomInstance implements IRoomInstance
   {
      ...
      public function dispose() : void
      {
         ...
         if(this.var_243 != null)
         {
            ...
            {
               _loc3_ = this.var_243.getWithIndex(_loc2_) as IRoomObjectManager;
               if(_loc3_ != null)
               {
                  _loc3_.dispose();
               }
      ...
      public function setNumber(param1:String, param2:Number, param3:Boolean = false) : void
      {
         ...
         if(this.var_591[param1] != param2)
         {
            this.var_591[param1] = param2;
         }
      }
      ...
      {
         if(this.var_1353.indexOf(param1) >= 0)
         {
            return;
         }
         if(param3)
         {
            this.var_1353.push(param1);
         }
      ...
      {
         return this.var_243.getKeys();
      }
      
      protected function createObjectManager(param1:int) : IRoomObjectManager
      {
         var _loc2_:String = String(param1);
         if(this.var_243.getValue(_loc2_) != null)
         {
            return this.var_243.getValue(_loc2_) as IRoomObjectManager;
         }
         if(this._container == null)
         {
            return null;
         ...
         if(_loc3_ != null)
         {
            this.var_243.add(_loc2_,_loc3_);
         }
         return _loc3_;
      }
      ...
      {
         return this.var_243.getValue(String(param1)) as IRoomObjectManager;
      }
      ...
      protected function disposeObjectManager(param1:int) : Boolean
      {
         ...
         if(this.var_243.getValue(_loc2_) != null)
         {
            _loc3_ = this.var_243.remove(_loc2_) as IRoomObjectManager;
            if(_loc3_ != null)
            {
               _loc3_.dispose();
            }
