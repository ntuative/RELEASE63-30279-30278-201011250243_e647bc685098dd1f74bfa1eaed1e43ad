package com.sulake.core.window.graphics.renderer
{
   ...
   public class SkinRenderer implements ISkinRenderer
   {
      ...
      protected var var_501:Dictionary;
      ...
      public function dispose() : void
      {
         ...
         if(!this._disposed)
         {
            for(_loc1_ in this.var_501)
            {
               ISkinLayout(this.var_501[_loc1_]).dispose();
               delete this.var_501[_loc1_];
            }
            this.var_501 = null;
            this.var_402 = null;
            for(_loc1_ in this.var_341)
            {
               ISkinTemplate(this.var_341[_loc1_]).dispose();
      ...
      {
         var _loc3_:ISkinLayout = this.var_501[param2];
         if(_loc3_ == null)
         {
      ...
      {
         var _loc3_:ISkinTemplate = this.var_341[param2];
         if(_loc3_ == null)
         {
      ...
      {
         this.var_501[param1.name] = param1;
         return param1;
      }
      
      public function getLayoutByName(param1:String) : ISkinLayout
      {
         return this.var_501[param1];
      }
      ...
      public function removeLayout(param1:ISkinLayout) : ISkinLayout
      {
         var _loc2_:* = null;
         var _loc3_:* = 0;
         param1 = this.var_341[param1.name];
         if(param1 != null)
         {
            ...
            delete this.var_501[param1.name];
         }
         return param1;
      }
      ...
      {
         this.var_341[param1.name] = param1;
         return param1;
      }
      ...
      public function removeTemplate(param1:ISkinTemplate) : ISkinTemplate
      {
         ...
         if(param1 != null)
         {
            ...
            delete this.var_341[param1.name];
         }
         return param1;
      }
   }
