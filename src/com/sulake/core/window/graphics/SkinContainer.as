package com.sulake.core.window.graphics
{
   ...
   public class SkinContainer implements ISkinContainer
   {
      ...
      private static const const_818:uint = 8;
      
      private static const const_1151:String = "skin";
      
      private static const const_1149:String = "bitmap";
      
      private static const const_1148:String = "fill";
      
      private static const const_1145:String = "text";
      
      private static const const_1146:String = "shape";
      
      private static const const_1150:String = "unknown";
      
      private static const const_1147:String = "null";
      ...
      public function SkinContainer(param1:XML, param2:IAssetLibrary)
      {
         ...
         TypeCodeTable.fillTables(this.var_1486,this.var_1991);
         this.var_1990 = new Dictionary();
         this.var_1989 = new Dictionary();
         StateCodeTable.fillTables(this.var_1990,this.var_1989);
         this.var_426 = new Dictionary();
         this.var_426[const_1151] = BitmapSkinRenderer;
         this.var_426[const_1149] = BitmapDataRenderer;
         this.var_426[const_1148] = FillSkinRenderer;
         this.var_426[const_1145] = TextSkinRenderer;
         this.var_426[const_1146] = ShapeSkinRenderer;
         this.var_426[const_1150] = SkinRenderer;
         this.var_426[const_1147] = NullSkinRenderer;
         if(var_286 == null)
         {
            var_286 = new Array();
            var_286.push(WindowState.const_65);
            var_286.push(WindowState.const_76);
            var_286.push(WindowState.const_86);
            var_286.push(WindowState.const_50);
            var_286.push(WindowState.WINDOW_STATE_HOVERING);
            var_286.push(WindowState.const_77);
            var_286.push(WindowState.const_98);
            var_286.push(WindowState.const_91);
         }
         if(param1 != null)
         {
            ...
            if(_loc4_ > 0)
            {
               ...
               while(_loc18_ < _loc4_)
               {
                  ...
                  this.addSkinRenderer(this.var_1486[_loc7_],uint(_loc8_),_loc14_,_loc17_);
                  _loc18_++;
               }
            }
         }
      ...
      {
         if(this.var_789[param1] == null)
         {
            this.var_789[param1] = new Array(const_818);
         }
         this.var_789[param1][param2] = param3;
         if(this.var_788[param1] == null)
         {
            this.var_788[param1] = new Array(const_818);
         }
         this.var_788[param1][param2] = param4;
      }
      
      public function getSkinRendererByTypeAndStyle(param1:uint, param2:uint) : ISkinRenderer
      {
         var _loc4_:* = null;
         var _loc3_:Array = this.var_789[param1];
         if(_loc3_)
         {
            _loc4_ = _loc3_[param2];
            if(!_loc4_ && param2 != WindowStyle.const_292)
            {
               _loc4_ = _loc3_["null"];
            }
         }
      ...
      {
         var _loc4_:* = null;
         var _loc3_:Array = this.var_788[param1];
         if(_loc3_)
         {
            _loc4_ = _loc3_[param2];
            if(!_loc4_ && param2 != WindowStyle.const_292)
