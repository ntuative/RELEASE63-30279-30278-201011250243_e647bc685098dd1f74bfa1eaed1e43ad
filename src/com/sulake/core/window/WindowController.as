package com.sulake.core.window
{
   ...
   public class WindowController extends WindowModel implements IWindow, IGraphicContextHost
   {
      ...
      protected static const const_1100:String = "_COLORIZE";
      
      protected static const const_1495:String = "_IGNORE_INHERITED_STYLE";
      
      private static var var_1238:Point = new Point();
      ...
      protected var var_751:Function;
      ...
      public function WindowController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function = null, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         ...
         if(_loc12_ != null)
         {
            var_342 = new Rectangle(0,0,int(_loc12_.attribute("width")),int(_loc12_.attribute("height")));
            var_55 = var_342.clone();
            var_11 = var_342.clone();
         ...
         if(_loc13_)
         {
            var_684 = _loc13_.blend;
            var_403 = _loc13_.treshold;
            if(var_502 != _loc13_.background)
            {
               this.background = _loc13_.background;
            }
            if(var_404 != _loc13_.color)
            {
      ...
      {
         return this.var_751 != null ? this.var_751 : (this.var_13 != null ? this.var_13.procedure : this.nullEventProc);
      }
      ...
      {
         var_502 = param1;
         var_404 = !!var_502 ? uint(var_404 | var_1149) : uint(var_404 & 16777215);
      ...
      {
         var_1149 = param1 & 4278190080;
         var_404 = !!var_502 ? uint(param1) : uint(param1 & 16777215);
         var_17.invalidate(this,var_11,WindowRedrawFlag.const_81);
      }
      
      public function set blend(param1:Number) : void
      {
         var_684 = param1 > 1 ? 1 : (param1 < 0 ? 0 : Number(param1));
         var_17.invalidate(this,var_11,WindowRedrawFlag.const_1032);
      }
      ...
      {
         var_403 = param1 > 255 ? 255 : uint(param1);
      }
      ...
      public function set parent(param1:IWindow) : void
      {
         ...
         if(this.var_13 != param1)
         {
            ...
            if(this.var_13 != null)
            {
               this.var_301 = this.var_13.rectangle.clone();
               var_55.x = var_11.x;
               var_55.y = var_11.y;
               var_55.width = var_11.width;
               var_55.height = var_11.height;
               this.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_421,this,this.var_13));
            }
            else
            {
               this.var_301.x = 0;
               this.var_301.y = 0;
               this.var_301.width = 0;
               this.var_301.height = 0;
               this.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_957,this,_loc2_));
            }
         }
      }
      ...
      public function clone() : IWindow
      {
         ...
         var _loc2_:WindowController = new _loc1_(_name,_type,var_77,_param,var_17,var_11,null,this.var_751,this.properties,var_754.concat(),_id) as WindowController;
         _loc2_.var_403 = var_403;
         _loc2_.var_149 = this.var_149;
         _loc2_._debug = this._debug;
         _loc2_.var_301 = this.var_301.clone();
         _loc2_.var_11 = var_11.clone();
         _loc2_.var_342 = var_342.clone();
      ...
      {
         return "[Window " + getQualifiedClassName(this) + " " + this.var_2069 + "]";
      }
      ...
      override public function invalidate(param1:Rectangle = null) : void
      {
         ...
         var_17.invalidate(this,param1,WindowRedrawFlag.const_81);
      }
      ...
      public function setRectangle(param1:int, param2:int, param3:int, param4:int) : void
      {
         ...
         if(_loc6_ && !_loc5_)
         {
            ...
            if(_loc7_ == WindowParam.const_440)
            {
               param1 -= (param3 - 0) / 2;
               _loc5_ = true;
            }
         ...
         if(_loc5_ || _loc6_)
         {
            if(_loc5_)
            {
               _loc9_ = new WindowNotifyEvent(WindowNotifyEvent.const_953,this,null,true);
            ...
            if(_loc6_)
            {
               _loc9_ = new WindowNotifyEvent(WindowNotifyEvent.const_583,this,null,true);
               this.update(this,_loc9_);
               if(_loc9_.isWindowOperationPrevented())
               {
                  _loc6_ = false;
      ...
      public function getRegionProperties(param1:Rectangle = null, param2:Rectangle = null, param3:Rectangle = null, param4:Rectangle = null) : void
      {
         ...
         if(param3 != null && var_127 != null)
         {
            param3.x = var_127.x;
            param3.y = var_127.y;
            param3.width = var_127.width;
            param3.height = var_127.height;
         }
      ...
      public function setRegionProperties(param1:Rectangle = null, param2:Rectangle = null, param3:Rectangle = null) : void
      {
         ...
         if(param2 != null)
         {
            ...
            var_127.x = param2.x;
            var_127.y = param2.y;
            var_127.width = param2.width;
            var_127.height = param2.height;
         }
      ...
      public function update(param1:WindowController, param2:Event) : Boolean
      {
         ...
         var _loc8_:* = null;
         var _loc9_:* = 0;
         if(!testParamFlag(WindowParam.const_638))
         {
         ...
         if(param2 is WindowMouseEvent)
         {
            switch(param2.type)
            {
               case WindowMouseEvent.const_39:
                  ...
                  _loc4_.areaLimit = MouseListenerType.const_1059;
         ...
         if(param2 is WindowNotifyEvent)
         {
            switch(param2.type)
            {
               case WindowNotifyEvent.const_165:
                  ...
                  if(param1 == this)
                  {
                     this.notifyChildren(new WindowNotifyEvent(WindowNotifyEvent.const_422,this,null));
                     if(testParamFlag(WindowParam.const_178,WindowParam.const_148))
                     {
                        this.updateScaleRelativeToParent();
                     }
                     else if(testParamFlag(WindowParam.const_170,WindowParam.const_158))
                     {
                        this.updateScaleRelativeToParent();
                     }
                     if(this.var_13 != null)
                     {
                        ...
                        if(testParamFlag(WindowParam.const_454))
                        {
               ...
               case WindowNotifyEvent.const_515:
                  var_17.invalidate(this,var_11.union(var_55),WindowRedrawFlag.const_449);
                  if(param1 == this)
                  {
                     this.notifyChildren(new WindowNotifyEvent(WindowNotifyEvent.const_910,this,null));
                     if(this.var_13 != null)
                     {
                        this.var_13.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_271,this.var_13,this));
                     }
                  }
                  break;
               case WindowNotifyEvent.const_339:
                  if(param1 == this)
                  {
                     this.notifyChildren(new WindowNotifyEvent(WindowNotifyEvent.const_694,this,null));
                     if(this.var_13 != null)
                     {
                        this.var_13.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_199,this.var_13,this));
                     }
                  }
                  break;
               case WindowNotifyEvent.const_531:
                  var_17.invalidate(this,var_11,WindowRedrawFlag.const_997);
                  break;
               ...
               case WindowNotifyEvent.const_398:
                  if(!(_param & 0))
                  {
                     if(!this.var_20)
                     {
                        ...
                        var_17.invalidate(this,var_11,WindowRedrawFlag.const_449);
                     }
                  }
                  else if(_param & 0)
                  {
               ...
               case WindowNotifyEvent.const_422:
                  this.var_13.getRegionProperties(null,this.var_301);
                  this.updateScaleRelativeToParent();
                  break;
      ...
      protected function forwardNotifyEvent(param1:WindowNotifyEvent) : WindowEvent
      {
         ...
         switch(param1.type)
         {
            ...
            case WindowNotifyEvent.const_1074:
               _loc2_ = "null";
               break;
            case WindowNotifyEvent.const_1478:
               _loc2_ = "null";
               _loc4_ = true;
               break;
            ...
            case WindowNotifyEvent.const_893:
               ...
               _loc4_ = true;
               break;
            case WindowNotifyEvent.const_594:
               _loc2_ = "null";
               break;
      ...
      {
         return this.testLocalPointHitAgainstAlpha(param1,param2,var_403);
      }
      ...
      public function validateGlobalPointIntersection(param1:Point, param2:BitmapData) : Boolean
      {
         ...
         return this.testLocalPointHitAgainstAlpha(_loc3_,param2,var_403);
      }
         ...
         if(this.var_149 && var_403 > 0)
         {
            if(!testParamFlag(WindowParam.const_31))
            {
               if(param1.x <= var_11.width && param1.y <= var_11.height)
               {
                  ...
                  if(_loc5_ != null)
                  {
                     _loc4_ = _loc5_.hitTest(var_1238,param3,param1);
                  }
               }
            }
            else
            {
               _loc4_ = param2 != null ? Boolean(param2.hitTest(var_1238,param3,param1)) : false;
            }
         }
      ...
      protected function updateScaleRelativeToParent() : void
      {
         ...
         var _loc1_:* = !testParamFlag(WindowParam.const_133,WindowParam.const_148);
         var _loc2_:* = !testParamFlag(WindowParam.const_125,WindowParam.const_158);
         if(_loc1_ || _loc2_)
         {
            _loc3_ = var_11.clone();
            if(_loc1_)
            {
               _loc4_ = this.var_13.width - this.var_301.width;
            ...
            if(_loc2_)
            {
               _loc4_ = this.var_13.height - this.var_301.height;
               _loc5_ = uint(_param & 0);
               if(_loc5_ == WindowParam.const_362)
               {
      ...
      {
         if(_state == WindowState.const_463)
         {
            return true;
         }
         _state = WindowState.const_463;
      ...
      public function enable() : Boolean
      {
         ...
         _loc1_.type = WindowNotifyEvent.const_563;
         this.update(this,_loc1_);
         return true;
      }
      ...
      public function disable() : Boolean
      {
         ...
         _loc1_.type = WindowNotifyEvent.const_594;
         this.update(this,_loc1_);
         return true;
      }
      ...
      public function addChild(param1:IWindow) : IWindow
      {
         ...
         _loc2_.parent = this;
         if(this.var_1237 || _loc2_.hasGraphicsContext())
         {
            this.setupGraphicsContext();
         ...
         this.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_313,this,param1));
         return param1;
      }
      ...
      public function addChildAt(param1:IWindow, param2:int) : IWindow
      {
         ...
         _loc3_.parent = this;
         if(this.var_1237 || _loc3_.hasGraphicsContext())
         {
            this.setupGraphicsContext();
      ...
      public function removeChild(param1:IWindow) : IWindow
      {
         ...
         this.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_568,this,param1));
         return param1;
      }
