package com.sulake.core.window.utils
{
   ...
   public class TextStyleManager
   {
      ...
      public static const const_335:String = "regular";
      ...
      private static var var_212:IEventDispatcher;
      ...
      private static function init() : void
      {
         var _loc1_:* = null;
         var_82 = new Map();
         var_212 = new EventDispatcher();
         _loc1_ = new TextStyle();
         _loc1_.name = const_335;
         _loc1_.color = 0;
         _loc1_.fontSize = "9";
      ...
      public static function setStyle(param1:String, param2:TextStyle) : void
      {
         ...
         if(_loc3_)
         {
            var_212.dispatchEvent(new Event(Event.ADDED));
         }
         else
         {
            var_212.dispatchEvent(new Event(Event.CHANGE));
         }
      }
      ...
      public static function setStyles(param1:Array, param2:Boolean = false) : void
      {
         ...
         if(param2)
         {
            _loc5_ = [var_82[const_335],var_82[ITALIC],var_82[BOLD]];
            var_82.reset();
            var_82[const_335] = _loc5_[0];
