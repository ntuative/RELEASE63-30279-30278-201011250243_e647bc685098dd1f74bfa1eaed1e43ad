package com.sulake.core.window.utils
{
   ...
   public class WindowParser implements IWindowParser
   {
      ...
      public static const const_1034:String = "_EXCLUDE";
      
      public static const const_1769:String = "_INCLUDE";
      
      public static const const_1746:String = "_TEMP";
      
      private static const const_1179:RegExp = /^(\s|\n|\r|\t|\v)*/m;
      
      private static const const_1180:RegExp = /(\s|\n|\r|\t|\v)*$/;
      ...
      public function WindowParser(param1:IWindowContext)
      {
         ...
         TypeCodeTable.fillTables(this._typeStringToCodeTable,this.var_1155);
         this.var_923 = new Dictionary();
         this.var_1398 = new Dictionary();
         ParamCodeTable.fillTables(this.var_923,this.var_1398);
         this.var_1865 = new Map();
      }
      
      private static function trimWhiteSpace(param1:String) : String
      {
         param1 = param1.replace(const_1180,"");
         return param1.replace(const_1179,"");
      }
      ...
      public function windowToXMLString(param1:IWindow) : String
      {
         ...
         var _loc2_:String = "";
         var _loc3_:String = this.var_1155[param1.type];
         ...
         if(_loc7_ is IIterable)
         {
            ...
            if(_loc9_ > 0)
            {
               ...
               while(_loc12_ < _loc9_)
               {
                  ...
                  if(_loc10_.tags.indexOf(WindowParser.const_1034) == -1)
                  {
