package com.sulake.core.window.utils
{
   ...
   public class MouseEventProcessor implements IEventProcessor, IDisposable
   {
      ...
      protected static function convertMouseEventType(param1:MouseEvent, param2:IWindow, param3:IWindow) : WindowMouseEvent
      {
         ...
         switch(param1.type)
         {
            ...
            case MouseEvent.MOUSE_UP:
               ...
               _loc4_ = !!_loc6_ ? "null" : WindowMouseEvent.const_162;
               break;
      ...
      public function process(param1:EventProcessorState, param2:IEventQueue) : void
      {
         ...
         var _loc6_:* = null;
         var _loc8_:* = null;
         this.var_128 = param1.desktop;
         this.var_78 = param1.var_1142 as WindowController;
         this._lastClickTarget = param1.var_1143 as WindowController;
         this.var_144 = param1.renderer;
         this.var_758 = param1.var_1145;
         param2.begin();
         ...
         while(true)
         {
            ...
            if(_loc3_.stageX != this.var_615.x || _loc3_.stageY != this.var_615.y)
            {
               this.var_615.x = _loc3_.stageX;
               this.var_615.y = _loc3_.stageY;
               _loc6_ = new Array();
               this.var_128.groupParameterFilteredChildrenUnderPoint(this.var_615,_loc6_,WindowParam.const_45);
            }
            ...
            if(_loc4_ == 0)
            {
               ...
               {
                  if(this.var_78 != this.var_128 && !this.var_78.disposed)
                  {
                     ...
                     this.var_78 = WindowController(this.var_128);
                  }
               }
            }
            while(--_loc4_ > -1)
               ...
               if(_loc5_ != null && _loc5_.visible)
               {
                  ...
                  else if(_loc3_.type == MouseEvent.MOUSE_UP || _loc3_.type == MouseEvent.CLICK)
                  {
                     if(this.var_78 && !this.var_78.disposed)
                     {
                        ...
                        {
                           this.var_758.mouseEventReceived(_loc3_.type,this.var_78);
                        }
                     }
                  }
         ...
         param2.end();
         param1.desktop = this.var_128;
         param1.var_1142 = this.var_78;
         param1.var_1143 = this._lastClickTarget;
         param1.renderer = this.var_144;
         param1.var_1145 = this.var_758;
      }
      ...
      private function passMouseEvent(param1:WindowController, param2:MouseEvent, param3:Boolean = false) : WindowController
      {
         ...
         if(param1.testParamFlag(WindowParam.const_426))
         {
