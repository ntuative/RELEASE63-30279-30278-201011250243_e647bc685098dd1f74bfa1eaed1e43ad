package com.sulake.core.window.components
{
   ...
   public class TextController extends WindowController implements ITextWindow, ITextFieldContainer, ILocalizable
   {
      ...
      protected static const const_1099:Dictionary = method_14();
      
      protected static const ZERO_RECT:Rectangle = new Rectangle();
      
      protected static const const_1491:Array = [AntiAliasType.ADVANCED,AntiAliasType.NORMAL];
      
      protected static const const_1490:Array = [GridFitType.PIXEL,GridFitType.NONE,GridFitType.SUBPIXEL];
      
      protected static const const_1492:Array = [TextFieldAutoSize.NONE,TextFieldAutoSize.LEFT,TextFieldAutoSize.RIGHT,TextFieldAutoSize.CENTER];
      ...
      public function TextController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         ...
         setTextFormatting(this._field,this.var_356,this.var_221);
      ...
      private static function method_7(param1:TextController, param2:Boolean) : void
      {
         var _loc3_:TextFormat = param1.defaultTextFormat;
      ...
      private static function setTextStyle(param1:TextController, param2:TextStyle) : void
      {
         ...
         if(_loc3_)
         {
            param1.var_356 = _loc3_.name;
            setTextFormatting(param1._field,param1.var_356,param1.var_221);
            param1.refreshTextImage();
         }
      }
      ...
      protected static function setTextFormatting(param1:TextField, param2:String, param3:TextStyle) : void
      {
         ...
         if(!_loc4_)
         {
            _loc4_ = TextStyleManager.getStyle(TextStyleManager.const_335);
         }
         ...
         {
            _loc5_.underline = _loc4_.textDecoration == TextStyle.const_890 ? true : null;
         }
      ...
      protected static function method_14() : Dictionary
      {
      ...
      {
         return TextStyleManager.getStyle(this.var_356);
      }
      ...
      {
         this.var_750 = param1;
         this._field.scrollH = this.var_750 * Number(this._field.maxScrollH);
      ...
      {
         return new Rectangle(this.var_750 * this.maxScrollH,this.var_498 * this.maxScrollV,width,height);
      }
      ...
      protected function refreshTextImage() : void
      {
         ...
         if(_loc5_ != _loc3_)
         {
            if(this.var_401 == TextFieldAutoSize.LEFT)
            {
               setRectangle(var_11.x,var_11.y,_loc5_ + _loc1_,Math.floor(this._field.height) + _loc2_);
               _loc6_ = true;
            }
            else if(this.var_401 == TextFieldAutoSize.RIGHT)
            {
               setRectangle(var_11.x,var_11.y,_loc5_ + _loc1_,Math.floor(this._field.height) + _loc2_);
               _loc6_ = true;
            }
            else if(this.var_401 != TextFieldAutoSize.CENTER)
            {
         ...
         {
            if(this.var_401 != TextFieldAutoSize.NONE)
            {
               setRectangle(var_11.x,var_11.y,_loc5_ + _loc1_,Math.floor(this._field.height) + _loc2_);
               _loc6_ = true;
            }
      ...
      override public function get properties() : Array
      {
         ...
         var _loc2_:Object = TextStyleManager.getStyle(this.var_356);
         _loc1_.push(new PropertyStruct("font_face",this.defaultTextFormat.font,PropertyStruct.const_92,this.defaultTextFormat.font != _loc2_.fontFamily));
         ...
         _loc1_.push(new PropertyStruct("text_color",this._field.textColor,PropertyStruct.const_180,this._field.textColor != _loc2_.color));
         _loc1_.push(new PropertyStruct("antialias_type",this._field.antiAliasType,PropertyStruct.const_92,this._field.antiAliasType != AntiAliasType.ADVANCED,const_1491));
         ...
         _loc1_.push(new PropertyStruct("border_color",this._field.borderColor,PropertyStruct.const_180,this._field.borderColor != 0));
         ...
         _loc1_.push(new PropertyStruct("grid_fit_type",this._field.gridFitType,PropertyStruct.const_92,this._field.gridFitType != GridFitType.PIXEL,const_1490));
         ...
         _loc1_.push(new PropertyStruct("restrict",this._field.restrict,PropertyStruct.const_92,this._field.restrict != null));
         _loc1_.push(new PropertyStruct("sharpness",this._field.sharpness,PropertyStruct.const_218,this._field.sharpness != 0));
         _loc1_.push(new PropertyStruct("text_style",this.var_356,PropertyStruct.const_92,this.var_356 != TextStyleManager.const_335,STYLE_SHEET_RANGE));
         _loc1_.push(new PropertyStruct("thickness",this._field.thickness,PropertyStruct.const_218,this._field.thickness != 0));
         _loc1_.push(new PropertyStruct("word_wrap",this._field.wordWrap,PropertyStruct.const_55,this._field.wordWrap != false));
         _loc1_.push(new PropertyStruct("margin_left",this.var_76.left,PropertyStruct.const_54,this.var_76.left != 0));
         _loc1_.push(new PropertyStruct("margin_top",this.var_76.top,PropertyStruct.const_54,this.var_76.top != 0));
         _loc1_.push(new PropertyStruct("margin_right",this.var_76.right,PropertyStruct.const_54,this.var_76.right != 0));
         _loc1_.push(new PropertyStruct("margin_bottom",this.var_76.bottom,PropertyStruct.const_54,this.var_76.bottom != 0));
         _loc1_.push(new PropertyStruct("auto_size",this.var_401,PropertyStruct.const_92,this.var_401 != TextFieldAutoSize.NONE,const_1492));
         ...
         _loc1_.push(new PropertyStruct("spacing",this._field.defaultTextFormat.letterSpacing,PropertyStruct.const_218,this._field.defaultTextFormat.letterSpacing != 0));
         return _loc1_;
      }
   }
}
