package com.sulake.core.window.components
{
   ...
   public class ScrollableItemListWindow extends WindowController implements IScrollableListWindow
   {
      ...
      private var var_1565:Boolean = true;
      ...
      override public function dispose() : void
      {
         if(this.var_375)
         {
            this.var_375.removeEventListener(WindowEvent.const_272,this.scrollBarEventProc);
            this.var_375.removeEventListener(WindowEvent.const_228,this.scrollBarEventProc);
            this.var_375 = null;
         }
         if(this.var_1005)
         {
      ...
      protected function get _itemList() : IItemListWindow
      {
         if(!this.var_1005)
         {
            this.var_1005 = findChildByTag("_ITEMLIST") as IItemListWindow;
         }
      ...
      protected function get _scrollBar() : IScrollbarWindow
      {
         if(!this.var_375)
         {
            ...
            if(this.var_375)
            {
               this.var_375.addEventListener(WindowEvent.const_272,this.scrollBarEventProc);
               this.var_375.addEventListener(WindowEvent.const_228,this.scrollBarEventProc);
            }
         }
         return this.var_375;
      }
