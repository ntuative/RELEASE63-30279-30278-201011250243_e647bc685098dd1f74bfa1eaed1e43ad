package com.sulake.core.window.components
{
   ...
   public class ItemListController extends WindowController implements IItemListWindow, IInputProcessorRoot
   {
      ...
      protected static const const_1105:String = "spacing";
      
      protected static const const_1104:String = "scale_to_fit_items";
      
      protected static const const_1106:String = "resize_on_item_update";
      
      protected static const const_1103:String = "auto_arrange_items";
      
      protected static const DEF_SPACING:int = 0;
      
      protected static const const_1497:Boolean = false;
      
      protected static const DEF_RESIZE_ON_ITEM_UPDATE:Boolean = false;
      
      protected static const const_1496:Boolean = true;
      ...
      protected var var_1862:Boolean = false;
      ...
      protected var var_2638:Number = 0.0;
      
      protected var var_2637:Number = 0.0;
      
      protected var var_920:Boolean = true;
      
      protected var var_504:Boolean = false;
      
      protected var var_1150:Boolean = false;
      
      protected var var_1861:int = 0;
      
      protected var var_1860:int = 0;
      
      protected var var_1151:Number;
      
      protected var var_1153:Number;
      ...
      public function ItemListController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function = null, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         ...
         this.var_98 = 0;
         this.var_89 = 0;
         this._horizontal = param2 == WindowType.const_374;
         super(param1,param2,param3,param4,param5,param6,param7,param8,param9,param10,param11);
         var_149 = var_502 || !testParamFlag(WindowParam.const_31);
         this._container = var_17.create("_CONTAINER","",WindowType.const_360,WindowStyle.const_657,0 | 0 | 0,new Rectangle(0,0,width,height),null,this,0,null,[TAG_INTERNAL,TAG_EXCLUDE]) as IWindowContainer;
         ...
         this.resizeOnItemUpdate = this.var_1150;
      }
      ...
      {
         return new Rectangle(this.var_613 * this.maxScrollH,this.var_614 * this.maxScrollV,width,height);
      }
      ...
      public function set scrollH(param1:Number) : void
      {
         ...
         {
            this.var_613 = param1;
            this._container.x = -this.var_613 * this.maxScrollH;
            var_17.invalidate(this._container,this.visibleRegion,WindowRedrawFlag.const_81);
            dispatchEvent(new WindowEvent(WindowEvent.const_404,this,null));
         }
      }
      ...
      public function set scrollV(param1:Number) : void
      {
         ...
         {
            this.var_614 = param1;
            this._container.y = -this.var_614 * this.maxScrollV;
            var_17.invalidate(this._container,this.visibleRegion,WindowRedrawFlag.const_81);
            dispatchEvent(new WindowEvent(WindowEvent.const_404,this,null));
         }
      }
      ...
      {
         this.var_2638 = Math.max(param1,0);
      }
      
      public function set scrollStepV(param1:Number) : void
      {
         this.var_2637 = Math.max(param1,0);
      }
      ...
      public function set resizeOnItemUpdate(param1:Boolean) : void
      {
         ...
         if(this._container)
         {
            if(this._horizontal)
            {
               this._container.setParamFlag(WindowParam.const_424,param1);
            }
            else
            {
               this._container.setParamFlag(WindowParam.const_454,param1);
            }
         }
      }
      ...
      public function process(param1:WindowEvent) : Boolean
      {
         ...
         switch(param1.type)
         {
            ...
            case WindowMouseEvent.const_182:
               if(this.var_1152)
               {
                  this.var_1151 = this.var_1861 - _loc3_;
                  this.var_1153 = this.var_1860 - _loc4_;
                  if(this._horizontal)
                  {
                     if(this.var_1151 != 0 && this.var_98 != 0)
                     {
                        this.scrollH += this.var_1151 / this.var_98;
                     }
                  }
                  else if(this.var_1153 != 0 && this.var_89 != 0)
                  {
                     this.scrollV += this.var_1153 / this.var_89;
                  }
                  this.var_1861 = _loc3_;
                  this.var_1860 = _loc4_;
                  _loc2_ = true;
            ...
            case WindowMouseEvent.const_162:
               if(this.var_1152)
               {
                  if(this._horizontal)
                  {
                     var_17.getWindowServices().getGestureAgentService().begin(this,this.scrollAnimationCallback,0,-this.var_1151,0);
                  }
                  else
                  {
                     var_17.getWindowServices().getGestureAgentService().begin(this,this.scrollAnimationCallback,0,0,-this.var_1153);
                  }
                  this.var_1152 = false;
                  _loc2_ = true;
               }
      ...
      protected function updateScrollAreaRegion() : void
      {
         ...
         var _loc3_:int = 0;
         var _loc4_:int = 0;
         if(this.var_920 && !this.var_503 && this._container)
         {
            this.var_503 = true;
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(new PropertyStruct(const_1105,this._spacing,PropertyStruct.const_54,this._spacing != DEF_SPACING));
         _loc1_.push(new PropertyStruct(const_1103,this.var_920,PropertyStruct.const_55,this.var_920 != const_1496));
         _loc1_.push(new PropertyStruct(const_1104,this.var_504,PropertyStruct.const_55,this.var_504 != const_1497));
         _loc1_.push(new PropertyStruct(const_1106,this.var_1150,PropertyStruct.const_55,this.var_1150 != DEF_RESIZE_ON_ITEM_UPDATE));
         return _loc1_;
      }
         ...
         for each(_loc2_ in param1)
         {
            switch(_loc2_.key)
            {
               ...
               case const_1106:
                  ...
                  break;
               case const_1103:
                  this.var_920 = _loc2_.value as Boolean;
                  break;
            }
         }
