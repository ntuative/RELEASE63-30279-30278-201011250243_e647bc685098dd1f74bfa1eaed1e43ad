package com.sulake.core.window.components
{
   ...
   public class TabContextController extends WindowController implements ITabContextWindow, IIterable
   {
      ...
      private static const const_1157:String = "_SELECTOR";
      
      private static const const_1158:String = "_CONTENT";
       
      
      protected var var_919:ITabSelectorWindow;
      ...
      public function get selector() : ITabSelectorWindow
      {
         ...
         {
            this.var_919 = findChildByTag(const_1157) as ITabSelectorWindow;
            if(this.var_919 != null)
            {
               this.var_919.procedure = this.selectorEventProc;
            }
         }
         return this.var_919;
      }
      ...
      public function get container() : IWindowContainer
      {
         ...
         {
            this.var_1855 = findChildByTag(const_1158) as IWindowContainer;
         }
      ...
      {
         return !!this.var_723 ? this.selector.iterator : null;
      }
      
      public function get numTabItems() : uint
      {
         return this.var_919.numSelectables;
      }
