package com.sulake.core.assets.loaders
{
   ...
   public class BitmapFileLoader extends AssetLoaderEventBroker implements IAssetLoader
   {
      ...
      {
         super();
         this.var_921 = param2 == null ? "" : param2.url;
         this._type = param1;
         this.var_38 = new Loader();
         this.var_924 = new LoaderContext();
         this.var_924.checkPolicyFile = true;
         ...
         {
            this.var_38.load(param2,this.var_924);
         }
      }
      ...
      {
         this.var_921 = param1.url;
         var_285 = 0;
         this.var_38.load(param1,this.var_924);
      }
      ...
      override protected function retry() : Boolean
      {
         if(!_disposed)
         {
            if(++var_285 < var_2595)
            {
               ...
               this.var_38.load(new URLRequest(this.var_921 + (this.var_921.indexOf("?") == -1 ? "?" : "&") + "retry=" + var_285),this.var_924);
               return true;
            }
         }
         return false;
