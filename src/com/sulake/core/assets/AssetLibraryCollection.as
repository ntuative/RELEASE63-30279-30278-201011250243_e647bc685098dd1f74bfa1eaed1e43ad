package com.sulake.core.assets
{
   ...
   public class AssetLibraryCollection extends EventDispatcher implements IAssetLibrary
   {
      ...
      protected var var_506:Array;
      
      protected var var_924:LoaderContext;
      ...
      public function AssetLibraryCollection(param1:String)
      {
         ...
         this.var_924 = new LoaderContext(false,ApplicationDomain.currentDomain,null);
         this.var_409 = new AssetLibrary("lib-" + this.var_507++);
         this.var_27.push(this.var_409);
      }
      ...
      public function loadFromFile(param1:LibraryLoader, param2:Boolean = false) : void
      {
         ...
         {
            this.loaderContext = this.var_924;
         }
         var _loc3_:IAssetLibrary = new AssetLibrary("lib-" + this.var_507++);
         this.var_506.push(_loc3_);
      ...
      {
         while(this.var_506.length > 0)
         {
            (this.var_506.pop() as IAssetLibrary).dispose();
         }
      ...
      private function loadEventHandler(param1:LibraryLoaderEvent) : void
      {
         ...
         if(param1.type == LibraryLoaderEvent.LIBRARY_LOADER_EVENT_COMPLETE)
         {
            ...
            _loc4_ = 0;
            while(_loc4_ < this.var_506.length)
            {
               _loc3_ = this.var_506[_loc4_] as IAssetLibrary;
