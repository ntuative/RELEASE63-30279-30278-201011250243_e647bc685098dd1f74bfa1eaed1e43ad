package com.sulake.core.assets
{
   ...
   public class AssetLibrary extends EventDispatcher implements IAssetLibrary
   {
      ...
      public static const const_1061:String = "AssetLibraryReady";
      
      public static const const_569:String = "AssetLibraryLoaded";
      
      public static const const_1403:String = "AssetLibraryUnloaded";
      
      public static const const_1483:String = "AssetLibraryLoadError";
      ...
      private static var var_813:Array = new Array();
      ...
      public function AssetLibrary(param1:String)
      {
         ...
         ++var_437;
         this.var_367 = new Dictionary(false);
         this.var_436 = new Dictionary(false);
         this.var_812 = new Dictionary(false);
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            this.unload();
            super.dispose();
            var_813.splice(var_813.indexOf(this),1);
            --var_437;
            this.var_436 = null;
            this.var_812 = null;
            this.var_134 = null;
      ...
      {
         if(this._file == param1.url && this.var_811)
         {
            if(!this.var_810 && param2)
            {
               AssetLibrary.fetchLibraryContents(this,this.var_643,this.var_544);
            }
            this.var_810 = param2;
            dispatchEvent(new Event(AssetLibrary.const_1061));
         }
         else
         {
      ...
      public function unload() : void
      {
         ...
         for(_loc1_ in this.var_812)
         {
            delete this.var_812[_loc1_];
         }
         if(this.var_38 != null)
         {
            this.var_38.dispose();
      ...
      {
         var _loc2_:Class = this.var_812[param1];
         if(_loc2_ != null)
         {
            return _loc2_;
         }
      ...
      public function loadAssetFromFile(param1:String, param2:URLRequest, param3:String = null) : AssetLoaderStruct
      {
         ...
         _loc6_.addEventListener(AssetLoaderEvent.const_983,this.assetLoadEventHandler);
         _loc6_.addEventListener(AssetLoaderEvent.const_1011,this.assetLoadEventHandler);
         _loc6_.addEventListener(AssetLoaderEvent.const_914,this.assetLoadEventHandler);
         ...
         switch(e.type)
         {
            case AssetLoaderEvent.const_30:
               ...
               if(decl != null)
               {
                  ...
                  {
                     ++this.var_369;
                     this.var_368.push(struct.assetName);
                  }
      ...
      {
         return param1 < this.var_368.length ? this.getAssetByName(this.var_368[param1]) : null;
      }
      ...
      public function getAssetIndex(param1:IAsset) : int
      {
         ...
         for(_loc2_ in this.var_134)
         {
            ...
            {
               return this.var_368.indexOf(_loc2_);
            }
         }
         return -1;
      }
      ...
      {
         return this.var_134[param1] != null || (this.var_544 != null ? this.var_544[param1] != null : false);
      }
      ...
      public function registerAssetTypeDeclaration(param1:AssetTypeDeclaration, param2:Boolean = true) : Boolean
      {
         ...
         {
            if(this.var_367.hasOwnProperty(param1.mimeType))
            {
               throw new Error("Asset type " + param1.mimeType + " already registered!");
            }
            this.var_367[param1.mimeType] = param1;
         }
         return true;
      }
      ...
      public function getAssetTypeDeclarationByMimeType(param1:String, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         _loc3_ = AssetTypeDeclaration(this.var_367[param1]);
         if(_loc3_ != null)
         {
            return _loc3_;
         }
      ...
      public function getAssetTypeDeclarationByClass(param1:Class, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         for(_loc4_ in this.var_367)
         {
            _loc3_ = AssetTypeDeclaration(this.var_367[_loc4_]);
            if(_loc3_ != null)
            {
               if(_loc3_.assetClass == param1)
               {
      ...
      public function getAssetTypeDeclarationByFileName(param1:String, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         for(_loc5_ in this.var_367)
         {
            _loc4_ = AssetTypeDeclaration(this.var_367[_loc5_]);
            if(_loc4_ != null)
            {
               if(_loc4_.fileTypes.indexOf(_loc3_))
               {
      ...
      private function libraryLoadedHandler(param1:LibraryLoaderEvent) : void
      {
         ...
         this.var_643 = _loc2_.manifest.copy();
         this.var_544 = _loc2_.resource;
      ...
      private function loadErrorHandler(param1:LibraryLoaderEvent) : void
      {
         ...
         dispatchEvent(new Event(AssetLibrary.const_1483));
         this.var_38 = null;
      }
      ...
      private function fetchAssetFromResource(param1:String) : IAsset
      {
         ...
         var _loc2_:XMLList = this.var_643.child("library");
         if(_loc2_ == null)
         {
         ...
         if(_loc2_ != null)
         {
            ...
            while(_loc7_ < _loc6_)
            {
               ...
               if(_loc3_.attribute("name").toString() == param1)
               {
                  ...
                  _loc5_.setUnknownContent(this.var_544[param1]);
