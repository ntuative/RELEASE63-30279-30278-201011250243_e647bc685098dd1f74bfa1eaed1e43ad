package com.sulake.core.utils
{
   ...
   public class LibraryLoader extends EventDispatcher implements IDisposable
   {
      ...
      protected static const const_1501:uint = 1;
      
      protected static const const_1498:uint = 2;
      
      protected static const const_1499:uint = 4;
      
      protected static const const_1500:uint = 3;
      ...
      protected var var_249:URLRequest;
      
      protected var var_643:XML;
      
      protected var var_544:Class;
      ...
      protected var var_925:Boolean = false;
      
      protected var var_2588:String = "";
      
      protected var var_2586:String = "";
      ...
      protected var var_2666:uint = 0;
      
      protected var var_2587:Boolean = true;
      ...
      {
         return !!this.var_249 ? this.var_249.url : null;
      }
      ...
      {
         return !!this.var_926 ? uint(this.var_1157 - this.var_1866) : uint(getTimer() - this.var_1866);
      }
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            dispatchEvent(new LibraryLoaderEvent(LibraryLoaderEvent.LIBRARY_LOADER_EVENT_DISPOSE,this.var_344,this.bytesTotal,this.bytesLoaded,this.elapsedTime));
            try
            {
               this.var_38.close();
            }
      ...
      public function load(param1:URLRequest, param2:int = 5) : void
      {
         ...
         this._name = parseNameFromUrl(this.var_249.url);
      ...
      {
         if(this.var_925 && !_disposed)
         {
            this.var_925 = false;
            if(!this.var_926 && this.var_249)
            {
               this.var_1157 = -1;
               this.var_1866 = getTimer();
               this.var_38.load(this.var_249,this.var_17);
            }
         }
      }
      ...
      {
         if(!this.var_926 && !_disposed && this.var_1156 > 0)
         {
            try
            {
               this.var_38.close();
            ...
            this.addRequestCounterToUrlRequest(this.var_249,const_1264 - this.var_1156);
            if(this.var_2587)
            {
               this.var_249.requestHeaders.push(new URLRequestHeader("pragma","no-cache"));
               this.var_249.requestHeaders.push(new URLRequestHeader("Cache-Control","no-cache"));
               this.var_2587 = false;
            }
            --this.var_1156;
            this.var_405 = 0;
      ...
      protected function loadEventHandler(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case HTTPStatusEvent.HTTP_STATUS:
               ...
               this.debug("Load event STATUS " + this.var_344 + " for file \"" + this.url + "\"");
               break;
            case Event.UNLOAD:
               this.debug("Load event UNLOAD for file \"" + this.url + "\"");
               dispatchEvent(new LibraryLoaderEvent(LibraryLoaderEvent.LIBRARY_LOADER_EVENT_UNLOAD,this.var_344,this.bytesTotal,this.bytesLoaded,this.elapsedTime));
               break;
            case ProgressEvent.PROGRESS:
               this.debug("Load event PROGRESS for file \"" + this.url + "\"");
               dispatchEvent(new LibraryLoaderEvent(LibraryLoaderEvent.LIBRARY_LOADER_EVENT_PROGRESS,this.var_344,this.bytesTotal,this.bytesLoaded,this.elapsedTime));
               break;
            case IOErrorEvent.IO_ERROR:
               this.debug("Load event IO ERROR for file \"" + this.url + "\"");
               if(!this.handleHttpStatus(this.var_344))
               {
                  this.var_1157 = getTimer();
            ...
            case TimerEvent.TIMER:
               ...
               if(!_disposed)
               {
                  this.var_405 = LibraryLoader.name_2;
         ...
         if(this.var_405 == LibraryLoader.const_1500)
         {
         ...
         if(this.var_405 == LibraryLoader.name_2)
         {
            if(this.prepareLibrary())
            {
               ...
               this.var_1157 = getTimer();
               this.removeEventListeners();
               dispatchEvent(new LibraryLoaderEvent(LibraryLoaderEvent.LIBRARY_LOADER_EVENT_COMPLETE,this.var_344,this.bytesTotal,this.bytesLoaded,this.elapsedTime));
      ...
      protected function prepareLibrary() : Boolean
      {
         ...
         this.var_544 = this.getDefinition(this._name) as Class;
         if(this.var_544 == null)
         {
            if(!this.retry())
            {
               this.failure("Failed to find resource class \"" + this._name + "\" from library " + this.var_249.url + "!");
            }
            return false;
         }
         try
         {
            xmlClass = this.var_544.manifest as Class;
            if(xmlClass == null)
            {
               return false;
            }
         ...
         try
         {
            this.var_643 = new XML(bytes.readUTFBytes(bytes.length));
         }
         catch(e:Error)
         {
            if(!retry())
      ...
      protected function debug(param1:String) : void
      {
         ...
         if(this._debug)
         {
            dispatchEvent(new LibraryLoaderEvent(LibraryLoaderEvent.LIBRARY_LOADER_EVENT_DEBUG,this.var_344,this.bytesTotal,this.bytesLoaded,this.elapsedTime));
         }
      }
      ...
      protected function failure(param1:String) : void
      {
         ...
         dispatchEvent(new LibraryLoaderEvent(LibraryLoaderEvent.LIBRARY_LOADER_EVENT_ERROR,this.var_344,this.bytesTotal,this.bytesLoaded,this.elapsedTime));
         dispatchEvent(new Event(LIBRARY_LOADER_FINALIZE));
      }
