package com.sulake.core.communication.connection
{
   ...
   public class SocketConnection extends EventDispatcher implements IConnection, IDisposable
   {
      ...
      public static const const_1330:int = 10000;
      ...
      private var var_463:ByteArray;
      
      private var var_1060:IEncryption;
      
      private var var_681:IProtocol;
      ...
      private var var_462:IConnectionStateListener;
      ...
      public function SocketConnection(param1:String, param2:ICoreCommunicationManager, param3:IConnectionStateListener)
      {
         ...
         this._id = param1;
         this.var_283 = param2;
         this.var_463 = new ByteArray();
         this.var_1059 = new MessageClassManager();
         this.var_75 = new Socket();
         this.var_321 = new Timer(const_1330,1);
         this.var_321.addEventListener(TimerEvent.TIMER,this.onTimeOutTimer);
      ...
      public function init(param1:String, param2:uint = 0) : Boolean
      {
         if(this.var_462)
         {
            this.var_462.connectionInit(param1,param2);
         }
      ...
      public function send(param1:IMessageComposer, param2:int = -1) : Boolean
      {
         ...
         var _loc5_:ByteArray = this.var_681.encoder.encode(_loc4_,param1.getMessageArray(),param2);
         if(this.var_462)
         {
            this.var_462.messageSent(String(_loc4_),_loc5_.toString());
         }
      ...
      override public function toString() : String
      {
         ...
         _loc1_ += "Protocol Encoder: " + this.var_681.encoder + "\n";
         _loc1_ += "Protocol Decoder: " + this.var_681.decoder + "\n";
      ...
      public function processReceivedData() : void
      {
         ...
         var offset:uint = this.var_681.getMessages(this.var_463,receivedMessages);
         ...
         try
         {
            for each(message in receivedMessages)
            {
               ...
               if(this.var_462)
               {
                  this.var_462.messageReceived(String(id),data.toString());
               }
            ...
            {
               temp = new ByteArray();
               temp.writeBytes(this.var_463,offset);
               this.var_463 = temp;
               this.logConnection("[SOCKET REST] offset: " + offset + " rest: " + this.var_463.toString());
            }
         }
         catch(e:Error)
         {
      ...
      private function onRead(param1:ProgressEvent) : void
      {
         ...
         {
            this.var_463.writeByte(this.var_75.readUnsignedByte());
         }
      }
      ...
      private function onTimeOutTimer(param1:TimerEvent) : void
      {
         ...
         _loc2_.text = "Socket Timeout (" + this.var_321.delay + " ms). Possible Firewall.";
